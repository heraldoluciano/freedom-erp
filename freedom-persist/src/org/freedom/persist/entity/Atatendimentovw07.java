...
public class Atatendimentovw07 implements java.io.Serializable {
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "razcli", column = @Column(name = "RAZCLI", length = 0)),
			...
			@AttributeOverride(name = "descsitcontr", column = @Column(name = "DESCSITCONTR", length = 0)),
			@AttributeOverride(name = "sitcontr", column = @Column(name = "SITCONTR", length = 0)),
			@AttributeOverride(name = "tpcontr", column = @Column(name = "TPCONTR", length = 0)),
