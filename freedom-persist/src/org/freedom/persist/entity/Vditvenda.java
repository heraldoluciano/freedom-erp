...
public class Vditvenda implements java.io.Serializable {
	...
	private Set<Vditvendaitvenda> vditvendaitvendasForVditvendafkitvend2 = new HashSet<Vditvendaitvenda>(
			0);
	private Set<Vdvendaconsig> vdvendaconsigs = new HashSet<Vdvendaconsig>(0);
	private Vditvendavditcontr vditvendavditcontr;
	private Set<Vditvendaitvenda> vditvendaitvendasForVditvendafkitvend1 = new HashSet<Vditvendaitvenda>(
			0);
	private Vditcustovenda vditcustovenda;
	private Set<Cpcompravenda> cpcompravendas = new HashSet<Cpcompravenda>(0);
	...
	public Vditvenda(VditvendaId id, Eqproduto eqproduto, Lfnatoper lfnatoper,
			...
			Lfitvenda lfitvenda, Set<Eqmovserie> eqmovseries,
			Set<Vditvendaitvenda> vditvendaitvendasForVditvendafkitvend2,
			Set<Vdvendaconsig> vdvendaconsigs,
			Vditvendavditcontr vditvendavditcontr,
			Set<Vditvendaitvenda> vditvendaitvendasForVditvendafkitvend1,
			Vditcustovenda vditcustovenda, Set<Cpcompravenda> cpcompravendas,
			Set<Vdvendaorc> vdvendaorcs, Set<Eqmovprod> eqmovprods,
			Set<Cpdevolucao> cpdevolucaos) {
		this.id = id;
		this.eqproduto = eqproduto;
		this.lfnatoper = lfnatoper;
	...
	public Set<Vditvendaitvenda> getVditvendaitvendasForVditvendafkitvend2() {
	...
	public Set<Vditvendaitvenda> getVditvendaitvendasForVditvendafkitvend1() {
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vditvenda")
	public Set<Cpcompravenda> getCpcompravendas() {
		return this.cpcompravendas;
	}

	public void setCpcompravendas(Set<Cpcompravenda> cpcompravendas) {
		this.cpcompravendas = cpcompravendas;
	}
