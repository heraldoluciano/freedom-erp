...
/**
 * PpopId generated by hbm2java
 */
public class PpopId implements java.io.Serializable {
	...
	public PpopId(int codop, short seqop, short codfilial, int codemp) {
		this.codop = codop;
		this.seqop = seqop;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PpopId))
			return false;
		PpopId castOther = (PpopId) other;
