...
public class Sgcatimg implements java.io.Serializable {
	...
	private Set<Sgimagem> sgimagems = new HashSet<Sgimagem>(0);
	...
	public Sgcatimg(SgcatimgId id, Sgfilial sgfilial, String desccatimg,
			...
			String idusualt, Set<Sgimagem> sgimagems) {
		this.id = id;
		this.sgfilial = sgfilial;
		this.desccatimg = desccatimg;
		this.dtins = dtins;
	...
	@EmbeddedId
	@AttributeOverrides({
			@AttributeOverride(name = "codcatimg", column = @Column(name = "CODCATIMG", nullable = false)),
	...
	@Column(name = "DESCCATIMG", nullable = false, length = 100)
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "sgcatimg")
	public Set<Sgimagem> getSgimagems() {
		return this.sgimagems;
	}

	public void setSgimagems(Set<Sgimagem> sgimagems) {
		this.sgimagems = sgimagems;
	}
