...
/**
 * FnfbnrecId generated by hbm2java
 */
public class FnfbnrecId implements java.io.Serializable {
	...
	public FnfbnrecId(int codrec, int nparcitrec, short codfilial, int codemp) {
		this.codrec = codrec;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FnfbnrecId))
			return false;
		FnfbnrecId castOther = (FnfbnrecId) other;
