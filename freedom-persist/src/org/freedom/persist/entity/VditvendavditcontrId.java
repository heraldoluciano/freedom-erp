...
/**
 * VditvendavditcontrId generated by hbm2java
 */
public class VditvendavditcontrId implements java.io.Serializable {
	...
	public VditvendavditcontrId() {
	}

	public VditvendavditcontrId(int codvenda, int coditvenda, char tipovenda,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VditvendavditcontrId))
			return false;
		VditvendavditcontrId castOther = (VditvendavditcontrId) other;
