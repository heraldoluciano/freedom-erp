...
public class Vwcustoproj01 implements java.io.Serializable {
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "desccusto", column = @Column(name = "DESCCUSTO", length = 0)),
			...
			@AttributeOverride(name = "qtdcusto", column = @Column(name = "QTDCUSTO", precision = 0, scale = 4)),
			@AttributeOverride(name = "vlrcusto", column = @Column(name = "VLRCUSTO", precision = 0, scale = 5)),
			@AttributeOverride(name = "tipocusto", column = @Column(name = "TIPOCUSTO", length = 0)) })
