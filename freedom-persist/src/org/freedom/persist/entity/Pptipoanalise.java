...
public class Pptipoanalise implements java.io.Serializable {
	...
	private Set<Ppestruanalise> ppestruanalises = new HashSet<Ppestruanalise>(0);
	...
	public Pptipoanalise(PptipoanaliseId id, Equnidade equnidade,
			...
			Set<Ppestruanalise> ppestruanalises) {
		this.id = id;
	...
	public Set<Ppestruanalise> getPpestruanalises() {
		return this.ppestruanalises;
	}

	public void setPpestruanalises(Set<Ppestruanalise> ppestruanalises) {
		this.ppestruanalises = ppestruanalises;
	}
