...
public class Atatendimentovw08Id implements java.io.Serializable {
	...
	@Column(name = "DTFINCONTR", length = 10)
	...
	@Column(name = "NOMEATEND", length = 0)
	public Character getNomeatend() {
		return this.nomeatend;
	}

	public void setNomeatend(Character nomeatend) {
		this.nomeatend = nomeatend;
	}
