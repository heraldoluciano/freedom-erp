...
public class Sguf implements java.io.Serializable {
	...
	private Set<Sgmunicipio> sgmunicipios = new HashSet<Sgmunicipio>(0);
	...
	public Sguf(SgufId id, Sgpais sgpais, String nomeuf, String nomecurto,
			...
			Set<Lfitclfiscal> lfitclfiscals, Set<Sgmunicipio> sgmunicipios) {
		this.id = id;
		this.sgpais = sgpais;
		this.nomeuf = nomeuf;
		this.nomecurto = nomecurto;
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "sguf")
	public Set<Sgmunicipio> getSgmunicipios() {
		return this.sgmunicipios;
	}

	public void setSgmunicipios(Set<Sgmunicipio> sgmunicipios) {
		this.sgmunicipios = sgmunicipios;
	}
