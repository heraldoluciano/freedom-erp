...
public class Atatendimentovw08 implements java.io.Serializable {
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "nomeatend", column = @Column(name = "NOMEATEND", length = 0)),
			...
			@AttributeOverride(name = "tpcobcontr", column = @Column(name = "TPCOBCONTR", length = 0)),
			@AttributeOverride(name = "sitcontr", column = @Column(name = "SITCONTR", length = 0)),
			...
			@AttributeOverride(name = "tipoorc", column = @Column(name = "TIPOORC", length = 0)),
