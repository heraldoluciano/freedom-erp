...
public class Sgusuario implements java.io.Serializable {
	...
	@Column(name = "TIPOUSU", nullable = false, length = 1)
	...
	@Column(name = "LIBERACAMPOPESAGEM", nullable = false, length = 1)
	...
	@Column(name = "APROVORDCP", nullable = false, length = 1)
	...
	@Column(name = "ACESOPBTCADLOTE", nullable = false, length = 1)
	...
	@Column(name = "ACESOPBTRMA", nullable = false, length = 1)
	...
	@Column(name = "ACESOPBTQUALID", nullable = false, length = 1)
	...
	@Column(name = "ACESOPBTDISTR", nullable = false, length = 1)
	...
	@Column(name = "ACESOPBTFASE", nullable = false, length = 1)
	...
	@Column(name = "ACESOPBTCANC", nullable = false, length = 1)
	...
	@Column(name = "ACESOPBTSUBPROD", nullable = false, length = 1)
	...
	@Column(name = "ACESOPBTREMESSA", nullable = false, length = 1)
	...
	@Column(name = "ACESOPBTRETORNO", nullable = false, length = 1)
	...
	@Column(name = "ACESOPVERITENS", nullable = false, length = 1)
	...
	@Column(name = "CADOUTUSU", nullable = false, length = 1)
	...
	@Column(name = "SENHAUSU", length = 128)
