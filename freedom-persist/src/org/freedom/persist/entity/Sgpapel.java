...
public class Sgpapel implements java.io.Serializable {
	...
	private Set<Sgmodetiqueta> sgmodetiquetas = new HashSet<Sgmodetiqueta>(0);
	...
	public Sgpapel(SgpapelId id, Sgfilial sgfilial, String descpapel,
			...
			Set<Sgmodetiqueta> sgmodetiquetas, Set<Sgestacaoimp> sgestacaoimps) {
		this.id = id;
		this.sgfilial = sgfilial;
	...
	public Set<Sgmodetiqueta> getSgmodetiquetas() {
		return this.sgmodetiquetas;
	}

	public void setSgmodetiquetas(Set<Sgmodetiqueta> sgmodetiquetas) {
		this.sgmodetiquetas = sgmodetiquetas;
	}
