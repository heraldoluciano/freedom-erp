...
public class Sgestcivil implements java.io.Serializable {
	...
	public Sgestcivil(SgestcivilId id, Sgfilial sgfilial, String descestcivil,
			...
			String idusualt, Set<Rhcandidato> rhcandidatos) {
		this.id = id;
		this.sgfilial = sgfilial;
		this.descestcivil = descestcivil;
		this.dtins = dtins;
	...
	@EmbeddedId
	@AttributeOverrides({
			@AttributeOverride(name = "codestcivil", column = @Column(name = "CODESTCIVIL", nullable = false, length = 2)),
	...
	@Column(name = "DESCESTCIVIL", nullable = false, length = 50)
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "sgestcivil")
