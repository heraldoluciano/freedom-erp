...
/**
 * Rhvagacaracrest generated by hbm2java
 */
@Entity
@Table(name = "RHVAGACARACREST")
public class Rhvagacaracrest implements java.io.Serializable {

	private RhvagacaracrestId id;
	...
	public Rhvagacaracrest() {
	}

	public Rhvagacaracrest(RhvagacaracrestId id,
	...
	public RhvagacaracrestId getId() {
		return this.id;
	}

	public void setId(RhvagacaracrestId id) {
		this.id = id;
	}
