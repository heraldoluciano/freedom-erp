/* Generated by IB DB Comparer v.1.15.Beta.  24/11/2007 10:21:20 */
...
COMMIT WORK;
ALTER TABLE "EQITSIMILAR" ADD CONSTRAINT "EQITSIMILARFKEQSIMI" FOREIGN KEY ("CODSIM","CODFILIAL","CODEMP") REFERENCES "EQSIMILAR"("CODSIM","CODFILIAL","CODEMP");
COMMIT WORK;
...
COMMIT WORK;
ALTER TABLE "EQSALDOPROD" ADD CONSTRAINT "EQSOLDOPRODFKEQALMO" FOREIGN KEY ("CODALMOX","CODFILIALAX","CODEMPAX") REFERENCES "EQALMOX"("CODALMOX","CODFILIAL","CODEMP");
COMMIT WORK;
...
COMMIT WORK;
ALTER TABLE "EQTIPOMOV" ADD CONSTRAINT "EQTIPOMOVFKVDTABPRE" FOREIGN KEY ("CODTAB","CODFILIALTB","CODEMPTB") REFERENCES "VDTABPRECO"("CODTAB","CODFILIAL","CODEMP");
COMMIT WORK;
...
COMMIT WORK;
ALTER TABLE "FNCONTAUSU" ADD CONSTRAINT "FNCONTAUSUFKSGUSUAR" FOREIGN KEY ("IDUSU","CODFILIALUS","CODEMPUS") REFERENCES "SGUSUARIO"("IDUSU","CODFILIAL","CODEMP");
COMMIT WORK;
...
COMMIT WORK;
ALTER TABLE "FNLANCA" ADD CONSTRAINT "FNLANCAFKFNPAGTOCOM" FOREIGN KEY ("CODPCOMI","CODFILIALCI","CODEMPCI") REFERENCES "FNPAGTOCOMI"("CODPCOMI","CODFILIAL","CODEMP");
COMMIT WORK;
