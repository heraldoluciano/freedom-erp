...
BEGIN
  ...
  BEGIN
    ...
    INSERT INTO FNITPAGAR (CODEMP,CODFILIAL,CODPAG,NPARCPAG,VLRITPAG,VLRDESCITPAG,VLRMULTAITPAG,
                           ...
                           DTITPAG,DTVENCITPAG,STATUSITPAG,VLRADICITPAG,FLAG, OBSITPAG) VALUES
    ...
    **/
    ...
    /* Distribuindo a comissao: */
          FOR SELECT CODITVENDA,VLRPRODITVENDA,QTDITVENDA,VLRCOMISITVENDA FROM VDITVENDA WHERE CODEMP=new.CODEMP AND
            CODFILIAL=new.CODFILIAL AND CODVENDA=new.CODVENDA and tipovenda=new.tipovenda INTO ICODITVENDA,VLRPRODITVENDA,QTDITVENDA,VLRCOMISITVENDA DO
          BEGIN
    /* Calculo do item.: */
