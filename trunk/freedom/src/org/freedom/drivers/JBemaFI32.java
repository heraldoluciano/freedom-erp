...
// Funções do Cupom Fiscal
   ...
   public native int  bVendeItem( String Codigo, String Descricao, String Aliquota, String TipoQuantidade, String Quantidade, int CasasDecimais, String ValorUnitario, String TipoDesconto, String Desconto);
   public native int  bVendeItemDepartamento( String Codigo, String Descricao, String Aliquota, String ValorUnitario, String Quantidade, String Acrescimo, String Desconto, String IndiceDepartamento, String UnidadeMedida);
...
// Funções para a Impressora Restaurante
   ...
   public native int  bRRegistraVenda(String Mesa, String Codigo, String Descricao, String Aliquota, String Quantidade, String ValorUnitario, String FlagAcrescimoDesconto, String ValorAcrescimoDesconto);
   ...
   public native int  bRFechaCupomContaDividida(String NumeroCupons, String FlagAcrescimoDesconto, String TipoAcrescimoDesconto, String ValorAcrescimoDesconto, String FormasPagamento, String ValorFormasPagamento, String ValorPagoCliente, String CGC_CPF);
   public native int  bRTransferenciaItem(String MesaOrigem, String Codigo, String Descricao, String Aliquota, String Quantidade, String ValorUnitario, String FlagAcrescimoDesconto, String ValorAcrescimoDesconto, String MesaDestino);
...
// Função para a Impressora Bilhete de Passagem
   ...
   public native int  bAbreBilhetePassagem(String ImprimeValorFinal, String ImprimeEnfatizado, String Embarque, String Destino, String Linha, String Prefixo, String Agente, String Agencia, String Data, String Hora, String Poltrona, String Plataforma);
...
/*
   ...
   public native int  bTEFConfirmaVenda(String Identificacao, String ValorCompra, String Header);
   public native int  bTEFNaoConfirmaVendaImpressao(String Identificacao, String ValorCompra);
   public native int  bTEFCancelaVendaCartao(String Identificacao, String ValorCompra, String Nsu, String NumeroCupom, String Hora, String Data, String Rede);
   public native int  bTEFImprimeTEF(String Identificacao, String FormaPagamento, String ValorCompra);
   public native int  bTEFImprimeRelatorio();
   public native int  bTEFADM(String Identificacao);
   public native int  bTEFVendaCompleta(String Identificacao, String ValorCompra, String FormaPagamento, String Texto);
   public native int  bTEFConfiguraDiretorioTef(String PathREQ, String PathRESP);
   public native int  bTEFVendaCheque(String Identificacao, String ValorCompra);
   public native int  bTEFApagaResiduos();
*/
// Outras Funções
     ...
     if (!bModoDemo) {
       ...
       if (!bRetorno) {
   	      Logger.gravaLogTxt("",sUserID,Logger.LGEP_FAZ_SUPRIMENTO,
   	      		"ERRO NO SUPRIMENTO-VALOR: "+bdValor+"-FORMA DE PAGTO. "+sFormaPagto+"-"+sMensErroLog);
       }
     }
     else
       bRetorno = true;
   ...
   public static String transStatus(char cStatus) {
   	 String sRet = "";
   	 switch(cStatus) {
   	 	case 'A' : sRet = "Aberto"; break;
		case 'U' : sRet = "Suprimento"; break;
		case 'S' : sRet = "Sangria"; break;
		case 'V' : sRet = "Venda"; break;
		case 'Z' : sRet = "Fechado (com LeituraZ)"; break;
		default : sRet = "Não identificado";
   	 }
   	 return sRet;
   }
...
/*   
  ...
  */ 
   ...
   public String mp40fiCoord(int iPosVlrX, int iPosExt1X, int iPosExt2X, int iPosFavX, int iPosLocalX, int iPosDiaX,
   	    int iPosMesX, int iPosAnoX, int iPosVlrY, int iPosExt1Y, int iPosExt2Y, int iPosFavY, int iPosLocalY){
   	  String sRetorno = "";
 	  if ((iPosVlrX==0) || (iPosExt1X==0) || (iPosExt2X==0) || (iPosFavX==0) || (iPosLocalX==0) || (iPosDiaX==0) ||
	     (iPosMesX==0) || (iPosAnoX==0) || (iPosVlrY==0) || (iPosExt1Y==0) || (iPosExt2Y==0) || (iPosFavY==0) || (iPosLocalY==0) ) {
	     sRetorno = "";
 	  }
	  else
	     sRetorno = Funcoes.strZero(""+iPosVlrX,2)+"|"+Funcoes.strZero(""+iPosExt1X,2)+"|"+
		   Funcoes.strZero(""+iPosExt2X,2)+"|"+Funcoes.strZero(""+iPosFavX,2)+"|"+
		   Funcoes.strZero(""+iPosLocalX,2)+"|"+Funcoes.strZero(""+iPosDiaX,2)+"|"+
	       Funcoes.strZero(""+iPosMesX,2)+"|"+Funcoes.strZero(""+iPosAnoX,2)+"|"+
		   Funcoes.strZero(""+iPosVlrY,2)+"|"+Funcoes.strZero(""+iPosExt1Y,2)+"|"+
		   Funcoes.strZero(""+iPosExt2Y,2)+"|"+Funcoes.strZero(""+iPosFavY,2)+"|"+
   ...
   public boolean mp40fiCheque(String sUserID, String sCodbanc, String sNome, String sCidade , Date dtCheq , double deVlrCheque, boolean bModoDemo) {
        ...
        while (!trataRetornoFuncao( bImprimeCheque(  sCodbanc ,
                sVlrCheq , sNome , sCidade ,
                sDataCheq, ""  ) ) ) {
        	Logger.gravaLogTxt("",sUserID,Logger.LGEP_IMPRES_CHEQUE,
        			"Banco: "+sCodbanc+"-Valor: "+sVlrCheq+"-Fav.: "+sNome+"-Cid: "+sCidade+
					"-Data: "+sDataCheq+"-"+sMensErroLog);
        	if (i>=5) {
        		bRetorno = false;
        		break;
        	}
  	...
  	try {
  		if (!bModoDemo) {
  		    ...
  		    while (!trataRetornoFuncao(bEfetuaFormaPagamentoDescricaoForma(sFormapagto, Funcoes.transValor(deValor+"",14,2,true),""))) {
  				Logger.gravaLogTxt("",sUserID,Logger.LGEP_FECHA_CUPOM,
  						"ERRO NA INCLUSÃO DE FORMA DE PAGAMENTO NO FECHAMENTO DO CUPOM. "+sMensErroLog+"-FORMA DE PAGAMENTO: "+sFormapagto);
 		        Funcoes.espera(2);
	            if (i>=5) {
  		           bRetorno = false;
  		           break;
...
*/
    ...
    try {
       if (!bModoDemo) {
          ...
          if (sNumero==null) {
            ...
            sNumero = sNumero.substring(10).trim();
          }
  ...
  public boolean vendaItem(String sUserID, int iCodprod, String sDescprod , String sTributo,
        double deQuant, double deValor, double deValDesc , boolean bModoDemo) {
  	String sQuant = "";
  	String sValor = "";
  	String sValdesc = "";
  	String sCodprod = "";
  	...
  	try {
  		if (!bModoDemo) {
  			...
  			while (! trataRetornoFuncao(bVendeItem( sCodprod ,
  					sDescprod , sTributo ,
					"F", sQuant , 2, sValor ,
					"$" , sValdesc ) ) ) {
  	          	Logger.gravaLogTxt("",sUserID,Logger.LGEP_IMPRES_ITEM,"Codigo: "+sCodprod+"-Descrição: "+sDescprod+"-Qtd.: "+sQuant+
						"-Valor: "+sValor+"-Desconto: "+sValdesc+"-Erro: "+sMensErroLog);
  				Funcoes.espera(2);
  				if (i++ >= 5 ) { 
  					bRetorno = false;
  					break;
  ...
  public boolean fechaCupomFiscal(String sUserID, String sFormaPagto, String sAcreDesc, String sTipoAcreDesc,
  	     double deVlrAcreDesc, double deVlrPago, String sMensagem, boolean bModoDemo) {
  	   int i=0;
  	   String sVlrAcreDesc = "";
  	   String sVlrPago = "";
  	   boolean bRetorno = true;
  	   ...
  	   try {
  	      if (!bModoDemo) {
  	         ...
  	         i=1;
  	         while (! trataRetornoFuncao(bFechaCupom( sFormaPagto, sAcreDesc,
  	           sTipoAcreDesc, sVlrAcreDesc, sVlrPago, sMensagem) ) ) {
  	          	Logger.gravaLogTxt("",sUserID,Logger.LGEP_FECHA_CUPOM,
  	          			"Forma Pagto.: "+sFormaPagto+" - Valor Pago:"+sVlrPago+" - Msg. final de cupom: "+sMensagem+" - Erro: "+sMensErroLog);
  	            Funcoes.espera(2);
  	            if (i>=5) {
  	               bRetorno = false;
  	               break;
  ...
  public boolean inicioFechaCupom(String sUserID, boolean bModoDemo) {
    ...
    try {
       if (!bModoDemo) {
         i = 1;
         while (! trataRetornoFuncao(bIniciaFechamentoCupom( "D" ,
            "%" , "0000" ) ) ) {
