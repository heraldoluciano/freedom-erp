...
public class FbnUtil {
	...
	public enum EColrec {
		CODBANCO, TIPOFEBRABAN, STIPOFEBRABAN, SITREMESSA, CODCLI, AGENCIACLI, IDENTCLI, DTVENC, VLRAPAG, PESSOACLI, CPFCLI, CNPJCLI, CODMOVIMENTO, DOCREC, DTREC, NRPARCPAG, SEQREC, VLRDESC
	}
