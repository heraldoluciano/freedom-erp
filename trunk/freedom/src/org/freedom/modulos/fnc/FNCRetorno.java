    ...
    try {
	  ...
	  private void imprimir(boolean bVisualizar) {
		    ...
		    String sSQL =  " select vdcliente.Nomecli as nome, fnbanco.Nomebanco as banco, "
	                      ...
	                      +" sgcheque.codbanco, sgcheque.codcli, sgrcheque.NCHEQUE, sgrcheque.CODIGOR, "
						  +" sgrcheque.CODBANCO, sgrcheque.DTINS "
						  +" from vdcliente, fnbanco, sgcheque, sgrcheque where "
						  +" vdcliente.CODCLI=sgcheque.CODCLI and "
						  +" fnbanco.codbanco=sgcheque.codbanco and UPPER(vdcliente.Nomecli) LIKE UPPER( "+ConsNome+" ) "
						  
						  +" and sgcheque.NCHEQUE=sgrcheque.NCHEQUE and sgcheque.CODBANCO=sgrcheque.CODBANCO "+CodigoR
						  +" and sgrcheque.dtins BETWEEN ? AND ? ORDER BY "+ordena;
