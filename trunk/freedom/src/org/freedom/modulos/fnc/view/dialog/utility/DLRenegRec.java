 ...
 * @version 01/11/2010
 */
public class DLRenegRec extends FDialogo {
	...
	private enum RECEBER {
		SEL, STATUS, DTVENC, CODREC, NPARCITREC, DOCLANCA, CODCLI, RAZCLI, OBS, DOCVENDA, VLRPARC, DTPAGTO, VLRPAGO, VLRDESC, VLRJUROS, NUMCONTA, DESCCONTA, CODPLAN, DESCPLAN, CODBANCO, NOMEBANCO;
	}
	...
	private void montaTela() {
		...
		tabReceber.adicColuna( "" );
		tabReceber.adicColuna( "Vencto." );
		tabReceber.adicColuna( "Código" );
		tabReceber.adicColuna( "Parc." );
		tabReceber.adicColuna( "Doc." );
		...
		tabReceber.setTamColuna( 60, RECEBER.DTVENC.ordinal() );
		tabReceber.setTamColuna( 60, RECEBER.CODREC.ordinal() );
		tabReceber.setTamColuna( 40, RECEBER.NPARCITREC.ordinal() );
		tabReceber.setTamColuna( 50, RECEBER.DOCLANCA.ordinal() );
		tabReceber.setTamColuna( 50, RECEBER.CODCLI.ordinal() );
		tabReceber.setTamColuna( 140, RECEBER.RAZCLI.ordinal() );
		tabReceber.setTamColuna( 150, RECEBER.OBS.ordinal() );
		tabReceber.setTamColuna( 70, RECEBER.DOCVENDA.ordinal() );
		tabReceber.setTamColuna( 80, RECEBER.VLRPARC.ordinal() );
		tabReceber.setTamColuna( 80, RECEBER.DTPAGTO.ordinal() );
		tabReceber.setTamColuna( 80, RECEBER.VLRPAGO.ordinal() );
		tabReceber.setTamColuna( 80, RECEBER.VLRDESC.ordinal() );
		tabReceber.setTamColuna( 80, RECEBER.VLRJUROS.ordinal() );
		tabReceber.setTamColuna( 60, RECEBER.NUMCONTA.ordinal() );
		tabReceber.setTamColuna( 130, RECEBER.DESCCONTA.ordinal() );
