 ...
 *         Classe:
 * @(#)DLConsultaBaixaPagamento.java <BR>
 * 
...
public class DLConsultaBaixaPagamento extends DLConsultaBaixa {

	private static final long serialVersionUID = 1L;
	
	public DLConsultaBaixaPagamento( Component cOrig, DbConnection cn, int iCodRec, int iNParc ) {
