...
//				sFrom = ",VDVENDEDOR VD ";
		...
		sSQL.append( "IT.OBSITREC, V.STATUSVENDA, IT.VLRPARCITREC, IT.VLRITREC "); 
		...
		sSQL.append( "ELSE IT.VLRAPAGITREC END) VLRAPAGITREC, COALESCE(L.VLRLANCA , IT.VLRPAGOITREC) VLRPAGOITREC, ");
