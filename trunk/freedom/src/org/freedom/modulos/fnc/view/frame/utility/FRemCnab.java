...
public class FRemCnab extends FRemFBN {
	...
	private RegT400 getRegT400( final StuffRec rec, int seqregistro ) throws ExceptionCnab {
		...
		reg.setEndCli( dadosCliente[ DadosCliente.ENDCLI.ordinal() ].trim() + ( dadosCliente[ DadosCliente.NUMCLI.ordinal() ] == null ? " " : ( ", " + dadosCliente[ DadosCliente.NUMCLI.ordinal() ] ) ) + "-" + dadosCliente[ DadosCliente.BAIRCLI.ordinal() ] );
