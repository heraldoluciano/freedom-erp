	...
	public FreedomFNC() {
		...
		addOpcao( 300000000, TP_OPCAO_MENU, "Febraban", "", 'b', 300200000, 1, false, null );
  		    addOpcao( 300200000, TP_OPCAO_MENU, "SIACC", "SIACC", 'S', 300201000, 2, false, null );
			    addOpcao( 300201000, TP_OPCAO_ITEM, "Remessa", "Remessa", 'm', 300201010, 2, true, FRemSiacc.class );
			    addOpcao( 300201000, TP_OPCAO_ITEM, "Retorno", "Retorno", 't', 300201020, 2, true, FRetSiacc.class );
		...
		addOpcao( -1, TP_OPCAO_MENU, "Financeiro", "", 'F', 400000000, 0, false, null );
			...
			addOpcao( 400000000, TP_OPCAO_ITEM, "Tipo de crédito", "Tipo de crédito", 'T', 400700000, 1, true, FTipoCred.class );
			addOpcao( 400000000, TP_OPCAO_ITEM, "Liberação de crédito", "Liberação de crédito", 'b', 400800000, 1, true, FLiberaCredito.class );
			addSeparador( 400000000 );
