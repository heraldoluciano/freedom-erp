...
public class FRRazCli extends FRelatorio {
	...
	public void imprimir( boolean bVisualizar ) {
		...
		try {
			...
			sSQL.append( "UNION SELECT R.CODCLI CODEMIT, C.RAZCLI RAZEMIT, R.DATAREC DATA, 'C' TIPO, R.DOCREC DOC, ");
			...
			sSQL.append( " 'P' TIPO, R.DOCREC DOC, L.VLRLANCA FROM FNLANCA L, FNRECEBER R, VDCLIENTE C " );
