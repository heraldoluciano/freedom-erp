...
public class FConsOrc extends FFilho implements ActionListener {
	...
	*/
	...
	private void carregaTabela() {
		...
		sSQLFatura = "(SELECT VO.CODVENDA FROM VDVENDAORC VO WHERE VO.CODORC=IT.CODORC AND VO.CODEMPOR=IT.CODEMP AND VO.CODFILIALOR=IT.CODFILIAL AND VO.CODITORC=IT.CODITORC),"+
