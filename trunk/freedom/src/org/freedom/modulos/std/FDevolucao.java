...
public class FDevolucao extends FWizard implements CarregaListener{
    ...
    private void mostraPainel1() {
        ...
        rg1 = new JRadioGroup(3,1,
                new Object[] {
                  "Devolução de saída completa.",
                  "Devolução de saída parcial.",
                  "Devolução de saída sem venda agregada.",
                },
                new Object[] {"SC","SP","SS"}
              );
    ...
    private void abreFor(int iCodFor) {
        ...
        if (fPrim.temTela("Fornecedor")==false) {
            FCompra tela = new FCompra();
            fPrim.criatela("Fornecedor",tela,con);
