...
public class FTipoFiscCli extends FDados implements ActionListener {
	...
	private void imprimir(boolean bVisualizar) {
		...
		try {
			...
			sSQL.append( "(SELECT COUNT(CLI.CODFISCCLI) FROM LFTIPOFISCCLI CLI " );
			sSQL.append( "WHERE CLI.CODEMPFC=TP.CODEMP AND CLI.CODFILIALFC=TP.CODFILIAL AND CLI.CODTIPOFISCCLI=TP.CODTIPOFISCCLI) AS QTD " );
