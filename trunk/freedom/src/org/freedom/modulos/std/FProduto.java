...
//	private JTextFieldPad txtCodAlmoxSaldo = new JTextFieldPad(JTextFieldPad.TP_INTEGER, 8, 0);
	...
	public FProduto() {
		...
		lcUnid.add(new GuardaCampo(txtDescUnid, "DescUnid",
				"Descrição da unidade", ListaCampos.DB_SI, false));
		...
		lcFisc.add(new GuardaCampo(txtCodFisc, "CodFisc", "Cód.c.fisc.",
				ListaCampos.DB_PK, true));
		lcFisc.add(new GuardaCampo(txtDescFisc, "DescFisc",
				"Descrição da classificação fiscal", ListaCampos.DB_SI, false));
		lcFisc.montaSql(false, "CLFISCAL", "LF");
		lcFisc.setReadOnly(true);
		lcFisc.setQueryCommit(false);
		txtCodFisc.setTabelaExterna(lcFisc);

		lcGrup.add(new GuardaCampo(txtCodGrup, "CodGrup", "Cód.grupo",
				ListaCampos.DB_PK, true));
	...
	private void montaTela() {
		adicCampo(txtCodProd, 7, 20, 70, 20, "CodProd", "Cód.prod.",
				ListaCampos.DB_PK, true);
		adicCampo(txtRefProd, 80, 20, 70, 20, "RefProd", "Referência",
				ListaCampos.DB_SI, true);
		adicCampo(txtDescProd, 153, 20, 360, 20, "DescProd",
				"Descrição do produto", ListaCampos.DB_SI, true);
		adicDB(rgTipo, 520, 20, 130, 140, "TipoProd", "Fluxo:", true);
		adicCampo(txtDescAuxProd, 7, 60, 250, 20, "DescAuxProd",
				"Descrição auxiliar", ListaCampos.DB_SI, false);
		adicCampo(txtCodMoeda, 259, 60, 70, 20, "CodMoeda", "Cód.moeda",
				ListaCampos.DB_FK, true);
		adicDescFK(txtDescMoeda, 332, 60, 181, 20, "SingMoeda",
				"Descrição da moeda");
		adicCampo(txtCodBarProd, 7, 100, 125, 20, "CodBarProd",
				"Código de barras", ListaCampos.DB_SI, true);
		adicCampo(txtCodFabProd, 135, 100, 125, 20, "CodFabProd",
				"Código do fabricante", ListaCampos.DB_SI, true);
		adicCampo(txtCodAlmox, 263, 100, 70, 20, "CodAlmox", "Cód.almox.",
				ListaCampos.DB_FK, true);
		...
		adicCampo(txtPesoLiqProd, 100, 140, 87, 20, "PesoLiqProd",
				"Peso líquido", ListaCampos.DB_SI, true);
		adicCampo(txtPrecoBaseProd, 190, 140, 97, 20, "PrecoBaseProd",
				"Preço base", ListaCampos.DB_SI, true);
		adicCampo(txtComisProd, 290, 140, 77, 20, "ComisProd", "% Comissão",
				ListaCampos.DB_SI, true);
		...
		lcUnidFat.add(new GuardaCampo(txtUnidFat, "CodUnid", "Cód.unid.",
				ListaCampos.DB_PK, true));
		...
		adicCampo(txtUnidFat, 7, 20, 80, 20, "CodUnid", "Cód.unid.",
		...
		lcCodPlan.add(new GuardaCampo(txtCodPlan, "CodPlan",
				"Cód.plan.", ListaCampos.DB_FK, true));
		lcCodPlan.add(new GuardaCampo(txtDescPlan, "DescPlan",
		...
		lcCodCC.add(new GuardaCampo(txtCodCC, "CodCC",
				"Cód.cc.", ListaCampos.DB_FK, true));
		lcCodCC.add(new GuardaCampo(txtDescCC, "DescCC",
		...
		adicCampo(txtSeqPP, 7, 20, 80, 20, "SeqPP", "SeqPP",
				ListaCampos.DB_PK, true);
		adicCampo(txtCodPlan, 90, 20, 80, 20, "CodPlan", "Cód.plan.",
				ListaCampos.DB_FK, txtDescUnidFat, true);
		adicDescFK(txtDescPlan, 173, 20, 250, 20, "DescPlan",
				"Descrição do planejamento");		
		adicDB(rgTP, 426, 20, 200, 30, "TipoPP", "Tipo", true);		
		adicCampo(txtCodCC, 7, 60, 80, 20, "CodCC", "Cód.cc.",
				ListaCampos.DB_FK, txtDescUnidFat, true);
		adicDescFK(txtDescCC, 90, 60, 250, 20, "DescCC",
		...
		lcForFK.add(new GuardaCampo(txtCodFor, "CodFor", "Cód.for.",
				ListaCampos.DB_PK, true));
		...
		adicCampo(txtCodLote, 7, 20, 110, 20, "CodLote", "Cód.lote",
				ListaCampos.DB_PK, true);
...
//		Fotos
		...
		adicCampo(txtCodFotoProd, 7, 20, 70, 20, "CodFotoProd", "Nº foto",
				ListaCampos.DB_PK, true);
		adicCampo(txtDescFotoProd, 80, 20, 250, 20, "DescFotoProd",
				"Descrição da foto", ListaCampos.DB_SI, true);
		...
		adicCampo(txtAltFotoProd, 90, 110, 77, 20, "AltFotoProd", "Altura",
				ListaCampos.DB_SI, true);
		adicDB(imFotoProd, 350, 20, 150, 140, "FotoProd", "Foto: (máx. 63K)",
				true);
