 ...
 * <BR>
 * 
 * Tela de cadastro das prefer�ncias do sistema. Esse cadastro � utilizado para
 * parametrizar o sistema de acordo com as necessidades espec�ficas da empresa.
 *  
 */
...
public class FPrefereGeral extends FTabDados implements CheckBoxListener,
	...
	public FPrefereGeral() {
		...
		cbDescCompl = new JCheckBoxPad("Usar descri��o completa do produto para Or�amento e Pedido?", "S", "N");
		...
		adicDescFK(txtDescTransp, 85, 280, 250, 20, "RazTran","Raz�o social da transp.padrao para venda");
		...
		adicCampo(txtCodTab, 10, 25, 77, 20, "CodTab", "C�d.tab.pc.",ListaCampos.DB_FK, txtDescTab, false);
		adicDescFK(txtDescTab, 90, 25, 260, 20, "DescTab","Descri��o da tabela de pre�os");
		adicCampo(txtCodPlanoPag, 10, 65, 77, 20, "CodPlanoPag", "C�d.p.pag.",ListaCampos.DB_FK, txtDescPlanoPag, false);
		adicDescFK(txtDescPlanoPag, 90, 65, 260, 20, "DescPlanoPag","Descri��o do plano de pagamento");
		adicCampo(txtCodClasCli, 10, 105, 77, 20, "CodClasCli", "C�d.c.cli",ListaCampos.DB_FK, txtDescClasCli, false);
		adicDescFK(txtDescClasCli, 90, 105, 260, 20, "DescClasCli","Descri��o da classifica��o dos clientes");
		...
		adicDescFK(txtDescTipoMov2, 90, 25, 230, 20, "DescTipoMov","Tipo de movimento para or�amentos.");
		adicCampo(txtDescClassOrc, 330, 25, 250, 20, "ClassOrc","Classe padr�o para or�amento.", ListaCampos.DB_SI, false);
		adicCampo(txtTitOrcTxt01, 330, 65, 250, 20, "TitOrcTxt01","T�tulo para campo TXT01", ListaCampos.DB_SI, false);
		adicDB(rgTipoValidOrc, 460, 230, 250, 30, "tipovalidorc","Validade na impress�o", true);
		...
		adicCampo(txtCodMoeda, 10, 20, 77, 20, "CodMoeda", "C�d.moeda",ListaCampos.DB_FK, txtDescMoeda, true);
		adicDescFK(txtDescMoeda, 90, 20, 230, 20, "SingMoeda","Descri��o da moeda corrente.");	
		adicDB(rgLibCred, 10, 60, 310, 80, "PrefCred", "Verifica��o de cr�dito",true);
		...
		adicCampo(txtCodTabJuros, 20, 240, 70, 20, "CodTbj", "C�d.tab.jr.",ListaCampos.DB_FK, txtDescTabJuros, false);
		adicDescFK(txtDescTabJuros, 93, 240, 250, 20, "DescTbj","Descri��o da tabela de juros.");
		...
		adicDB(cbTamDescProd, 20, 230, 300, 20, "TamDescProd", "Tamanho da descri��o do produto", false);
		...
		adicCampo(txtCodTipoMov8, 7, 75, 80, 20, "CodTipoMov8", "C�d.tp.mov.",ListaCampos.DB_FK, txtDescTipoMov8, false);
		adicDescFK(txtDescTipoMov8, 90, 75, 250, 20, "DescTipoMov","Descri��o do tp. mov. para RMA");
		...
		adicCampo(txtCodTipoMov7, 7, 65, 80, 20, "CodTipoMov", "C�d.tp.mov.",ListaCampos.DB_FK, txtDescTipoMov7, false);
		adicDescFK(txtDescTipoMov7, 90, 65, 230, 20, "DescTipoMov","Descri��o do tipo de movimento");
		adicCampo(txtCodPlanoPag2, 7, 105, 80, 20, "CodPlanoPag","C�d.p.pag.", ListaCampos.DB_FK, txtDescPlanoPag2, false);
		adicDescFK(txtDescPlanoPag2, 90, 105, 230, 20, "DescPlanoPag","Descri��o do plano de pagamento");
		adicCampo(txtCodCli, 7, 145, 80, 20, "CodCli", "C�d.cli.",ListaCampos.DB_FK, txtDescCli, false);
		adicDescFK(txtDescCli, 90, 145, 230, 20, "NomeCli", "Nome do cliente");
		adicCampo(txtPrazo, 330, 105, 250, 20, "Prazo","Prazo de Entrega do Or�amento", ListaCampos.DB_SI, false);
		adicCampo(txtDiasVencOrc, 330, 145, 250, 20, "DiasVencOrc", "Dias p/ vencimento do or�amento",ListaCampos.DB_SI, false);
		...
		JLabelPad lbServer = new JLabelPad("   Configura��es para envio de email");
	...
	public void beforePost(PostEvent pevt) {
		if (txtCasasDec.getVlrInteger().intValue() > 5) {
			Funcoes.mensagemErro(this,
					"N�mero de casas decimais acima do permitido!");
