...
public class DLEditaPag extends FFDialogo implements CarregaListener {
  ...
  public DLEditaPag(Component cOrig) {
    ...
    adic(new JLabel("Nº conta"),7,40,250,20);
    adic(txtCodConta,7,60,80,20);
    adic(new JLabel("Descrição da conta"),90,40,250,20);
    adic(txtDescConta,90,60,250,20);
    adic(new JLabel("Cód.catg."),7,80,250,20);
    adic(txtCodPlan,7,100,100,20);
    adic(new JLabel("Descrição da categoria"),110,80,250,20);
    adic(txtDescPlan,110,100,230,20);
	adic(new JLabel("Cód.c.c."),7,120,250,20);
	adic(txtCodCC,7,140,100,20);
	adic(new JLabel("Descrição do centro de custo"),110,120,250,20);
