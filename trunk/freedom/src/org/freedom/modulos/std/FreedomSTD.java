...
public class FreedomSTD extends Aplicativo {
  public FreedomSTD() {
	...
	addOpcao(-1,TP_OPCAO_MENU,"Arquivo",'A',100000000,0,false, null);
	  addOpcao(100000000,TP_OPCAO_MENU,"Tabelas",'T',100100000,1,false, null);
	    addOpcao(100100000,TP_OPCAO_MENU,"Cliente",'C',100101000,2,false, null);
	      addOpcao(100101000,TP_OPCAO_ITEM,"Tipo de cliente...",'T',100101010,3,true, FTipoCli.class);
	      addOpcao(100101000,TP_OPCAO_ITEM,"Classificação de cliente...", 'f', 100101020,3,true, FClasCli.class);
	      addOpcao(100101000,TP_OPCAO_ITEM,"Cliente...", 'C',100101030,3,true, FCliente.class);
		  addOpcao(100101000,TP_OPCAO_ITEM,"Tipo fiscal de cliente...",'p',100101040,3,true, FTipoFiscCli.class);
		  addOpcao(100101000,TP_OPCAO_ITEM,"Crédito por cliente...",'r',100101050,3,true, FCredCli.class);
	    addOpcao(100100000,TP_OPCAO_MENU,"Vendedor",'C',100102000,2,false, null);
	      addOpcao(100102000,TP_OPCAO_ITEM,"Setor", 'S',100102010,3,true, FSetor.class);
	      addOpcao(100102000,TP_OPCAO_ITEM,"Vendedor", 'V',100102020,4,true, FVendedor.class);
	      addOpcao(100102000,TP_OPCAO_ITEM,"Classif. de Comissões", 'P',100102030,5,true, FCLComis.class);
	      
	      
        addSeparador(100100000);
        addOpcao(100100000,TP_OPCAO_ITEM,"Moeda",'M',100112000,2,true, FMoeda.class);
	    addOpcao(100100000,TP_OPCAO_ITEM,"Banco",'B',100113000,2,true, FBanco.class);
	    addOpcao(100100000,TP_OPCAO_ITEM,"Tipo de cobrança",'o',100114000,2,true, FTipoCob.class);
	    addOpcao(100100000,TP_OPCAO_ITEM,"Plano de pagamento",'s',100115000,2,true, FPlanoPag.class);
	 //   addOpcao(100100000,TP_OPCAO_ITEM,"Tipo de expositor",'x',100116000,2,true, FTipoExp.class);	    
	    addSeparador(100100000);	    
	    addOpcao(100100000,TP_OPCAO_ITEM,"Transportadora",'p',100117000,2,true, FTransp.class);  	    
	    addSeparador(100100000);	    
	    addOpcao(100100000,TP_OPCAO_ITEM,"Tipo de fornecedor",'e',100118000,2,true, FTipoFor.class);  
	    addOpcao(100100000,TP_OPCAO_ITEM,"Fornecedor",'r',100119000,2,true, null);    
	    addSeparador(100100000);
        addOpcao(100100000,TP_OPCAO_ITEM,"Natureza de operação",'z',100120000,2,true, FNatoPer.class);
	    addSeparador(100100000);
	    addOpcao(100100000,TP_OPCAO_MENU,"Produto",'u',100130000,2,false, null);
          addOpcao(100130000,TP_OPCAO_ITEM,"Tratamento tributário",'t',100130010,3,true, FTratTrib.class);
          addOpcao(100130000,TP_OPCAO_ITEM,"Classificação fiscal",'l',100130020,3,true, FCLFiscal.class);
          addOpcao(100130000,TP_OPCAO_ITEM,"Almoxarifado",'x',100130030,3,true, FAlmox.class);
          addOpcao(100130000,TP_OPCAO_ITEM,"Grupo",'r',100130040,3,true, FGrupo.class);
          addOpcao(100130000,TP_OPCAO_ITEM,"Marca",'c',100130050,3,true, FMarca.class);
          addOpcao(100130000,TP_OPCAO_ITEM,"Unidade",'U',100130060,3,true, FUnidade.class);
          addOpcao(100130000,TP_OPCAO_ITEM,"Produto",'P',100130070,3,true, FProduto.class);
	      addSeparador(100130000);
          addOpcao(100130000,TP_OPCAO_ITEM,"Similaridade",'S',100130080,3,true, FSimilar.class);
          addOpcao(100130000,TP_OPCAO_MENU,"Grade de produtos",'G',100130090,3,false, null);        
	        ...
	        addOpcao(100130090,TP_OPCAO_ITEM,"Modelo",'M',100130092,4,true, null);
            addOpcao(100130090,TP_OPCAO_ITEM,"Grade",'r',100130093,4,true, null);
	    addSeparador(100100000);
        addOpcao(100100000,TP_OPCAO_MENU,"Preço",'ç',100140000,2,false, null);
          addOpcao(100140000,TP_OPCAO_ITEM,"Manutenção de Preços",'M',100140010,3,true, null);
          addOpcao(100140000,TP_OPCAO_ITEM,"Copia preço",'i',100140020,3,true, null);
          addOpcao(100140000,TP_OPCAO_ITEM,"Tabela de preço",'a',100140030,3,true, null);
          addOpcao(100140000,TP_OPCAO_ITEM,"Lista de preço",'l',100140040,3,true, null);
            
	addOpcao(100000000,TP_OPCAO_MENU,"Ferramentas",'F',100200000,1,false, null);
	  addOpcao(100200000,TP_OPCAO_ITEM,"Alteração de numero de nota",'A',100210000,2,true, null);
	 // addOpcao(100200000,TP_OPCAO_ITEM,"Exportar SVV",'E',100220000,2,true);
      ...
      addOpcao(100200000,TP_OPCAO_MENU,"Bloqueios e desbloqueios",'B',100260000,2,false, null);
         addOpcao(100260000,TP_OPCAO_ITEM,"Compras",'C',100260100,3,true, null);
         addOpcao(100260000,TP_OPCAO_ITEM,"Vendas",'V',100260200,3,true, null);
      addOpcao(100200000,TP_OPCAO_ITEM,"Canc. de vínc. venda x orçamento",'v',100270000,2,true, null);
	addOpcao(100000000,TP_OPCAO_MENU,"Preferências",'P',100300000,1,false, null);
	  ...
	  addOpcao(100300000,TP_OPCAO_ITEM,"Série de NFs",'N',100320000,2,true, null);
	  addOpcao(100300000,TP_OPCAO_ITEM,"Modelo de NFs",'M',100330000,2,true, null);
	addSeparador(100100000);
	addOpcao(100000000,TP_OPCAO_MENU,"Configurações",'C',100400000,1,false, null);
	  addOpcao(100400000,TP_OPCAO_ITEM,"Caixa PDV",'C',100410000,2,true, null);		  
	  ...
	  addOpcao(100400000,TP_OPCAO_ITEM,"Estação de trabalho",'E',100440000,2,true, null);// lom
	  addSeparador(100400000);
	  addOpcao(100400000,TP_OPCAO_ITEM,"Empresa",'E',100450000,2,true, null);	  	  

  addOpcao(-1,TP_OPCAO_MENU,"Entrada",'E',200000000,0,false, null);
    addOpcao(200000000,TP_OPCAO_ITEM,"Compra",'C',200100000,1,true, FCompra.class);
	addOpcao(200000000,TP_OPCAO_MENU,"Listagens",'L',200200000,1,false, null);
	  addOpcao(200200000,TP_OPCAO_ITEM,"Compras por fornecedor",'f',200210000,2,true, FRComprasFor.class);
  ...
  addOpcao(-1,TP_OPCAO_MENU,"Saída",'S',300000000,0,false, null);
	...
	addOpcao(300000000,TP_OPCAO_ITEM,"Lançamento de expositores",'x',300900000,1,true, null);
	addOpcao(300000000,TP_OPCAO_MENU,"Listagens",'s',301000000,1,false, null);				
	  ...
	  addOpcao(301000000,TP_OPCAO_ITEM,"Gerenciamento de contas",'i',301090000,2,true, null);
  ...
  addOpcao(-1,TP_OPCAO_MENU,"Pagar",'P',400000000,0,false, null);
    addOpcao(400000000,TP_OPCAO_ITEM,"Comissão",'C',400100000,1,true, null);
	...
	addOpcao(400000000,TP_OPCAO_MENU,"Listagens",'s',400300000,1,false, null);				
	  ...
	  addOpcao(400300000,TP_OPCAO_ITEM,"Comissões",'C',400420000,2,true, null);
  ...
  addOpcao(-1,TP_OPCAO_MENU,"Receber",'R',500000000,0,false, null);
    ...
    addOpcao(500000000,TP_OPCAO_MENU,"Listagens",'s',500300000,1,false, null);				
	  ...
	  addOpcao(500300000,TP_OPCAO_ITEM,"Bordero de cobrança",'B',500330000,2,true, null);
  ...
  addOpcao(-1,TP_OPCAO_MENU,"Financeiro",'F',600000000,0,false, null);
	...
	addSeparador(600000000);
	addOpcao(600000000,TP_OPCAO_ITEM,"Tabela de juros",'T',600900000,1,true, null);
	addSeparador(600000000);
	addOpcao(600000000,TP_OPCAO_ITEM,"Reprocessa saldo",'R',601000000,1,true, null);
	addSeparador(600000000);
    addOpcao(600000000,TP_OPCAO_MENU,"Listagens",'s',601100000,1,false, null);				
  	  addOpcao(601100000,TP_OPCAO_ITEM,"Extrato",'E',601110000,2,true, null);
	  addOpcao(601100000,TP_OPCAO_ITEM,"Balancete",'B',601120000,2,true, null);
	  addOpcao(601100000,TP_OPCAO_ITEM,"Relatório financeiro por C.C.",'R',601130000,2,true, null);
      addOpcao(601100000,TP_OPCAO_ITEM,"Razão financeiro",'z',601140000,2,true, null);
      addOpcao(601100000,TP_OPCAO_ITEM,"Fluxo de caixa",'F',601150000,2,true, null);
	addOpcao(600000000,TP_OPCAO_MENU,"Gráficos",'G',601200000,1,false, null);
	  addOpcao(601200000,TP_OPCAO_ITEM,"Balancete Gráfico",'G',601210000,2,true, null);
	  addOpcao(601200000,TP_OPCAO_ITEM,"Gráfico financeiro por C.C",'f',601220000,2,true, null);
  
  addOpcao(-1,TP_OPCAO_MENU,"Estoque",'E',700000000,0,false, null);
    addOpcao(700000000,TP_OPCAO_ITEM,"Kardex",'K',700100000,1,true, null);
	addOpcao(700000000,TP_OPCAO_ITEM,"Inventário",'I',700200000,1,true, null);
	addOpcao(700000000,TP_OPCAO_ITEM,"Consulta estoque",'C',700300000,1,true, null);
	addOpcao(700000000,TP_OPCAO_ITEM,"Consulta produto",'P',700400000,1,true, null);
	addOpcao(700000000,TP_OPCAO_ITEM,"Tipos de movimentos",'T',700500000,1,true, null);		
	addSeparador(700000000);
	addOpcao(700000000,TP_OPCAO_ITEM,"Reprocessa estoque",'R',700600000,1,true, null);
	addSeparador(700000000);
	addOpcao(700000000,TP_OPCAO_MENU,"Listagens",'L',700700000,1,false, null);
  	  addOpcao(700700000,TP_OPCAO_ITEM,"Estoque mínimo",'s',700701000,2,true, null);
  	  addOpcao(700700000,TP_OPCAO_ITEM,"Produtos/Movimentos",'P',700702000,2,true, null);
	  addOpcao(700700000,TP_OPCAO_ITEM,"Vencimentos de lote",'V',700703000,2,true, null);
	  addOpcao(700700000,TP_OPCAO_ITEM,"Saldos de lote",'l',700704000,2,true, null);
	  addOpcao(700700000,TP_OPCAO_ITEM,"Demanda",'D',700705000,2,true, null);
	  addOpcao(700700000,TP_OPCAO_ITEM,"Conferência",'C',700706000,2,true, null);
	  addOpcao(700700000,TP_OPCAO_ITEM,"Inventário",'I',700707000,2,true, null);
	  
  addOpcao(-1,TP_OPCAO_MENU,"Fiscal",'F',800000000,0,false, null);
    addOpcao(800000000,TP_OPCAO_ITEM,"Gerar",'G',800100000,1,true, null);
	addOpcao(800000000,TP_OPCAO_ITEM,"Regras fiscais",'R',800200000,1,true, null);
	addOpcao(800000000,TP_OPCAO_ITEM,"Sintegra",'S',800300000,1,true, null);
	addOpcao(800000000,TP_OPCAO_ITEM,"Tabela de Alíquotas",'T',800400000,1,true, null);
	addOpcao(800000000,TP_OPCAO_ITEM,"Mensagens",'M',800500000,1,true, null);
	addOpcao(800000000,TP_OPCAO_MENU,"Listagens",'L',800600000,1,false, null);
	  addOpcao(800600000,TP_OPCAO_ITEM,"ICMS sobre vendas",'I',800601000,2,true, null);
	  addOpcao(800600000,TP_OPCAO_ITEM,"Impostos sobre serviços",'S',800602000,2,true, null);
	  addOpcao(800600000,TP_OPCAO_ITEM,"Pis e cofins",'P',800603000,2,true, null);
  ...
  public void execOpcao( int iOpcao ) {
    if (iOpcao==100101010) {
      ...
      if (telaPrincipal.temTela("Comissao")==false) {
        ...
        //tela.setConexao(con);
        telaPrincipal.criatela("Comissao",tela,con);
      }
    }
      ...
      if (telaPrincipal.temTela("Copia Precos")==false) {
        ...
        //tela.setConexao(con);
        telaPrincipal.criatela("Copia Precos",tela,con);
      }
    }
      ...
      if (telaPrincipal.temTela("Manutenção de Preços")==false) {
        ...
        //tela.setConexao(con);
        telaPrincipal.criatela("Manutenção de Preços",tela,con);
      }
    }
      ...
      if (telaPrincipal.temTela("Lista de Preços")==false) {
        ...
        //tela.setConexao(con);
        telaPrincipal.criatela("Lista de Preços",tela,con);
      }
    }
      ...
      if (telaPrincipal.temTela("Físico de Vendas")==false) {
    	...
    	if (telaPrincipal.temTela("Consulta produto")==false) {
    		...
    		tela.setTelaPrim(telaPrincipal);
    		telaPrincipal.criatela("Consulta produto",tela,con);    	
    		//tela.setConexao(con);
    	}
    }    
      ...
      if (telaPrincipal.temTela("Icms Vendas e Compras")==false) {
        ...
        //tela.setConexao(con);
        telaPrincipal.criatela("Icms Vendas e Compras",tela,con);
      }
    }
        ...
        if (telaPrincipal.temTela("Impostos sobre serviços")==false) {
          ...
          //tela.setConexao(con);
          telaPrincipal.criatela("Impostos sobre Serviços",tela,con);
        }
        ...
        if (telaPrincipal.temTela("Pis e cofins")==false) {
          ...
          //tela.setConexao(con);
          telaPrincipal.criatela("Pis e cofins",tela,con);
        }
      ...
      if (telaPrincipal.temTela("Gera Fiscal")==false) {
        ...
        //tela.setConexao(con);
        telaPrincipal.criatela("Gera Fiscal",tela,con);
      }
    }
      ...
      if (telaPrincipal.temTela("Gera Arquivo Sintegra")==false) {
        ...
        telaPrincipal.criatela("Gera Arquivo Sintegra",tela,con);
      }
    }
      ...
      if (telaPrincipal.temTela("Media de vendas por item")==false) {
    	...
    	if (telaPrincipal.temTela("Gerenciamento de contas")==false) {
    		...
    		//tela.setConexao(con);
    		telaPrincipal.criatela("Gerenciamento de contas",tela,con);
    	}
    }    
      ...
      if (telaPrincipal.temTela("Inadimplentes")==false) {
        ...
        if (telaPrincipal.temTela("Bordero de cobrança")==false) {
          ...
          //tela.setConexao(con);
          telaPrincipal.criatela("Bordero de cobrança",tela,con);
        }
      }
      ...
      if (telaPrincipal.temTela("Comissão")==false) {
        ...
        //tela.setConexao(con);
        telaPrincipal.criatela("Comissão",tela,con);
      }
    }
	  ...
	  if (telaPrincipal.temTela("Gráfico Financeiro por C.C")==false) {
       ...
       if (telaPrincipal.temTela("Empresa")==false) {
    	...
    	if (telaPrincipal.temTela("Alteração de doc")==false) {
    		...
    		//tela.setConexao(con);
    		telaPrincipal.criatela("Alteração de doc",tela,con);
    	}
    }	
    	...
    	if (telaPrincipal.temTela("Exportação SVV")==false) {
    		FSVV tela = new FSVV();		
    		//tela.setConexao(con);
    		telaPrincipal.criatela("Exportação SVV",tela,con);
    	}
    }	
        ...
        if (telaPrincipal.temTela("Bloqueio e desbloqueio de compras")==false) {
            ...
            //tela.setConexao(con);
            telaPrincipal.criatela("Bloqueio e desbloqueio de compras",tela,con);
        }
    }
        ...
        if (telaPrincipal.temTela("Bloqueio e desbloqueio de vendas")==false) {
            ...
            //tela.setConexao(con);
            telaPrincipal.criatela("Bloqueio e desbloqueio de vendas",tela,con);
        }
    }
        ...
        if (telaPrincipal.temTela("Canc. de vínc. venda x orçamento")==false) {
            ...
            //tela.setConexao(con);
            telaPrincipal.criatela("Canc. de vínc. venda x orçamento",tela,con);
        }
    }
