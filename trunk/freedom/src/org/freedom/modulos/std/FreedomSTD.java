...
public class FreedomSTD extends AplicativoPD {
	...
	protected void montaMenu() {
		...
		addOpcao( 100200000, TP_OPCAO_ITEM, "Alteração de número de doc.", "Alteração de doc", 'A', 100201000, 2, true, FTrocaDoc.class );
		addOpcao( 100200000, TP_OPCAO_ITEM, "Alteração de número do recibo", "Alteração do número do recibo", 'P', 100202000, 2, true, FAlteraRecibo.class );
		addOpcao( 100200000, TP_OPCAO_ITEM, "Alteração cliente/receber", "Alteração cliente/receber", 'R', 100203000, 2, true, FAlteraCliRec.class );
		...
		addOpcao( 300000000, TP_OPCAO_ITEM, "Lançamento canhotos de entrega", "Lançamento de canhotos de entrega", 'h', 300900000, 1, true, FEntrega.class );
		...
		addOpcao( 301000000, TP_OPCAO_ITEM, "Evolução anual de vendas", "Evolução anual de vendas", 'E', 301002800, 2, true, FREvolucaoAnualVendas.class );
		...
		addOpcao( 700700000, TP_OPCAO_ITEM, "Codificação de produto", "Codificação de produto", 'P', 700700800, 2, true, FRCodficProd.class );
