...
public class FRMovProd extends FRelatorio {
  ...
  private JLabelPad lbForn = new JLabelPad("Cód.for.");
  private JLabelPad lbDescForn = new JLabelPad("Descrição do fornecedor");
  private JLabelPad lbGrupo = new JLabelPad("Cód.grupo");
