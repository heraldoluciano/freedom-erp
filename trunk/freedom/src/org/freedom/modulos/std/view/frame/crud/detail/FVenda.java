...
public class FVenda extends FVD implements PostListener, CarregaListener, FocusListener, ActionListener, InsertListener, DeleteListener, KeyListener, InterVenda {
	...
	private enum POS_PREFS {
		...
		VENDAMATCONSUM, OBSITVENDAPED, BLOQSEQIVD, VDPRODQQCLAS, CONSISTENDENTVD, BLOQDESCCOMPVD, BLOQPRECOVD, BLOQCOMISSVD, BLOQPEDVD
	}
	...
	private void imprimir( TYPE_PRINT bVisualizar, int iCodVenda, String origimp ) {
		...
		try {
			...
			sSQL.append( "C.UFCLI,C.FONECLI,C.FONECLI,C.FAXCLI,C.INSCCLI,C.RGCLI, C.CONTCLIENT, I.CODPROD,P.REFPROD,P.CODBARPROD,P.CODUNID, " );
			...
			sSQL.append( "C.FONEENT, VF.PLACAFRETEVD, VF.PESOBRUTVD, VF.PESOLIQVD, VF.QTDFRETEVD, P.DESCCOMPPROD, V.OBSVENDA, VF.QTDFRETEVD, C.NOMECLI, C.NUMENT, V.SERIE ");
	...
	private Object[] prefs() {
		...
		try {
			...
			sSQL.append( "P1.VDPRODQQCLAS, P1.CONSISTENDENTVD, P1.BLOQDESCCOMPVD, P1.BLOQPRECOVD, P1.BLOQCOMISSVD, P1.BLOQPEDVD " );
