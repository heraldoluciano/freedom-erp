...
import org.freedom.modulos.std.view.dialog.comum.DLChecaLFSaida;
		...
		try {
			...
			if ( cbSaida.getVlrString().equals( "S" ) ) {
				...
				sSQL = "SELECT V.TIPOVENDA, V.DTEMITVENDA,V.DTSAIDAVENDA,IV.CODNAT," 
						...
						+ "SELECT V.TIPOVENDA,V.DTEMITVENDA, V.DTSAIDAVENDA, IV.CODNAT," + "V.CODCLI, C.UFCLI, TM.ESPECIETIPOMOV, TM.CODMODNOTA," 
						+ "V.SERIE, L.PRIMCUPOMLX DOCVENDA, L.ULTCUPOMLX DOCFIM,IV.PERCICMSITVENDA, CF.ALIQLFISC, IV.PERCIPIITVENDA," 
