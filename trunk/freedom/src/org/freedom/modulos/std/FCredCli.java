...
public class FCredCli extends FTabDados implements ActionListener,
	...
	private JPanelPad pinDetRefP = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());

	private JPanelPad pinDetAutP = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());

	private JPanelPad pinDetVeic = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());

	private JPanelPad pinDetImov = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());

	private JPanelPad pinDetTerras = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());

	private JPanelPad pinDetBancos = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());

	private JPanelPad pinDetSocios = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());

	private JPanelPad pinDetRefC = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());
	...
	private JPanelPad pnRefP = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());

	private JPanelPad pnAutP = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());

	private JPanelPad pnVeic = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());

	private JPanelPad pnImov = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());

	private JPanelPad pnTerras = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());

	private JPanelPad pnBancos = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());

	private JPanelPad pnSocios = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());

	private JPanelPad pnRefC = new JPanelPad(JPanelPad.TP_JPANEL,
			new BorderLayout());
	...
	private JTextFieldFK txtDataCli = new JTextFieldFK(JTextFieldPad.TP_DATE,
			10, 0);
	...
	private JTextFieldPad txtCodTpCred = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 5, 0);

	private JTextFieldFK txtDescTpCred = new JTextFieldFK(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldFK txtVlrTpCred = new JTextFieldFK(
			JTextFieldPad.TP_DECIMAL, 15, 2);

	private JTextFieldPad txtDtIniTr = new JTextFieldPad(JTextFieldPad.TP_DATE,
			10, 0);

	private JTextFieldPad txtDtVencto = new JTextFieldPad(
			JTextFieldPad.TP_DATE, 10, 0);

	private JTextFieldPad txtRazCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtEndCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtNumCli = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 8, 0);

	private JTextFieldPad txtComplCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 20, 0);

	private JTextFieldPad txtBairCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtCidCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtUFCli = new JTextFieldPad(JTextFieldPad.TP_STRING,
			2, 0);

	private JTextFieldPad txtCepCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 8, 0);

	private JTextFieldPad txtFoneCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 12, 0);

	private JTextFieldPad txtRamalCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 8, 0);

	private JTextFieldPad txtFaxCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 8, 0);

	private JTextFieldPad txtCelCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 8, 0);

	private JTextFieldPad txtNatCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtApelidoCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtUFNatCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 2, 0);

	private JTextFieldPad txtTempoResCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 20, 0);

	private JTextFieldPad txtDDDCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 4, 0);

	private JTextFieldPad txtDDDFaxCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 4, 0);

	private JTextFieldPad txtDDDCelCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 4, 0);

	private JTextFieldPad txtPaiCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtRgPaiCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 10, 0);

	private JTextFieldPad txtSSPPaiCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 10, 0);

	private JTextFieldPad txtMaeCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtRgMaeCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 10, 0);

	private JTextFieldPad txtSSPMaeCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 10, 0);

	private JTextFieldPad txtEmpTrabCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtFuncaoTrabCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 20, 0);

	private JTextFieldPad txtDtAdmTrabCli = new JTextFieldPad(
			JTextFieldPad.TP_DATE, 10, 0);

	private JTextFieldPad txtRendaTrabCli = new JTextFieldPad(
			JTextFieldPad.TP_NUMERIC, 15, 2);

	private JTextFieldPad txtDDDTrabCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 4, 0);

	private JTextFieldPad txtFoneTrabCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 8, 0);

	private JTextFieldPad txtRamalTrabCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 8, 0);

	private JTextFieldPad txtEndTrabCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtNumTrabCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 8, 0);

	private JTextFieldPad txtComplTrabCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 20, 0);

	private JTextFieldPad txtBairTrabCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtCidTrabCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtUfTrabCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 2, 0);

	private JTextFieldPad txtCepTrabCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 8, 0);

	private JTextFieldPad txtOutRendaCli = new JTextFieldPad(
			JTextFieldPad.TP_NUMERIC, 15, 2);

	private JTextFieldPad txtFontRendaCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtNomeConjCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtDtNascConjCli = new JTextFieldPad(
			JTextFieldPad.TP_DATE, 10, 0);

	private JTextFieldPad txtRgConjCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 10, 0);

	private JTextFieldPad txtSSPConjCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 10, 0);

	private JTextFieldPad txtCPFConjCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 11, 0);

	private JTextFieldPad txtNatConjCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 20, 0);

	private JTextFieldPad txtUfNatConjCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 2, 0);

	private JTextFieldPad txtEmpTrabConjCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtFuncaoConjCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 20, 0);

	private JTextFieldPad txtDtAdmTrabConjCli = new JTextFieldPad(
			JTextFieldPad.TP_DATE, 10, 0);

	private JTextFieldPad txtRendaConjCli = new JTextFieldPad(
			JTextFieldPad.TP_DECIMAL, 15, 2);

	private JTextFieldPad txtNomeAvalCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtDtNascAvalCli = new JTextFieldPad(
			JTextFieldPad.TP_DATE, 10, 0);

	private JTextFieldPad txtRgAvalCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 10, 0);

	private JTextFieldPad txtSSPAvalCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 10, 0);

	private JTextFieldPad txtCPFAvalCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 11, 0);

	private JTextFieldPad txtEmpTrabAvalCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtFuncaoAvalCli = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 20, 0);
	...
	private JTextFieldPad txtCodFilialTb = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 5, 0);

	private JTextFieldPad txtCodTb = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 5, 0);

	private JTextFieldPad txtCodTipoCob = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 8, 0);

	private JTextFieldFK txtDescTipoCob = new JTextFieldFK(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtEndCob = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtNumCob = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 8, 0);

	private JTextFieldPad txtComplCob = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 20, 0);

	private JTextFieldPad txtBairCob = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtCidCob = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtCepCob = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 8, 0);

	private JTextFieldPad txtUFCob = new JTextFieldPad(JTextFieldPad.TP_STRING,
			2, 0);

	private JTextFieldPad txtDDDFoneCob = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 4, 0);

	private JTextFieldPad txtFoneCob = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 12, 0);

	private JTextFieldPad txtDDDFaxCob = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 4, 0);

	private JTextFieldPad txtFaxCob = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 8, 0);

	private JTextFieldPad txtCodRefP = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 5, 0);

	private JTextFieldPad txtNomeRefP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtEndRefP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtNumRefP = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 8, 0);

	private JTextFieldPad txtComplRefP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtBairRefP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtCidRefP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtCepRefP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 8, 0);

	private JTextFieldPad txtUfRefP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 2, 0);

	private JTextFieldPad txtDDDRefP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 4, 0);

	private JTextFieldPad txtFoneRefP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 12, 0);

	private JTextFieldPad txtCodAutP = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 5, 0);

	private JTextFieldPad txtNomeAutP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtEndAutP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtNumAutP = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 8, 0);

	private JTextFieldPad txtComplAutP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtBairAutP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtCidAutP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtCepAutP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 8, 0);

	private JTextFieldPad txtUfAutP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 2, 0);

	private JTextFieldPad txtDDDAutP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 4, 0);

	private JTextFieldPad txtFoneAutP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 12, 0);

	private JTextFieldPad txtRGAutP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 10, 0);

	private JTextFieldPad txtSSPAutP = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 10, 0);
	...
	private JTextFieldPad txtModeloVeic = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtAlienadoVeic = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtAnoVeic = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 4, 0);

	private JTextFieldPad txtValorVeic = new JTextFieldPad(
			JTextFieldPad.TP_DECIMAL, 15, 2);

	private JTextFieldPad txtCodImov = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 5, 0);

	private JTextFieldPad txtTipoImov = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtConstrImov = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtAreaTerImov = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtValorImov = new JTextFieldPad(
			JTextFieldPad.TP_DECIMAL, 15, 2);

	private JTextFieldPad txtCodTerra = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 5, 0);

	private JTextFieldPad txtEndTerra = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtNumTerra = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 8, 0);

	private JTextFieldPad txtBairTerra = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtAreaTerra = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtQtdCafeTerra = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 8, 0);

	private JTextFieldPad txtQtdGadoTerra = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 8, 0);

	private JTextAreaPad txaObsTerra = new JTextAreaPad();

	private JTextFieldPad txtConta = new JTextFieldPad(JTextFieldPad.TP_STRING,
			20, 0);

	private JTextFieldPad txtCodBanco = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 3, 0);

	private JTextFieldPad txtAgencia = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JTextFieldPad txtDtAbConta = new JTextFieldPad(
			JTextFieldPad.TP_DATE, 10, 0);

	private JTextFieldFK txtNomeBanco = new JTextFieldFK(
			JTextFieldPad.TP_STRING, 40, 0);

	private JTextFieldPad txtCodRefC = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 5, 0);

	private JTextFieldPad txtNomeEmpRefC = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtDDDRefC = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 4, 0);

	private JTextFieldPad txtFoneRefC = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 12, 0);

	private JTextFieldPad txtDtMaiorCpRefC = new JTextFieldPad(
			JTextFieldPad.TP_DATE, 10, 0);

	private JTextFieldPad txtVlrMaiorCpRefC = new JTextFieldPad(
			JTextFieldPad.TP_DECIMAL, 15, 2);

	private JTextFieldPad txtNroParcMaiorCpRefC = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 5, 0);

	private JTextFieldPad txtDtUltCpRefC = new JTextFieldPad(
			JTextFieldPad.TP_DATE, 10, 0);

	private JTextFieldPad txtVlrUltCpRefC = new JTextFieldPad(
			JTextFieldPad.TP_DECIMAL, 15, 2);

	private JTextFieldPad txtNroParcUltCpRefC = new JTextFieldPad(
			JTextFieldPad.TP_INTEGER, 5, 0);

	private JCheckBoxPad cbPontualRefC = new JCheckBoxPad("Sim", "S", "N");

	private JTextFieldPad txtMediaAtrasoRefC = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 20, 0);

	private JTextFieldPad txtConceitoRefC = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 30, 0);

	private JCheckBoxPad cbAvalistaRefC = new JCheckBoxPad("Sim", "S", "N");

	private JTextFieldPad txtInformanteRefC = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextAreaPad txaObsRefC = new JTextAreaPad();

	private JTextFieldPad txtNomeSocio = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 50, 0);

	private JTextFieldPad txtDtNascSocio = new JTextFieldPad(
			JTextFieldPad.TP_DATE, 10, 0);

	private JTextFieldPad txtRgSocio = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 10, 0);

	private JTextFieldPad txtSSPSocio = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 10, 0);

	private JTextFieldPad txtCPFSocio = new JTextFieldPad(
			JTextFieldPad.TP_STRING, 11, 0);

	private JTextFieldPad txtPercCotasSocio = new JTextFieldPad(
	...
	public FCredCli() {
		...
		lcTipoCli.add(new GuardaCampo(txtCodTipoCli, "CodTipoCli",
				"Cód.tp.cli.", ListaCampos.DB_PK, true));
		lcTipoCli.add(new GuardaCampo(txtDescTipoCli, "DescTipoCli",
				"Descrição do tipo de cliente", ListaCampos.DB_SI, false));
		lcTipoCli.montaSql(false, "TIPOCLI", "VD");
		lcTipoCli.setQueryCommit(false);
		lcTipoCli.setReadOnly(true);
		txtCodTipoCli.setTabelaExterna(lcTipoCli);

		lcTipoCred.add(new GuardaCampo(txtCodTpCred, "CodTpCred",
				"Cód.tp.cred.", ListaCampos.DB_PK, true));
		lcTipoCred.add(new GuardaCampo(txtDescTpCred, "DescTpCred",
				"Descrição do tipo de crédito", ListaCampos.DB_SI, false));
		lcTipoCred.add(new GuardaCampo(txtVlrTpCred, "VlrTpCred", "Valor",
		...
		lcTipoCob.add(new GuardaCampo(txtCodTipoCob, "CodTipoCob",
				"Cód.tp.cob.", ListaCampos.DB_PK, false));
		lcTipoCob.add(new GuardaCampo(txtDescTipoCob, "DescTipoCob",
				"Descrição do tipo de cobrança", ListaCampos.DB_SI, false));
		lcTipoCob.montaSql(false, "TIPOCOB", "FN");
		lcTipoCob.setQueryCommit(false);
		lcTipoCob.setReadOnly(true);
		txtCodTipoCob.setTabelaExterna(lcTipoCob);

		lcBanco.add(new GuardaCampo(txtCodBanco, "CodBanco", "Cód.Bco.",
				ListaCampos.DB_PK, false));
		lcBanco.add(new GuardaCampo(txtNomeBanco, "nomebanco", "Nome Banco",
				ListaCampos.DB_SI, false));
		...
		adicCampo(txtRazCli, 80, 20, 257, 20, "RazCli",
				"Razão social do cliente", ListaCampos.DB_SI, false);
		adicCampoInvisivel(txtCodTipoCli, "CodTipoCli", "Cód.tp.cli",
				ListaCampos.DB_FK, txtDescTipoCli, false);
		adicDescFK(txtDescTipoCli, 340, 20, 130, 20, "DescTipoCli",
				"Desc. tipo de cliente");
		adicCampo(txtDataCli, 473, 20, 95, 20, "DataCli", "Cadastro",
				ListaCampos.DB_SI, false);
		adicCampo(txtCodTpCred, 7, 60, 70, 20, "CodTpCred", "Cód.tp.cred",
				ListaCampos.DB_FK, txtDescTpCred, true);
		adicDescFK(txtDescTpCred, 80, 60, 212, 20, "DescTpCred",
				"Descrição do crédito");
		adicDescFK(txtVlrTpCred, 295, 60, 107, 20, "VlrTpCred", "Valor");
		adicCampo(txtDtIniTr, 405, 60, 80, 20, "DtIniTr", "Dt.ab.créd.",
				ListaCampos.DB_SI, true);
		adicCampo(txtDtVencto, 488, 60, 80, 20, "DtVenctoTr", "Vencimento",
				ListaCampos.DB_SI, true);
		adicCampo(txtEndCli, 7, 100, 330, 20, "EndCli", "Endereço",
				ListaCampos.DB_SI, false);
		adicCampo(txtNumCli, 340, 100, 77, 20, "NumCli", "Num.",
				ListaCampos.DB_SI, false);
		adicCampo(txtComplCli, 420, 100, 149, 20, "ComplCli", "Compl.",
				ListaCampos.DB_SI, false);
		adicCampo(txtBairCli, 7, 140, 210, 20, "BairCli", "Bairro",
				ListaCampos.DB_SI, false);
		adicCampo(txtCidCli, 220, 140, 210, 20, "CidCli", "Cidade",
				ListaCampos.DB_SI, false);
		adicCampo(txtCepCli, 433, 140, 80, 20, "CepCli", "Cep",
				ListaCampos.DB_SI, false);
		adicCampo(txtUFCli, 516, 140, 52, 20, "UFCli", "UF", ListaCampos.DB_SI,
				false);
		adicCampo(txtDDDCli, 7, 180, 60, 20, "DDDCli", "DDD",
				ListaCampos.DB_SI, false);
		adicCampo(txtFoneCli, 70, 180, 97, 20, "FoneCli", "Telefone",
				ListaCampos.DB_SI, false);
		adicCampo(txtRamalCli, 170, 180, 60, 20, "RamalCli", "Ramal",
				ListaCampos.DB_SI, false);
		adicCampo(txtDDDFaxCli, 233, 180, 60, 20, "DDDFaxCli", "DDD",
				ListaCampos.DB_SI, false);
		adicCampo(txtFaxCli, 296, 180, 97, 20, "FaxCli", "Fax",
				ListaCampos.DB_SI, false);
		adicCampo(txtDDDCelCli, 396, 180, 60, 20, "DDDCelCli", "DDD",
				ListaCampos.DB_SI, false);
		adicCampo(txtCelCli, 459, 180, 110, 20, "CelCli", "Celular",
				ListaCampos.DB_SI, false);

		adicCampo(txtEndCob, 7, 220, 330, 20, "EndCob", "Endereço de cobrança",
				ListaCampos.DB_SI, false);
		adicCampo(txtNumCob, 340, 220, 77, 20, "NumCob", "Num. cob.",
				ListaCampos.DB_SI, false);
		adicCampo(txtComplCob, 420, 220, 149, 20, "ComplCob",
				"Compl. cobrança", ListaCampos.DB_SI, false);
		adicCampo(txtBairCob, 7, 260, 210, 20, "BairCob", "Bairro cobrança",
				ListaCampos.DB_SI, false);
		adicCampo(txtCidCob, 220, 260, 210, 20, "CidCob", "Cidade cobrança",
				ListaCampos.DB_SI, false);
		adicCampo(txtCepCob, 433, 260, 80, 20, "CepCob", "Cep cobrança",
				ListaCampos.DB_SI, false);
		adicCampo(txtUFCob, 516, 260, 52, 20, "UFCob", "UF cob.",
				ListaCampos.DB_SI, false);
		adicCampo(txtDDDFoneCob, 7, 300, 40, 20, "DDDFoneCob", "DDD",
				ListaCampos.DB_SI, false);
		adicCampo(txtFoneCob, 50, 300, 97, 20, "FoneCob", "Telefone cob.",
				ListaCampos.DB_SI, false);
		adicCampo(txtDDDFaxCob, 150, 300, 40, 20, "DDDFaxCob", "DDD",
				ListaCampos.DB_SI, false);
		adicCampo(txtFaxCob, 193, 300, 97, 20, "FaxCob", "Fax cob.",
				ListaCampos.DB_SI, false);
		adicCampo(txtCodTipoCob, 293, 300, 60, 20, "CodTipoCob", "Cód.t.cob.",
				ListaCampos.DB_FK, txtDescTipoCob, false);
		adicDescFK(txtDescTipoCob, 356, 300, 211, 20, "DescTipoCob",
				"Descrição do tipo de cobrança");

		lbApelidoCli = adicCampo(txtApelidoCli, 7, 340, 170, 20, "ApelidoCli",
				"Apelido", ListaCampos.DB_SI, false);
		lbNatCli = adicCampo(txtNatCli, 180, 340, 165, 20, "NatCli",
				"Naturalidade", ListaCampos.DB_SI, false);
		lbUfNatCli = adicCampo(txtUFNatCli, 348, 340, 52, 20, "UfNatCli",
				"Uf Natur.", ListaCampos.DB_SI, false);
		lbTempoResCli = adicCampo(txtTempoResCli, 403, 340, 165, 20,
				"TempoResCli", "Tempo de residência.", ListaCampos.DB_SI, false);

		adicCampoInvisivel(txtCodEmpTb, "codempec", "cod. emp.",
				ListaCampos.DB_SI, false);
		adicCampoInvisivel(txtCodFilialTb, "codfilialec", "cod. filial",
				ListaCampos.DB_SI, false);
		adicCampoInvisivel(txtCodTb, "codtbec", "cod. emp.", ListaCampos.DB_SI,
				false);

		cbEstCivCli = new JComboBoxPad(new Vector(), new Vector(),
				JComboBoxPad.TP_INTEGER, 5, 0);
		lbEstadoCivil = adicDB(cbEstCivCli, 7, 380, 200, 25, "codittbec",
				"Estado civil", false);
		...
		lbPaiCli = adicCampo(txtPaiCli, 7, 20, 315, 20, "PaiCli",
				"Nome do pai", ListaCampos.DB_SI, false);
		lbRgPaiCli = adicCampo(txtRgPaiCli, 325, 20, 130, 20, "RgPaiCli", "Rg",
				ListaCampos.DB_SI, false);
		lbSSPPaiCli = adicCampo(txtSSPPaiCli, 458, 20, 100, 20, "SSPPaiCli",
				"Orgão exp.", ListaCampos.DB_SI, false);
		lbMaeCli = adicCampo(txtMaeCli, 7, 60, 315, 20, "MaeCli",
				"Nome da mãe", ListaCampos.DB_SI, false);
		lbRgMaeCli = adicCampo(txtRgMaeCli, 325, 60, 130, 20, "RgMaeCli", "Rg",
				ListaCampos.DB_SI, false);
		lbSSPMaeCli = adicCampo(txtSSPMaeCli, 458, 60, 100, 20, "SSPMaeCli",
				"Orgão exp.", ListaCampos.DB_SI, false);

		setPainel(pinTrabalho);

		lbEmpTrabCli = adicCampo(txtEmpTrabCli, 7, 20, 310, 20, "EmpTrabCli",
				"Empresa onde trabalha", ListaCampos.DB_SI, false);
		lbFuncaoTrabCli = adicCampo(txtFuncaoTrabCli, 320, 20, 165, 20,
				"CargoTrabCli", "Funcao", ListaCampos.DB_SI, false);
		lbDtAdmTrabCli = adicCampo(txtDtAdmTrabCli, 488, 20, 81, 20,
				"DtAdmTrabCli", "Dt.Admis.", ListaCampos.DB_SI, false);
		lbEndTrabCli = adicCampo(txtEndTrabCli, 7, 60, 330, 20, "EndTrabCli",
				"Endereço", ListaCampos.DB_SI, false);
		lbNumTrabCli = adicCampo(txtNumTrabCli, 340, 60, 77, 20, "NumTrabCli",
				"Num.", ListaCampos.DB_SI, false);
		lbComplTrabCli = adicCampo(txtComplTrabCli, 420, 60, 149, 20,
				"ComplTrabCli", "Compl.", ListaCampos.DB_SI, false);
		lbBairTrabCli = adicCampo(txtBairTrabCli, 7, 100, 210, 20,
				"BairTrabCli", "Bairro", ListaCampos.DB_SI, false);
		lbCidTrabCli = adicCampo(txtCidTrabCli, 220, 100, 210, 20,
				"CidTrabCli", "Cidade", ListaCampos.DB_SI, false);
		lbCepTrabCli = adicCampo(txtCepTrabCli, 433, 100, 80, 20, "CepTrabCli",
				"Cep", ListaCampos.DB_SI, false);
		lbUfTrabCli = adicCampo(txtUfTrabCli, 516, 100, 53, 20, "UFTrabCli",
				"UF", ListaCampos.DB_SI, false);
		lbDDDTrabCli = adicCampo(txtDDDTrabCli, 7, 140, 40, 20, "DDDTrabCli",
				"DDD", ListaCampos.DB_SI, false);
		lbFoneTrabCli = adicCampo(txtFoneTrabCli, 50, 140, 97, 20,
				"FoneTrabCli", "Telefone", ListaCampos.DB_SI, false);
		lbRamalTrabCli = adicCampo(txtRamalTrabCli, 150, 140, 47, 20,
				"RamalTrabCli", "Ramal", ListaCampos.DB_SI, false);
		lbRendaTrabCli = adicCampo(txtRendaTrabCli, 200, 140, 90, 20,
				"RendaTrabCli", "Renda", ListaCampos.DB_SI, false);
		lbOutRendaCli = adicCampo(txtOutRendaCli, 293, 140, 90, 20,
				"OutRendaCli", "Outras rendas", ListaCampos.DB_SI, false);
		...
		adicCampo(txtNomeConjCli, 7, 20, 300, 20, "NomeConjCli",
				"Nome do cônjuge", ListaCampos.DB_SI, false);
		adicCampo(txtDtNascConjCli, 310, 20, 85, 20, "DtNascConjCli",
				"Dt.nasc.conj.", ListaCampos.DB_SI, false);
		adicCampo(txtRgConjCli, 398, 20, 120, 20, "RgConjCli", "Rg",
				ListaCampos.DB_SI, false);
		adicCampo(txtSSPConjCli, 521, 20, 120, 20, "SSPConjCli", "Orgão exp.",
				ListaCampos.DB_SI, false);
		adicCampo(txtCPFConjCli, 7, 60, 140, 20, "CPFConjCli", "CPF",
				ListaCampos.DB_SI, false);
		adicCampo(txtNatConjCli, 150, 60, 140, 20, "NatConjCli",
				"Naturalidade", ListaCampos.DB_SI, false);
		adicCampo(txtUfNatConjCli, 293, 60, 30, 20, "UfNatConjCli", "UF",
				ListaCampos.DB_SI, false);
		adicCampo(txtEmpTrabConjCli, 326, 60, 315, 20, "EmpTrabConjCli",
				"Empresa onde trabalha", ListaCampos.DB_SI, false);
		adicCampo(txtFuncaoConjCli, 7, 100, 150, 20, "CargoConjCli", "Funcao",
				ListaCampos.DB_SI, false);
		adicCampo(txtDtAdmTrabConjCli, 160, 100, 90, 20, "DtAdmTrabConjCli",
				"Dt.admissao", ListaCampos.DB_SI, false);
		adicCampo(txtRendaConjCli, 253, 100, 90, 20, "RendaConjCli", "Renda",
				ListaCampos.DB_SI, false);

		setPainel(pinAvalista);

		adicCampo(txtNomeAvalCli, 7, 20, 300, 20, "NomeAvalCli",
				"Nome do avalista", ListaCampos.DB_SI, false);
		adicCampo(txtDtNascAvalCli, 310, 20, 85, 20, "DtNascAvalCli",
				"Dt.nasc.Aval.", ListaCampos.DB_SI, false);
		adicCampo(txtRgAvalCli, 398, 20, 120, 20, "RgAvalCli", "Rg",
				ListaCampos.DB_SI, false);
		adicCampo(txtSSPAvalCli, 521, 20, 120, 20, "SSPAvalCli", "Orgão exp.",
				ListaCampos.DB_SI, false);
		adicCampo(txtCPFAvalCli, 7, 60, 140, 20, "CPFAvalCli", "CPF",
				ListaCampos.DB_SI, false);
		adicCampo(txtEmpTrabAvalCli, 150, 60, 315, 20, "EmpTrabAvalCli",
				"Empresa onde trabalha", ListaCampos.DB_SI, false);
		adicCampo(txtFuncaoAvalCli, 468, 60, 173, 20, "CargoAvalCli", "Funcao",
				ListaCampos.DB_SI, false);
		adicCampo(txtDtAdmTrabAvalCli, 7, 100, 90, 20, "DtAdmTrabAvalCli",
				"Dt.admissao", ListaCampos.DB_SI, false);
		...
		adicCampo(txtCodRefP, 7, 20, 50, 20, "CodRefP", "Seq.",
				ListaCampos.DB_PK, null, true);
		adicCampo(txtNomeRefP, 60, 20, 370, 20, "NomeRefP", "Nome",
				ListaCampos.DB_SI, null, true);
		adicCampo(txtDDDRefP, 433, 20, 40, 20, "DDDRefP", "DDD",
				ListaCampos.DB_SI, false);
		adicCampo(txtFoneRefP, 476, 20, 97, 20, "FoneRefP", "Telefone",
				ListaCampos.DB_SI, false);
		adicCampo(txtEndRefP, 7, 60, 330, 20, "EndRefP", "Endereço",
				ListaCampos.DB_SI, false);
		adicCampo(txtNumRefP, 340, 60, 77, 20, "NumRefP", "Num.",
				ListaCampos.DB_SI, false);
		adicCampo(txtComplRefP, 420, 60, 149, 20, "ComplRefP", "Compl.",
				ListaCampos.DB_SI, false);
		adicCampo(txtBairRefP, 7, 100, 210, 20, "BairRefP", "Bairro",
				ListaCampos.DB_SI, false);
		adicCampo(txtCidRefP, 220, 100, 210, 20, "CidRefP", "Cidade",
				ListaCampos.DB_SI, false);
		adicCampo(txtUfRefP, 433, 100, 53, 20, "UFRefP", "UF",
				ListaCampos.DB_SI, false);
		adicCampo(txtCepRefP, 486, 100, 80, 20, "CepRefP", "Cep",
				ListaCampos.DB_SI, false);
		...
		adicCampo(txtCodAutP, 7, 20, 50, 20, "CodAutP", "Seq.",
				ListaCampos.DB_PK, null, true);
		adicCampo(txtNomeAutP, 60, 20, 200, 20, "NomeAutP", "Nome",
				ListaCampos.DB_SI, null, true);
		adicCampo(txtRGAutP, 263, 20, 100, 20, "RGAutP", "RG",
				ListaCampos.DB_SI, null, false);
		adicCampo(txtSSPAutP, 366, 20, 100, 20, "SSPAutP", "Orgão exp.",
				ListaCampos.DB_SI, null, false);
		adicCampo(txtCPFAutP, 469, 20, 100, 20, "CPFAutP", "CPF",
				ListaCampos.DB_SI, null, false);
		adicCampo(txtEndAutP, 7, 60, 330, 20, "EndAutP", "Endereço",
				ListaCampos.DB_SI, false);
		adicCampo(txtNumAutP, 340, 60, 77, 20, "NumAutP", "Num.",
				ListaCampos.DB_SI, false);
		adicCampo(txtComplAutP, 420, 60, 149, 20, "ComplAutP", "Compl.",
				ListaCampos.DB_SI, false);
		adicCampo(txtBairAutP, 7, 100, 210, 20, "BairAutP", "Bairro",
				ListaCampos.DB_SI, false);
		adicCampo(txtCidAutP, 220, 100, 210, 20, "CidAutP", "Cidade",
				ListaCampos.DB_SI, false);
		adicCampo(txtUfAutP, 433, 100, 53, 20, "UFAutP", "UF",
				ListaCampos.DB_SI, false);
		adicCampo(txtCepAutP, 486, 100, 80, 20, "CepAutP", "Cep",
				ListaCampos.DB_SI, false);
		adicCampo(txtDDDAutP, 7, 140, 40, 20, "DDDAutP", "DDD",
				ListaCampos.DB_SI, false);
	...
	private void buscaEstadoCivil() {
		...
		try {
			...
			if (rs != null) {
				...
				txtCodFilialTb.setVlrInteger(new Integer(ListaCampos
						.getMasterFilial("SGTABELA")));
			}
	...
	private void buscaAdicionais() {
		...
		try {
			...
			sSQL = "SELECT TC.FISTIPOCLI,TC.JURTIPOCLI,TC.CHEQTIPOCLI,TC.FILTIPOCLI,TC.LOCTRABTIPOCLI," +
					"TC.REFCOMLTIPOCLI,TC.BANCTIPOCLI,TC.REFPESTIPOCLI,TC.CONJTIPOCLI,TC.VEICTIPOCLI," +
					"TC.IMOVTIPOCLI,TC.TERRATIPOCLI,TC.PESAUTCPTIPOCLI,TC.AVALTIPOCLI," +
					"TC.SOCIOTIPOCLI FROM VDTIPOCLI TC,VDCLIENTE CLI " +
					"WHERE TC.CODEMP=? AND TC.CODFILIAL=? AND CLI.CODCLI=? AND " +
					"CLI.CODEMPTI=TC.CODEMP AND CLI.CODFILIALTI=TC.CODFILIAL AND " +
					"TC.CODTIPOCLI=CLI.CODTIPOCLI";
			...
			if (rs.next()) {
				...
				bPessAutTipoCli = rs.getString(13).equals("S") ? true : false;
