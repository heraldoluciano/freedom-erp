...
public class FCredCli extends FTabDados	implements ActionListener, CarregaListener,PostListener {
  ...
  private JScrollPane spnVeic = new JScrollPane(tbVeic); // Scrool pane para grid de Veiculos.
  private JScrollPane spnImov = new JScrollPane(tbImov); // Scrool pane para grid de Imoveis.
  private JScrollPane spnTerras = new JScrollPane(tbTerras); // Scrool pane para grid de Terras.
  private JScrollPane spnBancos = new JScrollPane(tbBancos); // Scrool pane para grid de Bancos.
  private JScrollPane spnSocios = new JScrollPane(tbSocios); // Scrool pane para grid de Socios.
  private JScrollPane spnRefC = new JScrollPane(tbRefC); // Scrool pane para grid de ref com.
