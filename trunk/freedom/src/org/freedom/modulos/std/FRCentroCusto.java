...
*/  
      ...
      while ( rs.next() ) {
        ...
        if (rs.getString(7)!=null) {
            ...
            imp.say(imp.pRow()+1,0,""+imp.comprimido());
            imp.say(imp.pRow(),0,"| "+Funcoes.copy(rs.getString("CODCC"),0,19)+
				" | "+sSiglacc+
			    " | "+Funcoes.copy(sDesccc,0,50)+
                " | "+(rs.getString(5) != null ? Funcoes.strDecimalToStrCurrency(12,2,rs.getString(5)) : Funcoes.replicate(" ",12))+
				" | "+(rs.getString(6) != null ? Funcoes.strDecimalToStrCurrency(12,2,rs.getString(6)) : Funcoes.replicate(" ",12))+
				" | "+(rs.getString(7) != null ? Funcoes.strDecimalToStrCurrency(12,2,rs.getString(7)) : Funcoes.replicate(" ",12)));
			imp.say(imp.pRow(),136,"|");
            if (iNivelcc==10) {
...
//      dl.dispose();
		...
		Funcoes.mensagemErro(this,"Erro na consulta de relatório financeiro por centro de custo!"+err.getMessage());      
    }
