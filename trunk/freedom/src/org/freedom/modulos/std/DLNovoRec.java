...
public class DLNovoRec extends FFDialogo implements PostListener{
  ...
  public DLNovoRec(Component cOrig) {
    ...
    lcReceber.add(new GuardaCampo( txtCodRec, 7, 100, 80, 20, "CodRec", "Cód.Rec", true, false, null, JTextFieldPad.TP_INTEGER,true),"txtCodPlanoPagx");
    lcReceber.add(new GuardaCampo( txtCodCli, 7, 100, 80, 20, "CodCli", "Cód.Cli", false, true, null, JTextFieldPad.TP_INTEGER,true),"txtCodPlanoPagx");
    lcReceber.add(new GuardaCampo( txtCodPlanoPag, 7, 100, 80, 20, "CodPlanoPag", "Cód.PlanoPag", false, true, null, JTextFieldPad.TP_INTEGER,true),"txtCodPlanoPagx");
    lcReceber.add(new GuardaCampo( txtCodBanco, 7, 100, 80, 20, "CodBanco", "Cód.Banco", false, true, null, JTextFieldPad.TP_STRING,false),"txtCodPlanoPagx");
    ...
    lcReceber.add(new GuardaCampo( txtDtEmisRec, 7, 100, 80, 20, "DataRec", "Emissão", false, false, null, JTextFieldPad.TP_DATE,false),"txtCodPlanoPagx");
    ...
    lcItReceber.add(new GuardaCampo( txtNParcRec, 7, 100, 80, 20, "NParcItRec", "Código", true, false, null, JTextFieldPad.TP_INTEGER,false),"txtCodPlanoPagx");
