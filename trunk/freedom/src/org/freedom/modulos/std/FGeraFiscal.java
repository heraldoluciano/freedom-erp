...
//      ps.close();
      ...
      if (cbSaida.getVlrString().equals("S")) {
        ...
        sSQL = "SELECT V.TIPOVENDA, V.DTEMITVENDA,V.DTSAIDAVENDA,IV.CODNAT,"
        	...
        	+ "CF.CODEMP=IV.CODEMPIF AND CF.CODFILIAL=IV.CODFILIALIF AND CF.CODFISC=IV.CODFISC AND "
        	+ "CF.CODITFISC=IV.CODITFISC AND CF.GERALFISC='S' AND " 
...
//       System.out.println("And:"+iAnd+"\n");
  ...
  private boolean checar() {
    ...
    String sSql = "SELECT V1.CODVENDA,V1.SERIE,"+
         ...
         " V3.DTEMITVENDA BETWEEN ? AND ? AND V3.CODTIPOMOV=V1.CODTIPOMOV AND " +
