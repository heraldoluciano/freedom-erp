...
public class Orcamento {
	...
	public enum PrefOrc {
		...
		HABVLRTOTITORC, SMODONOTA, COMISSAODESCONTO, VDPRODQQCLAS, BLOQDESCCOMPORC, BLOQPRECOORC, BLOQCOMISSORC;
	}
	...
	public static Object[] getPrefere() {
		...
		try {
			...
			sql.append( ", P1.BLOQDESCCOMPORC, P1.BLOQPRECOORC, P1.BLOQCOMISSORC ");
