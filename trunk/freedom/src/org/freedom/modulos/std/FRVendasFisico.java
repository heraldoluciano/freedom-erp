...
public class FRVendasFisico extends FRelatorio {
	...
	public void imprimir( boolean bVisualizar ) {
		...
		try {
			...
			sSQL = "SELECT SUBSTRING(P.CODGRUP FROM 1 FOR 4),P." + sCodProd 
				+ ",P.DESCPROD,G.DESCGRUP,P.CUSTOMPMPROD," 
				...
				+ " GROUP BY 1," + "P." + sCodProd + ",P.DESCPROD,G.DESCGRUP,IT.CODITVENDA, P.CUSTOMPMPROD"
				+ " ORDER BY 1," + sOrder;
			...
			imp.say( imp.pRow() + 1, 0, imp.comprimido() );
			imp.say( imp.pRow(), 0, "|" );
			imp.say( imp.pRow(), 30, "VENDA TOTAL: " + Funcoes.strDecimalToStrCurrency( 20, 2, "" + bTotalVenda ) + "   LUCRO ESTIMADO: " + Funcoes.strDecimalToStrCurrency( 20, 2, "" + bTotalLucro ) );
			imp.say( imp.pRow(), 135, "|" );
			imp.say( imp.pRow() + 1, 0, imp.comprimido() );
			imp.say( imp.pRow(), 0, "|" );
			...
			imp.say( imp.pRow(), 30, "CUSTO TOTAL: " + Funcoes.strDecimalToStrCurrency( 20, 2, "" + bTotalCusto ) + "   MARGEM MEDIA: " + Funcoes.copy( bTotalMargem + "%", 0, 6 ) );
			imp.say( imp.pRow(), 135, "|" );
			imp.say( imp.pRow() + 1, 0, imp.comprimido() );
			imp.say( imp.pRow(), 0, "|" );
