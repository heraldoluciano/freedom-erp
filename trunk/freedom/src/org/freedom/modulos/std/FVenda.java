...
public class FVenda extends FVD implements PostListener, CarregaListener, FocusListener, ActionListener, InsertListener, DeleteListener {
    ...
    private final JPanelPad pinCabVenda = new JPanelPad();

    private JPanelPad pinCabComis = null;

    private JScrollPane spnCabComis = null;

    private final JPanelPad pinCabFiscal = new JPanelPad();

    private final JPanelPad pinDet = new JPanelPad( 740, 100 );

    private final JPanelPad pinTot = new JPanelPad( 200, 200 );

    private final JPanelPad pnTot = new JPanelPad( JPanelPad.TP_JPANEL, new GridLayout( 1, 1 ) );

    private final JPanelPad pnCenter = new JPanelPad( JPanelPad.TP_JPANEL, new BorderLayout() );

    private final JButton btObs = new JButton( Icone.novo( "btObs.gif" ) );

    private final JButton btFechaVenda = new JButton( Icone.novo( "btOk.gif" ) );

    private final JButton btConsPgto = new JButton( Icone.novo( "btConsPgto.gif" ) );

    private final JButton btAdicOrc = new JButton( "Busca Orçamento", Icone.novo( "btOrcVenda.gif" ) );

    private final JButton btAltComis = new JButton( Icone.novo( "btEditar.gif" ) );
    ...
    private final JTextFieldPad txtCodRegrComis = new JTextFieldPad( JTextFieldPad.TP_INTEGER, 8, 0 );

    private final JTextFieldPad txtCodSerie = new JTextFieldPad( JTextFieldPad.TP_STRING, 4, 0 );

    private final JTextFieldPad txtTipoVenda = new JTextFieldPad( JTextFieldPad.TP_STRING, 1, 0 );

    private final JTextFieldPad txtDocVenda = new JTextFieldPad( JTextFieldPad.TP_INTEGER, 8, 0 );

    private final JTextFieldPad txtCodTratTrib = new JTextFieldPad( JTextFieldPad.TP_STRING, 2, 0 );

    private final JTextFieldPad txtTipoMov = new JTextFieldPad( JTextFieldPad.TP_STRING, 2, 0 );

    private final JTextFieldPad txtESTipoMov = new JTextFieldPad( JTextFieldPad.TP_STRING, 1, 0 );
    ...
    private final JTextFieldPad txtNomeCli = new JTextFieldPad( JTextFieldPad.TP_STRING, 50, 0 );
    ...
    private final JTextFieldPad txtPedCliVenda = new JTextFieldPad( JTextFieldPad.TP_STRING, 10, 0 );

    private final JTextFieldFK txtDescClComis = new JTextFieldFK( JTextFieldPad.TP_STRING, 40, 0 );

    private final JTextFieldPad txtPercComisVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 7, casasDecFin );

    private final JTextFieldPad txtCodItVenda = new JTextFieldPad( JTextFieldPad.TP_INTEGER, 8, 0 );

    private final JTextFieldPad txtQtdItVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDec );
    ...
    private final JTextFieldPad txtVerifProd = new JTextFieldPad( JTextFieldPad.TP_STRING, 1, 0 );

    private final JTextFieldPad txtPrecoItVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtPercDescItVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 7, casasDecFin );

    private final JTextFieldPad txtVlrDescItVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtVlrComisItVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtPercComItVenda = new JTextFieldPad( JTextFieldPad.TP_DECIMAL, 6, casasDecFin );

    private final JTextFieldPad txtCodNat = new JTextFieldPad( JTextFieldPad.TP_STRING, 4, 0 );

    private final JTextFieldFK txtSldLiqProd = new JTextFieldFK( JTextFieldPad.TP_NUMERIC, 15, casasDec );

    private final JTextFieldPad txtPercICMSItVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 7, casasDecFin );

    private final JTextFieldPad txtVlrICMSItVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtVlrLiqItVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtEstCli = new JTextFieldPad( JTextFieldPad.TP_STRING, 2, 0 );

    private final JTextFieldPad txtClasComis = new JTextFieldPad( JTextFieldPad.TP_STRING, 1, 0 );

    private final JTextFieldPad txtCodMens = new JTextFieldPad( JTextFieldPad.TP_INTEGER, 8, 0 );

    private final JTextFieldPad txtCodLote = new JTextFieldPad( JTextFieldPad.TP_STRING, 13, 0 );
    ...
    private final JTextFieldPad txtRedFisc = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 6, 2 );

    private final JTextFieldPad txtTpRedIcmsFisc = new JTextFieldPad( JTextFieldPad.TP_STRING, 1, 0 );

    private final JTextFieldPad txtVlrFreteVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtVlrComisVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtMedComisVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 9, casasDecFin );

    private final JTextFieldPad txtVlrICMSVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtVlrIPIVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtVlrPisVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtVlrCofinsVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtVlrIRVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtVlrCSocialVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtVlrBaseICMSVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtVlrBaseISSVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtVlrISSVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtVlrProdVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtVlrDescVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtVlrLiqVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtVlrProdItVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtBaseIPIItVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDec );

    private final JTextFieldPad txtStrDescItVenda = new JTextFieldPad( JTextFieldPad.TP_STRING, 50, 0 );

    private final JTextAreaPad txaObsItVenda = new JTextAreaPad( 500 );

    private final JTextFieldPad txtBaseICMSItVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtAliqFisc = new JTextFieldPad( JTextFieldPad.TP_DECIMAL, 9, casasDecFin );

    private final JTextFieldPad txtAliqIPIItVenda = new JTextFieldPad( JTextFieldPad.TP_DECIMAL, 6, casasDecFin );

    private final JTextFieldPad txtVlrIPIItVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtAliqIPIFisc = new JTextFieldPad( JTextFieldPad.TP_DECIMAL, 6, casasDecFin );

    private final JTextFieldPad txtVlrBrutVenda = new JTextFieldPad( JTextFieldPad.TP_NUMERIC, 15, casasDecFin );

    private final JTextFieldPad txtStatusVenda = new JTextFieldPad( JTextFieldPad.TP_STRING, 2, 0 );

    private final JTextFieldPad txtOrigFisc = new JTextFieldPad( JTextFieldPad.TP_STRING, 1, 0 );

    private final JTextFieldPad txtCodEmpLG = new JTextFieldPad( JTextFieldPad.TP_INTEGER, 8, 0 );

    private final JTextFieldPad txtCodFilialLG = new JTextFieldPad( JTextFieldPad.TP_INTEGER, 8, 0 );

    private final JTextFieldPad txtCodLog = new JTextFieldPad( JTextFieldPad.TP_INTEGER, 8, 0 );
    ...
    private final JTextFieldFK txtDescVend = new JTextFieldFK( JTextFieldPad.TP_STRING, 40, 0 );
    ...
    private final JTextFieldFK txtDescProdAux = new JTextFieldFK( JTextFieldPad.TP_STRING, 50, 0 );

    private final JTextFieldFK txtDescNat = new JTextFieldFK( JTextFieldPad.TP_STRING, 40, 0 );

    private final JTextFieldFK txtDescLote = new JTextFieldFK( JTextFieldPad.TP_DATE, 10, 0 );

    private final JTextFieldFK txtDescFisc = new JTextFieldFK( JTextFieldPad.TP_STRING, 50, 0 );

    private final JTextField txtFiscalTipoMov1 = new JTextField();

    private final JTextField txtFiscalTipoMov2 = new JTextField();

    private final JTextFieldPad txtCodAlmoxItVenda = new JTextFieldPad( JTextFieldPad.TP_INTEGER, 5, 0 );

    private JTextFieldPad txtUltCamp = new JTextFieldPad( JTextFieldPad.TP_DECIMAL, 15, 2 );

    private final JLabelPad lbStatus = new JLabelPad();

    private final JCheckBoxPad chbImpPedTipoMov = new JCheckBoxPad( "Imp.ped.", "S", "N" );

    private final JCheckBoxPad chbImpNfTipoMov = new JCheckBoxPad( "Imp.NF", "S", "N" );

    private final JCheckBoxPad chbImpBolTipoMov = new JCheckBoxPad( "Imp.bol.?", "S", "N" );

    private final JCheckBoxPad chbImpRecTipoMov = new JCheckBoxPad( "Imp.rec.?", "S", "N" );

    private final JCheckBoxPad chbReImpNfTipoMov = new JCheckBoxPad( "Reimp.NF?", "S", "N" );

    private final JCheckBoxPad cbAtivo = new JCheckBoxPad( "Ativo", "S", "N" );

    private final ListaCampos lcTratTrib = new ListaCampos( this, "TT" );
    ...
    private final ListaCampos lcProd = new ListaCampos( this, "PD" );

    private final ListaCampos lcProd2 = new ListaCampos( this, "PD" );

    private final ListaCampos lcNat = new ListaCampos( this, "NT" );

    private final ListaCampos lcLote = new ListaCampos( this, "LE" );

    private final ListaCampos lcClComis = new ListaCampos( this, "CM" );

    private final ListaCampos lcFisc = new ListaCampos( this );

    private final ListaCampos lcVenda2 = new ListaCampos( this );

    private final ListaCampos lcAlmox = new ListaCampos( this, "AX" );
    ...
    private int altcabcomis = 50;

    private int aumentacabcomis = -1;
    

    private enum POS_PREFS {
	USAREFPROD, USAPEDSEQ, USALIQREL, TIPOPRECOCUSTO, USACLASCOMIS, TRAVATMNFVD, NATVENDA, 
	BLOQVENDA, VENDAMATPRIM, DESCCOMPPED, TAMDESCPROD, OBSCLIVEND, IPIVENDA, CONTESTOQ, 
	DIASPEDT, RECALCCPVENDA, USALAYOUTPED, ICMSVENDA, USAPRECOZERO, MULTICOMIS
    }
	...
	if ( bPrefs[ POS_PREFS.MULTICOMIS.ordinal() ] ) {
		...
		ctrlmc = new CtrlMultiComis( 
			this, con, lcCampos, numComissionados, txtTipoVenda, txtCodVenda, txtCodVend );
	...
	if ( numComissionados > 0 ) {
	    ...
	    aumentacabcomis = numComissionados/2;
	    
	    if ( ( numComissionados % 2 ) > 0 ) {
		aumentacabcomis++;
	    }
	    ...
	    pinCabComis = new JPanelPad( 750, altcabcomis + ( aumentacabcomis * 40 ) );
	...
	/*
         * SELECT CODTIPOMOV, DESCTIPOMOV FROM EQTIPOMOV WHERE ( TUSUTIPOMOV='S' OR EXISTS (SELECT * FROM EQTIPOMOVUSU TU WHERE TU.CODEMP=EQTIPOMOV.CODEMP AND TU.CODFILIAL=EQTIPOMOV.CODFILIAL AND
         * TU.CODTIPOMOV=EQTIPOMOV.CODTIPOMOV AND TU.CODEMPUS=4 AND TU.CODFILIALUS=1 AND TU.IDUSU='sysdba') ) ORDER BY 1
         */
	lcTipoMov.setWhereAdic( 
		...
		"TU.CODFILIALUS=" + ListaCampos.getMasterFilial( "SGUSUARIO" ) + " AND " +
		"TU.IDUSU='" + Aplicativo.strUsuario + "') ) )" );
	...
	if ( numComissionados > 0 ) {
		...
		if ( itemcomis != null ) {
		    ...
		    adicCampoInvisivel( itemcomis.getTxtTipovenda(), itemcomis.getTxtTipovenda().getNomeCampo(), "Tipo", ListaCampos.DB_PK, true );
		    adicCampoInvisivel( itemcomis.getTxtSeqvc(), itemcomis.getTxtSeqvc().getNomeCampo(), "Seq.", ListaCampos.DB_PK, true );
		    adicCampoInvisivel( itemcomis.getTxtCodRegra(), itemcomis.getTxtCodRegra().getNomeCampo(), "Cód.rg.comis.", ListaCampos.DB_FK, true );
		    adicCampoInvisivel( itemcomis.getTxtSeqRegra(), itemcomis.getTxtSeqRegra().getNomeCampo(), "Seq.rg.comis.", ListaCampos.DB_FK, true );
		    adicCampo( itemcomis.getTxtCodvend(), cols[ col ], row + 20, 80, 20, itemcomis.getTxtCodvend().getNomeCampo(), itemcomis.getLbCodvend().getText(), ListaCampos.DB_FK, itemcomis.getTxtNomevend(), "S".equals( itemcomis.getObrigitrc() ) );
		    adicDescFK( itemcomis.getTxtNomevend(), cols[ col ] + 83, row + 20, 200, 20, itemcomis.getTxtNomevend().getNomeCampo(), itemcomis.getLbNomevend().getText() );
		    adicCampo( itemcomis.getTxtPerccomis(), cols[ col ] + 286, row + 20, 55, 20, itemcomis.getTxtPerccomis().getNomeCampo(), itemcomis.getLbPercvend().getText(), ListaCampos.DB_SI, "S".equals( itemcomis.getObrigitrc() ) );

		    setListaCampos( false, "VENDACOMIS", "VD" );
	...
	try {
	    ...
	    sql.append( "FROM VDREGRACOMIS RC, VDITREGRACOMIS IRC " );
	    sql.append( "WHERE IRC.CODEMP=RC.CODEMP AND IRC.CODFILIAL=RC.CODFILIAL AND " );
	    sql.append( "IRC.CODREGRCOMIS=RC.CODREGRCOMIS AND RC.CODEMP=? AND RC.CODFILIAL=? " );
	...
	if (txtPercComItVenda.floatValue() >= 0) {
	    txtVlrComisItVenda.setVlrBigDecimal(new BigDecimal(Funcoes.arredFloat((txtVlrProdItVenda.floatValue() - txtVlrDescItVenda.floatValue()) * txtPercComItVenda.floatValue() / 100
	...
	int[] iRetorno = { txtCodProd.getVlrInteger().intValue(), txtCodCli.getVlrInteger().intValue(), Aplicativo.iCodEmp, ListaCampos.getMasterFilial("VDCLIENTE"),
		txtCodPlanoPag.getVlrInteger().intValue(), Aplicativo.iCodEmp, ListaCampos.getMasterFilial("FNPLANOPAG"), txtCodTipoMov.getVlrInteger().intValue(), Aplicativo.iCodEmp,
		ListaCampos.getMasterFilial("EQTIPOMOV"), Aplicativo.iCodEmp, Aplicativo.iCodFilial, txtCodVenda.getVlrInteger().intValue(), Aplicativo.iCodEmp, ListaCampos.getMasterFilial("VDVENDA") };
	return iRetorno;
    }
	...
	try {
		...
		while (rs.next()) {
			...
			if (imp.pRow() == 0) {
			    ...
			    imp.pulaLinha(1, imp.comprimido());
			    imp.say(1, rs.getString("CpfCli") != null ? "CPF    : " + Funcoes.setMascara(rs.getString("CpfCli"), "###.###.###-##") : "CNPJ   : "
				    + Funcoes.setMascara(rs.getString("CnpjCli"), "##.###.###/####-##"));// CNJP cliente
			    imp.say(70, "CONTATO: " + (rs.getString("ContCli") != null ? rs.getString("ContCli").trim() : ""));
			    imp.pulaLinha(1, imp.comprimido());
			    imp.say(1, (rs.getString("RgCli") != null ? "R.G.   : " + rs.getString("RgCli") : "I.E.   : " + (rs.getString("InscCli") != null ? rs.getString("InscCli") : "")));// IE
                                                                                                                                                                                                // cliente
			    imp.say(70, (rs.getString("EndCli") != null ? rs.getString("EndCli").trim() + " N°:" + (rs.getString("NumCli") != null ? rs.getString("NumCli") : "") : ""));// rua e
                                                                                                                                                                                                // número
                                                                                                                                                                                                // do
                                                                                                                                                                                                // cliente
			    imp.pulaLinha(1, imp.comprimido());
			    imp.say(1, "SITE   : " + (rs.getString("SiteCli") != null ? rs.getString("SiteCli").trim() : ""));
			    imp.say(70, (rs.getString("BairCli") != null ? rs.getString("BairCli").trim() : "") + (rs.getString("CidCli") != null ? " - " + rs.getString("CidCli").trim() : "")
				    + (rs.getString("UFCli") != null ? " - " + rs.getString("UFCli").trim() : "") + (rs.getString("CEPCli") != null ? " - " + rs.getString("CEPCli").trim() : ""));// complemento
                                                                                                                                                                                                        // do
                                                                                                                                                                                                        // endereço
                                                                                                                                                                                                        // do
                                                                                                                                                                                                        // cliente
			    ...
			    imp.say(70, "TEL: " + (rs.getString("DDDCli") != null ? Funcoes.setMascara(rs.getString("DDDCli"), "(####)") : "")
			...
			if (i == 0) {
			    ...
			    imp.say(87, Funcoes.strDecimalToStrCurrency(13, 2, ""
				    + (new BigDecimal(rs.getString("VlrLiqItVenda"))).divide(new BigDecimal(rs.getDouble("QtdItVenda")), 2, BigDecimal.ROUND_HALF_UP)));
	...
	try {
		...
		if (layNF instanceof Layout) {
		    ...
		    sSQL
			    .append("SELECT (SELECT COUNT(IC.CODITVENDA) FROM VDITVENDA IC WHERE IC.CODVENDA=V.CODVENDA AND IC.CODEMP=V.CODEMP AND IC.CODFILIAL=V.CODFILIAL AND IC.TIPOVENDA=V.TIPOVENDA),");
		    sSQL.append("(SELECT L.CODLOTE FROM EQLOTE L WHERE L.CODPROD=I.CODPROD AND L.CODLOTE=I.CODLOTE),");
		    sSQL.append("(SELECT L.VENCTOLOTE FROM EQLOTE L WHERE L.CODPROD=I.CODPROD AND L.CODLOTE=I.CODLOTE),");
	...
	try {
	    ...
	    sql.append( "SELECT USAREFPROD,USAPEDSEQ,USALIQREL,TIPOPRECOCUSTO,ORDNOTA,USAPRECOZERO," );
	    sql.append( "USACLASCOMIS,TRAVATMNFVD,NATVENDA,IPIVENDA,BLOQVENDA, VENDAMATPRIM, DESCCOMPPED, " );
	    sql.append( "TAMDESCPROD, OBSCLIVEND, CONTESTOQ, DIASPEDT, RECALCPCVENDA, USALAYOUTPED, " );
	    sql.append( "ICMSVENDA, MULTICOMIS " );
	...
	if ( e.getListaCampos() == lcProd2 ) {
	    lcProd.edit();
	}

	if ( e.getListaCampos() == lcVendedor ) {// Ativa auto-incrementos
	...
	try {
		...
		if ( numComissionados > 0 && ctrlmc != null &&
		    ...
		    ctrlmc.loadVendaComis( "V", txtCodVenda.getVlrInteger().intValue() );
		}
	    } 
	...
	if ( ( e.getListaCampos() == lcCampos ) && ( lcCampos.getStatus() == ListaCampos.LCS_INSERT ) ) {
	    ...
	    if ( bPrefs[ POS_PREFS.TRAVATMNFVD.ordinal() ] ) {
		try {
		    psTipoMov = con.prepareStatement( 
			    "SELECT CODTIPOMOV,DESCTIPOMOV FROM EQTIPOMOV " +
			    "WHERE CODEMP=? AND CODFILIAL=? AND CODTIPOMOV=? AND FISCALTIPOMOV='N'" );
	...
	if ( e.getListaCampos() == lcCampos ) {
	    ...
	    if ( numComissionados > 0 && ctrlmc != null && e.ok ) {
	...
	if ( e.getKeyCode() == KeyEvent.VK_CONTROL ) {
	    ...
	    if ( e.getSource() == txtPercComisVenda || ( e.getSource() == txtClasComis && !txtPercComisVenda.getAtivo() ) ) {
		// Como estes são os ultimos campos
	    ...
	    else if ( e.getSource() == txtPedCliVenda ) {// Como este é o
		// ultimo campo da
		// aba de venda
		// então abre a tab
		// comissao.
	    ...
	    else if ( e.getSource() == txtUltCamp ) {// Como este é o ultimo
		// campo do painel de
	    ...
	    else if ( e.getSource() == txtCodNat ) {// Talvez este possa ser
		// o ultimo campo por
		// isso o teste.
	    ...
	    else if ( e.getSource() == txtRefProd || e.getSource() == txtCodProd ) {
		if ( e.getSource() == txtRefProd ) {
		    lcDet.edit();
		}
	...
	else if ( e.getKeyCode() == KeyEvent.VK_F3 && e.getSource() == txtVlrDescItVenda ) {
	    mostraTelaDescont();
	} 
	...
	try {
	    ...
	    PreparedStatement ps = con.prepareStatement( "EXECUTE PROCEDURE FNLIBCREDSP(?,?,?,?,?,?,?,?);" );
	    ps.setInt( 1, Aplicativo.iCodEmp );
	    ps.setInt( 2, ListaCampos.getMasterFilial( "VDVENDA" ) );
	    ps.setString( 3, "V" );
	    ...
	    err.printStackTrace();
	    Funcoes.mensagemInforma( this, "Problema ao executar fechamento da venda!\nA Venda ultrapassa o limite de crédito pré-estabelecido!/n" );
	    Logger.gravaLogTxt( "", Aplicativo.strUsuario, Logger.LGEB_BD, "Erro ao executar fechamento (limite de crédito)." );
	    return false;
	}
	...
	if ( e.getSource() == btFechaVenda ) { // xxx
	    if ( lcCampos.carregaDados() ) {
		fechaVenda();
	    }
	} 
	else if ( e.getSource() == btConsPgto ) {
	...
	else if ( e.getSource() == btObs ) {
	    mostraObs( "VDVENDA", txtCodVenda.getVlrInteger().intValue() );
	} 
	else if ( e.getSource() == btAdicOrc ) {
	    abreAdicOrc();
	} 
	else if ( e.getSource() == btAltComis ) {
	    altComisVend();
	}
	...
	if ( e.getSource() == txtPercDescItVenda ) {
	...
	else if ( e.getSource() == txtPercComItVenda ) {
	...
	else if ( e.getSource() == txtVlrDescItVenda ) {
	...
	else if ( e.getSource() == txtVlrComisItVenda ) {
	...
	else if ( ( e.getSource() == txtQtdItVenda ) | ( e.getSource() == txtPrecoItVenda ) | ( e.getSource() == txtCodNat ) ) {
	    calcVlrProd();
	    calcImpostos( true );
	} 
	else if ( ( e.getSource() == txtPercICMSItVenda ) | ( e.getSource() == txtAliqIPIItVenda ) ) {
	    calcImpostos( false );
	}
    }
