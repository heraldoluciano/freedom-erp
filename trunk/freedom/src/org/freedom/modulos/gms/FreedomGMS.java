...
public class FreedomGMS extends Aplicativo {
	...
	public FreedomGMS() {
		...
		addOpcao(-1,TP_OPCAO_MENU,"Arquivo","",'A',100000000,0, false, null);
			addOpcao(100000000,TP_OPCAO_MENU,"Cadastros","",'T',100100000,1, false, null);
		        ...
		        addOpcao(100100000,TP_OPCAO_MENU,"Produtos","",'u',100301000,2, false, null);
		        	addOpcao(100301000,TP_OPCAO_ITEM,"Tratamentos tributários","Tratamento Tributário",'t',100301010,3, true, FTratTrib.class);
		        	addOpcao(100301000,TP_OPCAO_ITEM,"Classificações fiscais","Classificações",'l',100130020,3, true, FCLFiscal.class);
		        	addOpcao(100301000,TP_OPCAO_ITEM,"Almoxarifados","Almoxarifado",'x',100130030,3, true, FAlmox.class);
		        	addOpcao(100301000,TP_OPCAO_ITEM,"Grupos","Grupos",'r',100130040,3, true, FGrupo.class);
		        	addOpcao(100301000,TP_OPCAO_ITEM,"Marcas","Marcas",'c',100130050,3, true, FMarca.class);
		        	addOpcao(100301000,TP_OPCAO_ITEM,"Unidades","Unidades",'U',100130060,3, true, FUnidade.class);
			      	addOpcao(100301000,TP_OPCAO_ITEM,"Kits de produtos","Kits de produtos",'K',100130070,3, true, FGrupo.class);
		        	addOpcao(100301000,TP_OPCAO_ITEM,"Produtos","Produtos",'P',100130080,3, true, FProduto.class);
		        	...
		        	addOpcao(100301000,TP_OPCAO_MENU,"Grade de produtos","",'G',100130090,3, false, null);        
		        		...
		        		addOpcao(100130090,TP_OPCAO_ITEM,"Modelos","Modelo de Grade",'M',100130092,4, true, FModGrade.class);
		        		addOpcao(100130090,TP_OPCAO_ITEM,"Grades","Grade",'r',100130093,4, true, FGrade.class);
		        addSeparador(100100000);	  		    		    		    		  	   
		        addOpcao(100100000,TP_OPCAO_MENU,"Outros cadastros","",'C',100401000,2, false, null);		    
		        	addOpcao(100401000,TP_OPCAO_ITEM,"Transportadoras","Transportadora",'p',100401010,3, true, FTransp.class);  	    
		        	addSeparador(100401000);
		        	addOpcao(100401000,TP_OPCAO_ITEM,"Tipo de cobrança","TipoCob",'o',100401020,3, true, FTipoCob.class);
		        	addOpcao(100401000,TP_OPCAO_ITEM,"Plano de pagamento","PlanoPag",'s',100401030,3, true, FPlanoPag.class);
		        	addSeparador(100401000);
		        	addOpcao(100401000,TP_OPCAO_ITEM,"Natureza de operação","Naturezas",'z',100401040,3, true, FNatoPer.class);
		        	addSeparador(100401000); 
				    addOpcao(100100000,TP_OPCAO_MENU,"Atribuições","",'t',100401050,3, false, null);
				      	addOpcao(100401050,TP_OPCAO_ITEM,"Atribuições","Atribuição",'r',100401051,4, true, FAtribuicao.class);
				      	addOpcao(100401050,TP_OPCAO_ITEM,"Atribuições por usuário","Atribuição por usuário",'u',100401052,4, true, FAtribUsu.class);		        	
		    ...
		    addOpcao(100000000,TP_OPCAO_MENU,"Configurações","",'C',100300000,1, false, null);
		    	addOpcao(100300000,TP_OPCAO_ITEM,"Impressora","Impressoras",'I',100310000,2, true, FImpressora.class);
		    	addOpcao(100300000,TP_OPCAO_ITEM,"Papel","Papeis",'P',100320000,2, true, FPapel.class);
		    	addOpcao(100300000,TP_OPCAO_ITEM,"Estação","FEstacao",'E',100330000,2, true, FEstacao.class);// lom
		    	addSeparador(100300000);
		    	addOpcao(100300000,TP_OPCAO_MENU,"Preferências","",'P',100340000,2, false, null);
		    		addOpcao(100340000,TP_OPCAO_ITEM,"Preferências gerais","Pref. Gerais",'g',100340010,3, true, FPrefereGeral.class);
		    		addOpcao(100300000,TP_OPCAO_ITEM,"Série de NFs","",'N',100340020,3, true, FPrefereGeral.class);
		    		addOpcao(100300000,TP_OPCAO_ITEM,"Modelo de NFs","Modelo NF",'M',100340030,3, true, FModNota.class);
  
	    addOpcao(-1,TP_OPCAO_MENU,"Entrada","",'E',200000000,0, false, null);
	    	addOpcao(200000000,TP_OPCAO_ITEM,"Solicitação de Compra","Solicitação de Compra",'S',200300000,1, true, FSolicitacaoCompra.class);
	    	addOpcao(200000000,TP_OPCAO_ITEM,"Aprova Solicitação de Compra","",'A',200400000,1, true, FAprovaSolicitacaoCompra.class);
	    	addOpcao(200000000,TP_OPCAO_ITEM,"Pesquisa Solicitações de Compra","",'P',200500000,1, true, FConsSol.class);
	    	addSeparador(200000000);
	    	addOpcao(200000000,TP_OPCAO_ITEM,"Cotação de Preços","",'T',200600000,1, true, FCotacaoPrecos.class);
	    	addOpcao(200000000,TP_OPCAO_ITEM,"Aprova Cotação de Preços","",'P',200700000,1, true, FAprovaCotacaoPrecos.class);
	    	addSeparador(200000000);
	    ...
	    addOpcao(-1,TP_OPCAO_MENU,"Saída","",'S',300000000,0, false, null);
	    	...
	    	addOpcao(301000000,TP_OPCAO_ITEM,"Ultimas Vendas por Cliente","",'C',301070000,2, true, FRUltimaVenda.class);
	    ...
	    addOpcao(-1,TP_OPCAO_MENU,"Estoque","",'E',400000000,0, false, null);
	    	addOpcao(400000000,TP_OPCAO_ITEM,"Kardex","Kardex",'K',400100000,1, true, FConsPreco.class);
	    	addOpcao(400000000,TP_OPCAO_ITEM,"Inventário","",'I',400200000,1, true, FInventario.class);
