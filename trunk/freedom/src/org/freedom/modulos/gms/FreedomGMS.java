...
public class FreedomGMS extends Aplicativo {
	...
	public FreedomGMS() {
		...
		addOpcao(-1,TP_OPCAO_MENU,"Arquivo","",'A',100000000,0, false, null);
		    ...
		    addOpcao(100000000,TP_OPCAO_MENU,"Configurações","",'C',100300000,1, false, null);
		    	...
		    	addOpcao(100300000,TP_OPCAO_MENU,"Preferências","",'P',100340000,2, false, null);
		    		...
		    		addOpcao(100300000,TP_OPCAO_ITEM,"Série de NFs","",'N',100340020,3, true, FSerie.class);
	    ...
	    addOpcao(-1,TP_OPCAO_MENU,"Entrada","",'E',200000000,0, false, null);
	    	...
	    	addOpcao(200000000,TP_OPCAO_ITEM,"Aprova Solicitação de Compra","Aprova Solicitação de Compra",'A',200400000,1, true, FAprovaSolicitacaoCompra.class);
	    	addOpcao(200000000,TP_OPCAO_ITEM,"Pesquisa Solicitações de Compra","Pesquisa Solicitações de Compra",'P',200500000,1, true, FConsSol.class);
	    	addSeparador(200000000);
	    	addOpcao(200000000,TP_OPCAO_ITEM,"Cotação de Preços","Cotação de Preços",'T',200600000,1, true, FCotacaoPrecos.class);
	    	addOpcao(200000000,TP_OPCAO_ITEM,"Aprova Cotação de Preços","Aprova Cotação de Preços",'P',200700000,1, true, FAprovaCotacaoPrecos.class);
	    	addSeparador(200000000);
