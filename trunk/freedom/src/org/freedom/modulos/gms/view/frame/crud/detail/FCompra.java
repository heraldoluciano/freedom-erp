...
//		adic( rgFreteRM, 521, 60, 150, 20, "Frete" );
	...
	private void imprimir( TYPE_PRINT bVisualizar, int iCodCompra ) {
		...
		sql.append( "I.CODPROD,P.REFPROD,P.CODFABPROD,P.DESCPROD,P.CODUNID,I.QTDITCOMPRA,I.PRECOITCOMPRA, " );
	...
	public void afterCarrega( CarregaEvent cevt ) {
		...
		else if ( statuscompra.length() > 0 && statuscompra.substring( 0, 1 ).equals( "N" ) ) {
	...
	public void setConexao( DbConnection cn ) {
		...
		setNfecf( new NFEConnectionFactory( cn, Aplicativo.getInstance().getConexaoNFE(), AbstractNFEFactory.TP_NF_IN
