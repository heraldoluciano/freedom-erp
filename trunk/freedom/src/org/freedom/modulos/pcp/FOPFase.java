...
public class FOPFase extends FDetalhe {
  ...
  public FOPFase(int iCodOP) {
    ...
    lcRec.add(new GuardaCampo(txtCodRec,"CodRecP", "Código", ListaCampos.DB_PK, true));
    lcRec.add(new GuardaCampo(txtDescRec, "DescRecP", "Descrição", ListaCampos.DB_SI, false));
