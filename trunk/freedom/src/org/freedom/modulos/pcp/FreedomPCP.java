...
public class FreedomPCP extends AplicativoPD implements ActionListener {
	...
	public FreedomPCP() {
		...
		super( "iconpcp.png", "splashPCP.png", 1, "Freedom", 5, "Planejamento e Controle da Produção", null, new FPrincipalPD( null, "bgFreedom2.jpg" ), LoginPD.class );
		...
		addOpcao( 200000000, TP_OPCAO_ITEM, "Acompanhamento da produção", "Acompanhamento da produção", 'A', 200300000, 1, true, FAcompanhaProd.class );
		addOpcao( 200000000, TP_OPCAO_ITEM, "Planejamento mestre da produção (Pull)", "Planejamento mestre da produção (Pull)", 'U', 200400000, 1, true, FPMP_Pull.class );
		addOpcao( 200000000, TP_OPCAO_ITEM, "Planejamento mestre da produção (Push)", "Planejamento mestre da produção (Push)", 'H', 200500000, 1, true, FPMP_Push.class );
		...
		addOpcao( 400700000, TP_OPCAO_ITEM, "Estoque mínimo", "Estoque Mínimo", 'E', 400701000, 2, true, FREstoqueMin.class );
		...
		addOpcao( 400700000, TP_OPCAO_ITEM, "Inventário", "Inventário", 'U', 400709000, 2, true, FRInventario.class );
