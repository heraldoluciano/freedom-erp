...
public class FRProducaoGrupo extends FRelatorio {
	...
	public void imprimir( boolean visualizar ) {
		...
		try {
			...
			sql.append( "left outer join ppopsubprod sp on sp.codemp=op.codemp and sp.codfilial=op.codfilial and sp.codop=op.codop and sp.seqop=op.seqop ");
			...
			sql.append( "left outer join eqgrupo gp on gp.codemp=pd.codempgp and gp.codfilial=pd.codfilialgp and gp.codgrup=pd.codgrup ");
