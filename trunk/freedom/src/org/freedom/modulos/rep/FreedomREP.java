...
public class FreedomREP extends AplicativoPD implements ActionListener {

	public FreedomREP() {

		super( "iconAtendimento32.gif", "splashREP.jpg", 1, "Freedom", 5, "Controle de representações", null, new FPrincipalPD( null, "bgFreedomSTD.jpg" ), LoginPD.class );
		addOpcao( -1, TP_OPCAO_MENU, "Arquivo", "", 'A', 100000000, 0, false, null );
			...
			addOpcao( 100000000, TP_OPCAO_ITEM, "Empresa", "Empresa", 'E', 100300000, 1, true, RPEmpresa.class );
		...
		addOpcao( -1, TP_OPCAO_MENU, "Pagar", "Pagar", 'P', 300000000, 0, false, null );
			addOpcao( 300000000, TP_OPCAO_ITEM, "Pagar", "Pagar", 'P', 300100000, 1, true, null );
		
		addOpcao( -1, TP_OPCAO_MENU, "Receber", "Receber", 'R', 400000000, 0, false, null );
			addOpcao( 400000000, TP_OPCAO_ITEM, "Receber", "Receber", 'R', 400100000, 1, true, null );
