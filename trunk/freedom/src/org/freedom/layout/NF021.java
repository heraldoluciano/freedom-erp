...
public class NF021 extends Layout {
		...
		try {
			...
			while (itens.next()) {
				...
				if (imp.pRow()==0) {        	 
					...
					imp.say(imp.pRow()+0,80,!cab.getString(NF.C_BAIREMIT).equals("") ? Funcoes.copy(cab.getString(NF.C_BAIREMIT),0,20) : "");
					...
					imp.say(imp.pRow()+0,54,(!cab.getString(NF.C_DDDEMIT).equals("") ? "("+cab.getString(NF.C_DDDEMIT)+")" : "")+(!cab.getString(NF.C_FONEEMIT).equals("")? Funcoes.setMascara(cab.getString(NF.C_FONEEMIT).trim(),"####-####") : ""));
				...
				imp.say(imp.pRow()+0,75,Funcoes.alinhaDir(""+itens.getFloat(NF.C_QTDITPED),6));
				imp.say(imp.pRow()+0,82,Funcoes.strDecimalToStrCurrency(12,2,""+((new BigDecimal(itens.getFloat(NF.C_VLRLIQITPED))).divide(new BigDecimal(itens.getFloat(NF.C_QTDITPED)),2,BigDecimal.ROUND_HALF_UP))));
				imp.say(imp.pRow()+0,100,Funcoes.strDecimalToStrCurrency(13,2,itens.getFloat(NF.C_VLRLIQITPED)+""));
				imp.say(imp.pRow()+0,115,""+itens.getFloat(NF.C_PERCICMSITPED));
				imp.say(imp.pRow()+0,120,""+itens.getFloat(NF.C_PERCIPIITPED));
			...
			imp.say(imp.pRow()+9,0,""+imp.comprimido());
	...
	private void impTotais(ImprimeOS imp,Vector vValores){
		...
		try {	
			...
			imp.say(imp.pRow()+0,62,Funcoes.strDecimalToStrCurrency(20,2,vValores.elementAt(4).toString()));
			imp.say(imp.pRow()+0,88,Funcoes.strDecimalToStrCurrency(20,2,vValores.elementAt(5).toString()));
			...
			imp.say(imp.pRow()+0,73,vValores.elementAt(8) != null ? (vValores.elementAt(8).toString().equals("C") ? "1" : "2") : "");
			imp.say(imp.pRow()+0,79,vValores.elementAt(9) != null ? vValores.elementAt(9).toString() : "");
			imp.say(imp.pRow()+0,101,vValores.elementAt(10) != null ? vValores.elementAt(10).toString() : "");
			...
			if ( sTipoTran.equals("C") )
				...
				imp.say(imp.pRow()+0,110,Funcoes.setMascara(vValores.elementAt(13) != null ? vValores.elementAt(13).toString() : "","##.###.###/####-##"));
			...
			imp.say(imp.pRow()+0,101,vValores.elementAt(17) != null ? vValores.elementAt(17).toString().trim() : "");
			...
			imp.say(imp.pRow()+0,23,vValores.elementAt(20) != null ? vValores.elementAt(20).toString() : "");
			imp.say(imp.pRow()+0,48,vValores.elementAt(21) != null ? vValores.elementAt(21).toString() : "");
			imp.say(imp.pRow()+0,100,vValores.elementAt(22) != null ? vValores.elementAt(22).toString() : "");
