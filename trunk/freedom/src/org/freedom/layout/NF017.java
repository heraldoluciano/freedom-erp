    ...
    try {
     ...
     while (itens.next()) {
         ...
         if (imp.pRow()==0) {
	           ...
	           imp.say(imp.pRow()+0,56,(!cab.getString(NF.C_DDDEMIT).equals("") ? "("+cab.getString(NF.C_DDDEMIT)+")" : "")+
					   				   (!cab.getString(NF.C_FONEEMIT).equals("") ? Funcoes.setMascara(cab.getString(NF.C_FONEEMIT).trim(),"####-####") : "").trim());
	           imp.say(imp.pRow()+0,78,cab.getString(NF.C_UFEMIT));
	           ...
	           imp.say(imp.pRow()+0,25,sDuplics[0]);
			   imp.say(imp.pRow()+0,43,sVals[0]);
			   imp.say(imp.pRow()+0,66,sVencs[0]);
			   imp.say(imp.pRow()+0,84,sDuplics[1]);
			   imp.say(imp.pRow()+0,102,sVals[1]);
			   imp.say(imp.pRow()+0,125,sVencs[1]);			   
			   imp.say(imp.pRow()+1,0,"");
			   imp.say(imp.pRow()+1,0,""+imp.comprimido());
			   imp.say(imp.pRow()+0,9,cab.getString(NF.C_ENDCOBEMIT)+" , "+cab.getString(NF.C_NUMCOBEMIT)+ " - "+cab.getString(NF.C_BAIRCOBEMIT)+ " / "+cab.getString(NF.C_CIDCOBEMIT)+" - "+cab.getString(NF.C_UFCOBEMIT));
			   imp.say(imp.pRow()+1,0,"");			  
			   imp.say(imp.pRow()+1,0,"");
         }
	
         imp.say(imp.pRow()+1,0,""+imp.comprimido());
         imp.say(imp.pRow()+0,1,Funcoes.alinhaDir(itens.getInt(NF.C_CODPROD),8));
		 ...
		 Vector vDesc = Funcoes.strToVectorSilabas((itens.getString(NF.C_OBSITPED).equals("") ? (itens.getString(NF.C_DESCPROD).trim()) : itens.getString(NF.C_OBSITPED))/*+sDescAdic*/,50);
	     String sDesc = "";
         ...
         imp.say(imp.pRow()+0,66,sSigla);
         imp.say(imp.pRow()+0,70,Funcoes.copy(itens.getString(NF.C_ORIGFISC),0,1)+Funcoes.copy(itens.getString(NF.C_CODTRATTRIB),0,2));
         imp.say(imp.pRow()+0,75,itens.getString(NF.C_CODUNID).substring(0,4));
         imp.say(imp.pRow()+0,81,""+itens.getFloat(NF.C_QTDITPED));
         imp.say(imp.pRow()+0,93,Funcoes.strDecimalToStrCurrency(8,2,""+((new BigDecimal(itens.getFloat(NF.C_VLRLIQITPED))).divide(new BigDecimal(itens.getFloat(NF.C_QTDITPED)),2,BigDecimal.ROUND_HALF_UP))));
         imp.say(imp.pRow()+0,104,Funcoes.strDecimalToStrCurrency(13,2,""+itens.getFloat(NF.C_VLRLIQITPED)));
         ...
         if ((iItImp == itens.getInt(NF.C_CONTAITENS)) || (imp.pRow() > iLinMax)) {
           ...
           if (iItImp == itens.getInt(NF.C_CONTAITENS)) {
	             ...
	             imp.say(imp.pRow()+0,31,Funcoes.strDecimalToStrCurrency(20,2,""+itens.getFloat(NF.C_VLRICMSPED)));
	             imp.say(imp.pRow()+0,112,Funcoes.strDecimalToStrCurrency(20,2,""+itens.getFloat(NF.C_VLRPRODPED)));
	             imp.say(imp.pRow()+1,0,"");
	             imp.say(imp.pRow()+1,0,""+imp.comprimido());
	             imp.say(imp.pRow()+0,4,Funcoes.strDecimalToStrCurrency(20,2,""+frete.getFloat(NF.C_VLRFRETEPED)));
	             imp.say(imp.pRow()+0,61,Funcoes.strDecimalToStrCurrency(20,2,""+itens.getFloat(NF.C_VLRADICPED)));
	             imp.say(imp.pRow()+0,88,Funcoes.strDecimalToStrCurrency(20,2,""+itens.getFloat(NF.C_VLRIPIPED)));
	             imp.say(imp.pRow()+0,112,Funcoes.strDecimalToStrCurrency(20,2,""+itens.getFloat(NF.C_VLRLIQPED)));
           }

           imp.say(imp.pRow()+3,0,"");
           imp.say(imp.pRow()+0,9,frete.getString(NF.C_RAZTRANSP));
           imp.say(imp.pRow()+0,80,frete.getString(NF.C_TIPOFRETE).equals("C") ? "1" : "2");
           imp.say(imp.pRow()+0,91,frete.getString(NF.C_PLACAFRETE));
           imp.say(imp.pRow()+0,107,frete.getString(NF.C_UFFRETE));
           ...
           imp.say(imp.pRow()+0,70,Funcoes.copy(frete.getString(NF.C_CIDTRANSP),0,30));
           imp.say(imp.pRow()+0,107,frete.getString(NF.C_UFTRANSP));
           ...
           imp.say(imp.pRow()+0,30,frete.getString(NF.C_ESPFRETE));
           imp.say(imp.pRow()+0,50,frete.getString(NF.C_MARCAFRETE));
           imp.say(imp.pRow()+0,104,Funcoes.strDecimalToStrCurrency(5,casasDec,""+frete.getString(NF.C_PESOBRUTO)));
           imp.say(imp.pRow()+0,124,Funcoes.strDecimalToStrCurrency(5,casasDec,""+frete.getString(NF.C_PESOLIQ)));
           imp.say(imp.pRow()+1,0,"");
           imp.say(imp.pRow()+1,0,"");
