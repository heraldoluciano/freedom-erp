		...
		try {
			...
			while (itens.next()) {  
				...
				if (imp.pRow()==0) {
					...
					imp.say(imp.pRow()+1,0, imp.comprimido());
					imp.say(imp.pRow()+1,0, imp.comprimido());
					imp.say(imp.pRow(),  8, sNat[0]);
					imp.say(imp.pRow(), 45, sNat[1]);
					
					imp.say(imp.pRow()+1,0, imp.comprimido());
					imp.say(imp.pRow()+1,0, imp.comprimido());
					imp.say(imp.pRow()+1,0, imp.comprimido());
					imp.say(imp.pRow(),  8, cab.getString(NF.C_RAZEMIT));
					...
					imp.say(imp.pRow()+1,0, imp.comprimido());
					imp.say(imp.pRow()+1,0, imp.comprimido());
					imp.say(imp.pRow(),  8, Funcoes.copy(cab.getString(NF.C_ENDEMIT),0,50).trim()+", "+(Funcoes.copy(String.valueOf(cab.getInt(NF.C_NUMEMIT)),0,6).trim()).trim()+" - "+(cab.getString(NF.C_COMPLEMIT) != null ? Funcoes.copy(cab.getString(NF.C_COMPLEMIT),0,9).trim() : "").trim());
					imp.say(imp.pRow(), 68, !cab.getString(NF.C_BAIREMIT).equals("") ? Funcoes.copy(cab.getString(NF.C_BAIREMIT),0,25) : "");
					...
					imp.say(imp.pRow(), 52, Funcoes.setMascara(cab.getString(NF.C_DDDEMIT) + " ", "(####)" +
				...
				imp.say(imp.pRow()+1,0, imp.comprimido());
				imp.say(imp.pRow(),  8, String.valueOf(itens.getInt(NF.C_CODPROD)));
				imp.say(imp.pRow(), 17, Funcoes.copy(itens.getString(NF.C_DESCPROD),0,48));
				imp.say(imp.pRow(), 84, Funcoes.copy(itens.getString(NF.C_ORIGFISC),0,1)+Funcoes.copy(itens.getString(NF.C_CODTRATTRIB),0,2));
				imp.say(imp.pRow(), 90, itens.getString(NF.C_CODUNID).substring(0,4));
				imp.say(imp.pRow(), 98, Funcoes.strDecimalToStrCurrency( 7,2,String.valueOf(itens.getFloat(NF.C_QTDITPED))));
				imp.say(imp.pRow(),106, Funcoes.strDecimalToStrCurrency(12,2,String.valueOf(((new BigDecimal(itens.getFloat(NF.C_VLRLIQITPED))).divide(new BigDecimal(itens.getFloat(NF.C_QTDITPED)),2,BigDecimal.ROUND_HALF_UP)))));
				imp.say(imp.pRow(),120, Funcoes.strDecimalToStrCurrency(12,2,String.valueOf(itens.getFloat(NF.C_VLRLIQITPED))));
				imp.say(imp.pRow(),134, Funcoes.strDecimalToStrCurrency( 2,0,String.valueOf(itens.getFloat(NF.C_PERCICMSITPED))));
				...
				if ((iItImp == itens.getInt(NF.C_CONTAITENS)) || (imp.pRow() == numMax)) {       	 
					if (iItImp == itens.getInt(NF.C_CONTAITENS)) {
						...
						imp.say(imp.pRow()+1,0, imp.comprimido());
						imp.say(imp.pRow()+1,0, imp.comprimido());
						imp.say(imp.pRow(),  8, Funcoes.strDecimalToStrCurrency(20,2,String.valueOf(itens.getFloat(NF.C_VLRBASEICMSPED))));
						...
						imp.say(imp.pRow()+1,0, imp.comprimido());
						imp.say(imp.pRow()+1,0, imp.comprimido());
						imp.say(imp.pRow(),  8, Funcoes.strDecimalToStrCurrency(20,2,String.valueOf(frete.getFloat(NF.C_VLRFRETEPED))));
					...
					if (frete.getString(NF.C_TIPOFRETE)!=null) {   
						imp.say(imp.pRow(),  8, frete.getString(NF.C_RAZTRANSP));
						imp.say(imp.pRow(), 83, frete.getString(NF.C_TIPOFRETE).equals("C") ? "1" : "2");
						imp.say(imp.pRow(), 88, frete.getString(NF.C_PLACAFRETE));
						imp.say(imp.pRow(),105, frete.getString(NF.C_UFFRETE));
					}
					...
					imp.say(imp.pRow()+1,0, imp.comprimido());
					imp.say(imp.pRow()+1,0, imp.comprimido());
					imp.say(imp.pRow(),  8, Funcoes.copy(frete.getString(NF.C_ENDTRANSP),0,50) + ", " + 
											Funcoes.copy(frete.getString(NF.C_NUMTRANSP),0,6));
					imp.say(imp.pRow(), 76, frete.getString(NF.C_CIDTRANSP));
					imp.say(imp.pRow(),105, frete.getString(NF.C_UFTRANSP));
					...
					imp.say(imp.pRow()+1,0, imp.comprimido());
					imp.say(imp.pRow()+1,0, imp.comprimido());
					imp.say(imp.pRow(),  8, ""+frete.getFloat(NF.C_QTDFRETE));
					imp.say(imp.pRow(), 25, frete.getString(NF.C_ESPFRETE));
					imp.say(imp.pRow(), 50, frete.getString(NF.C_MARCAFRETE));
					imp.say(imp.pRow(), 97, ""+frete.getFloat(NF.C_PESOBRUTO));
					imp.say(imp.pRow(),122, ""+frete.getFloat(NF.C_PESOLIQ));					 
