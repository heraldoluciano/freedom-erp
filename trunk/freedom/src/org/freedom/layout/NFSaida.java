...
public class NFSaida extends NF {
	...
	public boolean carregaTabelas( Connection con, Vector parans ) {
		...
		try {
			...
			sql.append( "I.QTDITVENDA, I.VLRLIQITVENDA, I.PERCIPIITVENDA, I.PERCICMSITVENDA, V.VLRICMSVENDA, V.VLRPRODVENDA," );
			sql.append( "V.VLRIPIVENDA, V.VLRLIQVENDA, V.VLRISSVENDA, N.IMPDTSAIDANAT, I.VLRPRODITVENDA, N.DESCNAT, N.CODNAT," );
			sql.append( "I.CODLOTE, I.ORIGFISC, I.CODTRATTRIB, V.VLRBASEICMSVENDA, V.VLRADICVENDA, P.CODFISC, P.TIPOPROD, I.VLRDESCITVENDA," );
			...
			sql.append( "V.VLRFRETEVENDA, F.CONHECFRETEVD " );
