...
public class EbsContabil extends Contabil {
	...
	private String format(BigDecimal value, int size, int decimal) {
		...
		if (value != null) {
			...
			// ).divide( new BigDecimal( "1" + StringFunctions.strZero( "0",
			// decimal ) ) );
			valueTmp = value.setScale(decimal, BigDecimal.ROUND_HALF_UP);
	...
	private class HeaderSaida {
		...
		public String toString() {
			...
			// headerSaida.append( format( Funcoes.setMascara( getCnpj(),
			// "##.###.###/####-##" ), 18 ) );c
	...
	private class Saida {
		...
		public String toString() {
			...
			// saida.append( format( Funcoes.setMascara( getCnpjDestinatario(),
			// "##.###.###/####-##" ), 18 ) );
