...
public class Lfnatoper implements java.io.Serializable {
	...
	private Set<Cpequivcfop> cpequivcfopsForCpequivcfopfklfnan = new HashSet<Cpequivcfop>(
			0);
	...
	public Lfnatoper(LfnatoperId id, Sgfilial sgfilial, String descnat,
			...
			Date halt, String idusualt, Set<Lfitregrafiscal> lfitregrafiscals,
			Set<Lffrete> lffretes,
			Set<Cpequivcfop> cpequivcfopsForCpequivcfopfklfnan,
			Set<Cpitcompra> cpitcompras, Set<Vditvenda> vditvendas,
			Set<Lflivrofiscal> lflivrofiscals,
	...
	public Set<Cpequivcfop> getCpequivcfopsForCpequivcfopfklfnan() {
