...
public class Vdtransp implements java.io.Serializable {
	...
	private Set<Vdfretevd> vdfretevds = new HashSet<Vdfretevd>(0);
	...
	private Set<Vdveiculo> vdveiculos_1 = new HashSet<Vdveiculo>(0);
	private Set<Vdmotorista> vdmotoristas_1 = new HashSet<Vdmotorista>(0);
	private Set<Cpfretecp> cpfretecps = new HashSet<Cpfretecp>(0);
	...
	public Vdtransp(VdtranspId id, Sgfilial sgfilial, Cpforneced cpforneced,
			...
			Set<Vdveiculo> vdveiculos, Set<Sgprefere1> sgprefere1s,
			Set<Eqrecmerc> eqrecmercs, Set<Lffrete> lffretes,
			Set<Vdfretevd> vdfretevds, Set<Vdromaneio> vdromaneios,
			Set<Vdmotorista> vdmotoristas, Set<Eqtipomov> eqtipomovs,
			Set<Vdveiculo> vdveiculos_1, Set<Vdmotorista> vdmotoristas_1,
			Set<Cpfretecp> cpfretecps, Set<Sgprefere8> sgprefere8s,
			Set<Vdorcamento> vdorcamentos, Set<Eqexpedicao> eqexpedicaos,
			Set<Vdcliente> vdclientes, Set<Cpcompra> cpcompras) {
		this.id = id;
		this.sgfilial = sgfilial;
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdtransp")
	public Set<Vdfretevd> getVdfretevds() {
		return this.vdfretevds;
	}

	public void setVdfretevds(Set<Vdfretevd> vdfretevds) {
		this.vdfretevds = vdfretevds;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdtransp")
	public Set<Vdveiculo> getVdveiculos_1() {
		return this.vdveiculos_1;
	}

	public void setVdveiculos_1(Set<Vdveiculo> vdveiculos_1) {
		this.vdveiculos_1 = vdveiculos_1;
	}

	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdtransp")
	public Set<Vdmotorista> getVdmotoristas_1() {
		return this.vdmotoristas_1;
	}

	public void setVdmotoristas_1(Set<Vdmotorista> vdmotoristas_1) {
		this.vdmotoristas_1 = vdmotoristas_1;
	}

	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdtransp")
	public Set<Cpfretecp> getCpfretecps() {
		return this.cpfretecps;
	}

	public void setCpfretecps(Set<Cpfretecp> cpfretecps) {
		this.cpfretecps = cpfretecps;
	}
