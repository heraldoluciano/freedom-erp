...
public class Crchamado implements java.io.Serializable {
	...
	private Set<Crchamadoanexo> crchamadoanexos = new HashSet<Crchamadoanexo>(0);
	...
	public Crchamado(CrchamadoId id, Atatendente atatendente,
			...
			Date dtalt, Date halt, String idusualt, Set<Crtarefa> crtarefas,
			Set<Crchamadoanexo> crchamadoanexos,
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "crchamado")
	public Set<Crchamadoanexo> getCrchamadoanexos() {
		return this.crchamadoanexos;
	}

	public void setCrchamadoanexos(Set<Crchamadoanexo> crchamadoanexos) {
		this.crchamadoanexos = crchamadoanexos;
	}
