...
/**
 * VdprevtribitorcId generated by hbm2java
 */
public class VdprevtribitorcId implements java.io.Serializable {
	...
	public VdprevtribitorcId() {
	}

	public VdprevtribitorcId(int codorc, int coditorc, char tipoorc,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VdprevtribitorcId))
			return false;
		VdprevtribitorcId castOther = (VdprevtribitorcId) other;
