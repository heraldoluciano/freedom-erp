...
public class Eqlocdescarga implements java.io.Serializable {
	...
	@EmbeddedId
	@AttributeOverrides({
			@AttributeOverride(name = "codlocdescarga", column = @Column(name = "CODLOCDESCARGA", nullable = false)),
	...
	@Column(name = "DESCLOCDESCARGA", nullable = false, length = 40)
