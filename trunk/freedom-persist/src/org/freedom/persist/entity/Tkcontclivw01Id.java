...
/**
 * Tkcontclivw01Id generated by hbm2java
 */
@Embeddable
public class Tkcontclivw01Id implements java.io.Serializable {

	private Character tipocto;
	private Integer codemp;
	private Short codfilial;
	private Integer codcto;
	private Character razcto;
	private Character nomecto;
	private Character contcto;
	private Character emailcto;
	...
	public Tkcontclivw01Id() {
	}

	public Tkcontclivw01Id(Character tipocto, Integer codemp, Short codfilial,
			Integer codcto, Character razcto, Character nomecto,
			Character contcto, Character emailcto, String obscto,
			Integer codempto, Short codfilialto, Integer codtipocont,
			Integer codempsr, Short codfilialsr, Integer codsetor,
			Integer codempoc, Short codfilialoc, Integer codorigcont,
			Integer codempti, Short codfilialti, Integer codtipocli,
			Integer codempcc, Short codfilialcc, Integer codclascli,
			Character ativo, Date dtins, Date dtalt, Date dtinscc, Date dtaltcc) {
	...
	@Column(name = "RAZCTO", length = 0)
	public Character getRazcto() {
		return this.razcto;
	}

	public void setRazcto(Character razcto) {
		this.razcto = razcto;
	}

	@Column(name = "NOMECTO", length = 0)
	public Character getNomecto() {
		return this.nomecto;
	}

	public void setNomecto(Character nomecto) {
		this.nomecto = nomecto;
	}

	@Column(name = "CONTCTO", length = 0)
	public Character getContcto() {
		return this.contcto;
	}

	public void setContcto(Character contcto) {
		this.contcto = contcto;
	}

	@Column(name = "EMAILCTO", length = 0)
	public Character getEmailcto() {
		return this.emailcto;
	}

	public void setEmailcto(Character emailcto) {
		this.emailcto = emailcto;
	}

	@Column(name = "OBSCTO", length = 0)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Tkcontclivw01Id))
			return false;
		Tkcontclivw01Id castOther = (Tkcontclivw01Id) other;
