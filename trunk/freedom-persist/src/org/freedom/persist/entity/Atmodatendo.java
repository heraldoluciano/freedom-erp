...
public class Atmodatendo implements java.io.Serializable {
	...
	private Set<Sgprefere3> sgprefere3sForSgprefere3atmodfj = new HashSet<Sgprefere3>(
			0);
	private Set<Sgprefere3> sgprefere3sForSgprefere3atmodmi = new HashSet<Sgprefere3>(
			0);
	private Set<Sgprefere3> sgprefere3sForSgprefere3atmodap = new HashSet<Sgprefere3>(
			0);
	...
	public Atmodatendo(AtmodatendoId id, Sgfilial sgfilial,
			...
			Set<Sgprefere3> sgprefere3sForSgprefere3atmodap) {
		this.id = id;
		this.sgfilial = sgfilial;
	...
	public Set<Sgprefere3> getSgprefere3sForSgprefere3atmodme() {
	...
	public Set<Sgprefere3> getSgprefere3sForSgprefere3atmodfi() {
	...
	public Set<Sgprefere3> getSgprefere3sForSgprefere3atmodfj() {
	...
	public Set<Sgprefere3> getSgprefere3sForSgprefere3atmodmi() {
	...
	public Set<Sgprefere3> getSgprefere3sForSgprefere3atmodap() {
