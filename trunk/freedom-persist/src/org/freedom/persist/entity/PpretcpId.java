...
/**
 * PpretcpId generated by hbm2java
 */
public class PpretcpId implements java.io.Serializable {
	...
	public PpretcpId(int codop, short seqop, short codfilial, int codemp) {
		this.codop = codop;
		this.seqop = seqop;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PpretcpId))
			return false;
		PpretcpId castOther = (PpretcpId) other;
