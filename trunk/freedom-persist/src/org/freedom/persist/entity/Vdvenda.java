...
public class Vdvenda implements java.io.Serializable {
	...
	private Set<Vditromaneio> vditromaneios = new HashSet<Vditromaneio>(0);
	...
	private Set<Vdauxvenda> vdauxvendas = new HashSet<Vdauxvenda>(0);
	...
	private Set<Vdtef> vdtefs = new HashSet<Vdtef>(0);
	...
	public Vdvenda(VdvendaId id, Ppop ppop, Pvcaixa pvcaixa, Fnbanco fnbanco,
			...
			Set<Vditvenda> vditvendas, Set<Vdcomissao> vdcomissaos,
			Set<Ppitop> ppitops, Set<Fnreceber> fnrecebers,
			Set<Fnlibcred> fnlibcreds, Set<Vdtef> vdtefs) {
		this.id = id;
		this.ppop = ppop;
	...
	public Set<Vditromaneio> getVditromaneios() {
		return this.vditromaneios;
	}

	public void setVditromaneios(Set<Vditromaneio> vditromaneios) {
		this.vditromaneios = vditromaneios;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdvenda")
	public Set<Vdauxvenda> getVdauxvendas() {
		return this.vdauxvendas;
	}

	public void setVdauxvendas(Set<Vdauxvenda> vdauxvendas) {
		this.vdauxvendas = vdauxvendas;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdvenda")
	public Set<Vdtef> getVdtefs() {
		return this.vdtefs;
	}

	public void setVdtefs(Set<Vdtef> vdtefs) {
		this.vdtefs = vdtefs;
	}
