...
public class AtagendaId implements java.io.Serializable {
	...
	@Column(name = "CODAG", nullable = false)
	public int getCodag() {
		return this.codag;
	}
	...
	@Column(name = "CODEMPSA", nullable = false)
	...
	@Column(name = "CODFILIALSA", nullable = false)
	...
	@Column(name = "DTACADAG", nullable = false, length = 10)
	...
	@Column(name = "HORACATAG", nullable = false, length = 8)
	...
	@Column(name = "DTAAG", nullable = false, length = 10)
	...
	@Column(name = "HORAAG", nullable = false, length = 8)
	...
	@Column(name = "DESCAGENDA", nullable = false, length = 50)
	...
	@Column(name = "DTAATENDAG", length = 10)
	...
	@Column(name = "HORAATENDAG", length = 8)
	...
	@Column(name = "OBSAGENDA", length = 10000)
