...
public class Lfitnatoper implements java.io.Serializable {
	...
	@EmbeddedId
	@AttributeOverrides({
			@AttributeOverride(name = "coditnatoper", column = @Column(name = "CODITNATOPER", nullable = false)),
	...
	@JoinColumns({
			@JoinColumn(name = "UFTI", referencedColumnName = "UFTI", nullable = false),
