...
public class Vdcliente implements java.io.Serializable {
	...
	private Set<Vdclirefp> vdclirefps = new HashSet<Vdclirefp>(0);
	private Set<Eqrecmerc> eqrecmercs = new HashSet<Eqrecmerc>(0);
	private Set<Vdclirefc> vdclirefcs = new HashSet<Vdclirefc>(0);
	private Set<Vdcliimov> vdcliimovs = new HashSet<Vdcliimov>(0);
	private Set<Fnrestricao> fnrestricaos = new HashSet<Fnrestricao>(0);
	...
	private Set<Vdclimetavend> vdclimetavends = new HashSet<Vdclimetavend>(0);
	private Set<Vdcliterra> vdcliterras = new HashSet<Vdcliterra>(0);
	private Set<Crchamado> crchamados = new HashSet<Crchamado>(0);
	private Set<Sgprefere4> sgprefere4s = new HashSet<Sgprefere4>(0);
	private Set<Vdsetorrota> vdsetorrotas = new HashSet<Vdsetorrota>(0);
	...
	private Set<Vdobscli> vdobsclis = new HashSet<Vdobscli>(0);
	private Set<Vdcliautp> vdcliautps = new HashSet<Vdcliautp>(0);
	...
	private Set<Vdcliveic> vdcliveics = new HashSet<Vdcliveic>(0);
	private Set<Fnlanca> fnlancas = new HashSet<Fnlanca>(0);
	private Vdclicompl vdclicompl;
	private Set<Vdcontrato> vdcontratos = new HashSet<Vdcontrato>(0);
	private Set<Vdclisocios> vdclisocioses = new HashSet<Vdclisocios>(0);
	private Set<Tkcampanhacli> tkcampanhaclis = new HashSet<Tkcampanhacli>(0);
	private Set<Svos> svoses = new HashSet<Svos>(0);
	...
	public Vdcliente(VdclienteId id, Vdtipocli vdtipocli,
			...
			Set<Tkcampanhacto> tkcampanhactos, Set<Atmodatendo> atmodatendos,
			Set<Tkhistorico> tkhistoricos, Set<Tkcontcli> tkcontclis,
			Set<Vdclirefp> vdclirefps, Set<Eqrecmerc> eqrecmercs,
			Set<Vdclirefc> vdclirefcs, Set<Vdcliimov> vdcliimovs,
			Set<Fnrestricao> fnrestricaos, Set<Eqmovexp> eqmovexps,
			Set<Eqclifor> eqclifors, Set<Fnlibcred> fnlibcreds,
			Set<Fnsublanca> fnsublancas, Set<Vdclicontas> vdclicontases,
			Set<Vdclimetavend> vdclimetavends, Set<Vdcliterra> vdcliterras,
			Set<Crchamado> crchamados, Set<Sgprefere4> sgprefere4s,
			Set<Vdsetorrota> vdsetorrotas, Set<Vdvenda> vdvendas,
			Set<Sgeqvclifor> sgeqvclifors, Set<Vdvendaconsig> vdvendaconsigs,
			Set<Vdobscli> vdobsclis, Set<Vdcliautp> vdcliautps,
			Set<Tksitcamp> tksitcamps, Set<Vdorcamento> vdorcamentos,
			Set<Fnfbncli> fnfbnclis, Set<Vdcliveic> vdcliveics,
			Set<Fnlanca> fnlancas, Vdclicompl vdclicompl,
			Set<Vdcontrato> vdcontratos, Set<Vdclisocios> vdclisocioses,
			Set<Tkcampanhacli> tkcampanhaclis, Set<Svos> svoses,
			Set<Fnreceber> fnrecebers, Set<Eqlanctoexp> eqlanctoexps) {
		this.id = id;
		this.vdtipocli = vdtipocli;
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdcliente")
	public Set<Vdclirefp> getVdclirefps() {
		return this.vdclirefps;
	}

	public void setVdclirefps(Set<Vdclirefp> vdclirefps) {
		this.vdclirefps = vdclirefps;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdcliente")
	public Set<Vdclirefc> getVdclirefcs() {
		return this.vdclirefcs;
	}

	public void setVdclirefcs(Set<Vdclirefc> vdclirefcs) {
		this.vdclirefcs = vdclirefcs;
	}

	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdcliente")
	public Set<Vdcliimov> getVdcliimovs() {
		return this.vdcliimovs;
	}

	public void setVdcliimovs(Set<Vdcliimov> vdcliimovs) {
		this.vdcliimovs = vdcliimovs;
	}

	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdcliente")
	public Set<Fnrestricao> getFnrestricaos() {
		return this.fnrestricaos;
	}

	public void setFnrestricaos(Set<Fnrestricao> fnrestricaos) {
		this.fnrestricaos = fnrestricaos;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdcliente")
	public Set<Vdclimetavend> getVdclimetavends() {
		return this.vdclimetavends;
	}

	public void setVdclimetavends(Set<Vdclimetavend> vdclimetavends) {
		this.vdclimetavends = vdclimetavends;
	}

	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdcliente")
	public Set<Vdcliterra> getVdcliterras() {
		return this.vdcliterras;
	}

	public void setVdcliterras(Set<Vdcliterra> vdcliterras) {
		this.vdcliterras = vdcliterras;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdcliente")
	public Set<Vdsetorrota> getVdsetorrotas() {
		return this.vdsetorrotas;
	}

	public void setVdsetorrotas(Set<Vdsetorrota> vdsetorrotas) {
		this.vdsetorrotas = vdsetorrotas;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdcliente")
	public Set<Vdobscli> getVdobsclis() {
		return this.vdobsclis;
	}

	public void setVdobsclis(Set<Vdobscli> vdobsclis) {
		this.vdobsclis = vdobsclis;
	}

	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdcliente")
	public Set<Vdcliautp> getVdcliautps() {
		return this.vdcliautps;
	}

	public void setVdcliautps(Set<Vdcliautp> vdcliautps) {
		this.vdcliautps = vdcliautps;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdcliente")
	public Set<Vdcliveic> getVdcliveics() {
		return this.vdcliveics;
	}

	public void setVdcliveics(Set<Vdcliveic> vdcliveics) {
		this.vdcliveics = vdcliveics;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdcliente")
	public Set<Vdcontrato> getVdcontratos() {
		return this.vdcontratos;
	}

	public void setVdcontratos(Set<Vdcontrato> vdcontratos) {
		this.vdcontratos = vdcontratos;
	}

	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdcliente")
	public Set<Vdclisocios> getVdclisocioses() {
		return this.vdclisocioses;
	}

	public void setVdclisocioses(Set<Vdclisocios> vdclisocioses) {
		this.vdclisocioses = vdclisocioses;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "vdcliente")
	public Set<Svos> getSvoses() {
		return this.svoses;
	}

	public void setSvoses(Set<Svos> svoses) {
		this.svoses = svoses;
	}
