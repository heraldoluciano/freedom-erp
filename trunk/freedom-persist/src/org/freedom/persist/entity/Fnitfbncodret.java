...
public class Fnitfbncodret implements java.io.Serializable {
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "coditret", column = @Column(name = "CODITRET", nullable = false, length = 4)),
	...
	@JoinColumns({
			@JoinColumn(name = "CODRET", referencedColumnName = "CODRET", nullable = false, insertable = false, updatable = false),
	...
	@Column(name = "DESCITRET", nullable = false, length = 150)
