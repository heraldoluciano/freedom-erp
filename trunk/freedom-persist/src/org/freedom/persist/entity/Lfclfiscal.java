...
public class Lfclfiscal implements java.io.Serializable {
	...
	public Lfclfiscal(LfclfiscalId id, Sgfilial sgfilial, Lfservico lfservico,
			Lfregrafiscal lfregrafiscal, Lfncmnbm lfncmnbm, String descfisc,
			String tipofisc, Character tpredicmsfisc, BigDecimal aliqfisc,
			BigDecimal aliqlfisc, BigDecimal redfisc, BigDecimal aliqipifisc,
			Character origfisc, Integer codemptt, Short codfilialtt,
			String codtrattrib, Integer codempme, Short codfilialme,
			Integer codmens, Character sitpisfisc, Character sitcofinsfisc,
			String tipost, BigDecimal margemvlagr, String extipi, Date dtins,
			Date hins, String idusuins, Date dtalt, Date halt, String idusualt,
			Set<Lfitclfiscal> lfitclfiscals, Set<Eqproduto> eqprodutos) {
		this.id = id;
		this.sgfilial = sgfilial;
