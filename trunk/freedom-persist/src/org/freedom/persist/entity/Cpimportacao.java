...
public class Cpimportacao implements java.io.Serializable {
	...
	private Set<Cpimportacaocompl> cpimportacaocompls = new HashSet<Cpimportacaocompl>(
			0);
	...
	public Cpimportacao(CpimportacaoId id, Cpforneced cpforneced,
			...
			String idusualt, Set<Cpitimportacao> cpitimportacaos,
			Set<Cpimportacaocompl> cpimportacaocompls,
			Set<Cpimportacaoadic> cpimportacaoadics,
			Set<Cpimportacao> cpimportacaos, Set<Cpcompra> cpcompras) {
		this.id = id;
		this.cpforneced = cpforneced;
		this.fnplanopag = fnplanopag;
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "cpimportacao")
	public Set<Cpimportacaocompl> getCpimportacaocompls() {
		return this.cpimportacaocompls;
	}

	public void setCpimportacaocompls(Set<Cpimportacaocompl> cpimportacaocompls) {
		this.cpimportacaocompls = cpimportacaocompls;
	}
