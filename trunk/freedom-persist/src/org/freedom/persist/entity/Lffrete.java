...
public class Lffrete implements java.io.Serializable {
	...
	private Set<Lffretevenda> lffretevendas = new HashSet<Lffretevenda>(0);
	...
	public Lffrete(LffreteId id, Fnpagar fnpagar, Eqrecmerc eqrecmerc,
			...
			Set<Lffretecompra> lffretecompras, Set<Lffretevenda> lffretevendas) {
		this.id = id;
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "lffrete")
	public Set<Lffretevenda> getLffretevendas() {
		return this.lffretevendas;
	}

	public void setLffretevendas(Set<Lffretevenda> lffretevendas) {
		this.lffretevendas = lffretevendas;
	}
