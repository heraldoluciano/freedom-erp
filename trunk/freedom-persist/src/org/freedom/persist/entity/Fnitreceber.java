...
public class Fnitreceber implements java.io.Serializable {
	...
	private Set<Fnitrenegrec> fnitrenegrecs = new HashSet<Fnitrenegrec>(0);
	private Set<Fnlanca> fnlancas = new HashSet<Fnlanca>(0);
	private Set<Vdcomissao> vdcomissaos = new HashSet<Vdcomissao>(0);
	private Set<Fnitbordero> fnitborderos = new HashSet<Fnitbordero>(0);
	private Set<Fnsublanca> fnsublancas = new HashSet<Fnsublanca>(0);
	private Fnfbnrec fnfbnrec;
	private Set<Atatendimentoitrec> atatendimentoitrecs = new HashSet<Atatendimentoitrec>(
			0);
	...
	public Fnitreceber(FnitreceberId id, Fnconta fnconta, Fntipocob fntipocob,
			...
			Set<Fnitrenegrec> fnitrenegrecs, Set<Fnlanca> fnlancas,
			Set<Vdcomissao> vdcomissaos, Set<Fnitbordero> fnitborderos,
			Set<Fnsublanca> fnsublancas, Fnfbnrec fnfbnrec,
			Set<Atatendimentoitrec> atatendimentoitrecs) {
		this.id = id;
	...
	public Set<Fnitrenegrec> getFnitrenegrecs() {
		return this.fnitrenegrecs;
	}

	public void setFnitrenegrecs(Set<Fnitrenegrec> fnitrenegrecs) {
		this.fnitrenegrecs = fnitrenegrecs;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "fnitreceber")
	public Set<Fnitbordero> getFnitborderos() {
		return this.fnitborderos;
	}

	public void setFnitborderos(Set<Fnitbordero> fnitborderos) {
		this.fnitborderos = fnitborderos;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "fnitreceber")
	public Set<Atatendimentoitrec> getAtatendimentoitrecs() {
		return this.atatendimentoitrecs;
	}

	public void setAtatendimentoitrecs(
			Set<Atatendimentoitrec> atatendimentoitrecs) {
		this.atatendimentoitrecs = atatendimentoitrecs;
	}
