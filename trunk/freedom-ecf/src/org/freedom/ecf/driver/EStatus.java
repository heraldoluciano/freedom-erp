...
public enum EStatus {
	...
	DARUMA_ERROR_N1( -1, "Comando não implementado pelo driver de comunicação." ), DARUMA_ERROR_01( 1, "Comando habilitado somente em modo manutenção." ), DARUMA_ERROR_02( 2, "Falha na gravação da Memória Fiscal." ), DARUMA_ERROR_03( 3,
			...
			"Impressão no verso somente após a impressão da frente do cheque." ), DARUMA_ERROR_88( 88, "Valor inválido para o cheque." ), DARUMA_WARNING_01( 1001, "Near End foi detectado." ), DARUMA_WARNING_02( 1002, "Execute redução Z." ), DARUMA_WARNING_04(
