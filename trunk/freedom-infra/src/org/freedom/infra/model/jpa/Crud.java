...
public class Crud {
	...
	public Crud( int persistFramework, String persistUnit, String initFile, String sessionName, String userParam, String passwordParam ) {
	...
	private static Map<String, String> getParamsDB( final int persistFramework, final String initFile, final String sessionName, final String userParam, final String passwordParam ) {
