...
public class CryptUtil {
	...
	/**
	 * 
	 * @param 	key				<Descrição do parametro>
	 * @return	<Descrição do retorno>
	 * @since 	25/06/2008
	 */
	public static byte[] generateKey( String key ) {
		...
		byte[] encKey = new byte[] 
                          { 107, 101, 121, 64, 101, 110, 99, 114, 121, 112, 116, 105, 111, 110 };
		if ( key != null ) {
			encKey = key.getBytes();
		}
		return encKey;
	...
	/**
	 * 
	 * @param 	source			<Descrição do parametro>
	 * @param 	encKey			<Descrição do parametro>
	 * @return	<Descrição do retorno> 
	 ...
	 * @since 	25/06/2008
	 */
	public static String encrypt( String source, byte[] encKey ) throws UnsupportedEncodingException, 
	...
	/**
	 * 
	 * @param 	encryptedSource	<Descrição do parametro>
	 * @param 	encKey			<Descrição do parametro>
	 * @return	<Descrição do retorno>
	 * @throws 	UnsupportedEncodingException
	 * @throws 	NoSuchAlgorithmException
	 ...
	 * @since 	25/06/2008
	 */
	public static String decrypt( String encryptedSource, byte[] encKey ) throws UnsupportedEncodingException, 
	                                                                             NoSuchAlgorithmException, 
	                                                                             NoSuchPaddingException, 
	                                                                             InvalidKeyException, 
	                                                                             IllegalStateException, 
	 ...
	 * 
	 * @param 	source			<Descrição do parametro>
	 * @param 	destination		<Descrição do parametro>
	 * @param 	encKey			<Descrição do parametro>
	 * @throws 	NoSuchAlgorithmException
	 * @throws 	NoSuchPaddingException
	 * @throws 	InvalidKeyException
	 ...
	 * @since 	25/06/2008
	 */
	public static void encrypt( String source, String destination, byte[] encKey ) throws NoSuchAlgorithmException, 
	                                                                                      NoSuchPaddingException, 
	                                                                                      InvalidKeyException, 
	                                                                                      IllegalStateException, 
	                                                                                      IllegalBlockSizeException, 
	 ...
	 * @since 	25/06/2008
	 */
	public static void decrypt( String source, String destination, byte[] encKey ) throws NoSuchAlgorithmException, 
	                                                                                      NoSuchPaddingException, 
	                                                                                      InvalidKeyException, 
	                                                                                      IllegalStateException, 
	                                                                                      IllegalBlockSizeException, 
