 ...
 * 
 * <blockquote>
 * Exemplo: 0000/00/00 - desta forma deverá ser substituido o '0' pelo caracter inteiro.<br>
 ...
 * </ul>
 * </code>
 * Qualquer caracter diferente destes será identificado como mascara e não deverá ser substituido,
 * como o caracter '/' apresentado no exemplo.
 * </blockquote>
 * 
 * @see 		Document
...
public class Mask {
	 ...
	 * 
	 * @param 	mask	String contendo o modelo de mascara
	 * 
	 * @since 	13/05/2008
	 */
	...
	/**
	 * @return	Cópia do array de caracteres que formam a mascara.
	 * 			É retornada uma cópia para proteger a formação da mascara.
	 */
	...
	/**
	 * @param 	size		Tamanho da mascara, sem contar o caracter de separação da decimal.
	...
	/**
	 * @param 	size	Tamanho máximo para o texto.
	...
	/**
	 * @return	Mascara para tempo no formato hora:minuto:segundo:milisegundo ( HH:MM:SS.sss )
	 * 
	 * @since 	13/05/2008
	 */
