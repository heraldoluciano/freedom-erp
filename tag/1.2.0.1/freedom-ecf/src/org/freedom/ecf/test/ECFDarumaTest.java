...
public class ECFDarumaTest extends TestCase {
	...
	public void testComandosDeCupomFiscal() {
		...
		*/
		...
		assertTrue( trataresultFuncao( ecf, ecf.vendaItem( 
		...
		assertTrue( trataresultFuncao( ecf, ecf.programaUnidadeMedida( "Kg" ) ) );
		...
		*/
		...
		assertTrue( trataresultFuncao( ecf, ecf.efetuaFormaPagamento( "01", 10.00f, null ) ) );
		*/
		...
		assertTrue( trataresultFuncao( ecf, ecf.estornoFormaPagamento( "Cheque          ", "Dinheiro", 5.50f ) ) );
		*/
	...
	public void testComandosDeOperacoesNaoFiscais() {
		...
		assertTrue( trataresultFuncao( ecf, ecf.relatorioGerencial( 
		...
		assertTrue( trataresultFuncao( ecf, ecf.fechamentoRelatorioGerencial() ) );
		*/
		...
		assertTrue( trataresultFuncao( ecf, ecf.abreComprovanteNFiscalVinculado( "Cheque          ", 10f, Integer.parseInt( ecf.resultNumeroCupom() ) ) ) );
		
		System.out.print( "usaComprovanteNFiscalVinculado > " ); 
		assertTrue( trataresultFuncao( ecf, ecf.usaComprovanteNFiscalVinculado( 
				"Comprovante \nTeste\nteste\nteste..." ) ) );		
	...
	public void testComandosDeRelatoriosFiscais() {
		...
		//assertTrue( trataresultFuncao( ecf, ecf.leituraMemoriaFiscal( antes, hoje, ECFDaruma.IMPRESSAO ) ) );
		//System.out.println( new String( ecf.getBytesLidos() ) );
		
		System.out.print( "leituraMemoriaFiscal data result > " );
		assertTrue( trataresultFuncao( ecf, ecf.leituraMemoriaFiscal( antes, hoje, ECFDaruma.result ) ) );
		System.out.println( new String( ecf.getBytesLidos() ) );
		
		System.out.print( "leituraMemoriaFiscal redução > " ); 
		assertTrue( trataresultFuncao( ecf, ecf.leituraMemoriaFiscal( 605, 610, ECFDaruma.IMPRESSAO ) ) );
		System.out.println( new String( ecf.getBytesLidos() ) );
		
		System.out.print( "leituraMemoriaFiscal redução result > " ); 
		assertTrue( trataresultFuncao( ecf, ecf.leituraMemoriaFiscal( 605, 610, ECFDaruma.result ) ) );
		System.out.println( new String( ecf.getBytesLidos() ) );*/
