 ...
 * <BR>
 * 
 *         Tela para ordem do relatório de qualificações.
 */
...
public class DLRQualificacao extends FFDialogo {
	...
	public String getValor() {
		...
		if ( rgOrdem.getVlrString().compareTo( "C" ) == 0 )
			sRetorno = "CODQUALIFIC";
		else if ( rgOrdem.getVlrString().compareTo( "D" ) == 0 )
			sRetorno = "DESCQUALIFIC";
		return sRetorno;
	}
}
