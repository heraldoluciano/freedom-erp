...
public class DedicatedAction implements TefAction {
	 ...
	 * No retorno o primenro carácter presente em Buffer deve conter 0 se confirma e 1 se cancela.
	 */
	 ...
	 * Na chamada o parâmetro Buffer contém as opções da forma que ele desejar 
	 * (não sendo necessário incluir os índices 1,2,...) e após a seleção feira pelo usuário, 
	...
	/**
	 * Deve ser lido um campo cujo tamanho está entre Tamanho Minimo e Tamanho Máximo.
	 ...
	 * A coleta pode ser feita via leitura de CMC-7 ou pela digutação da primeira linha do cheque. 
	 * No retorno deve ser devolvido em Buffer "0:" ou "1:" seguido do número coletado manualmente ou 
	 * pela leitura do CMC-7, respectivamente. Quando o número for coletado manualmente o formato é o sequinte:
	 * Compensação (3), Banco (3), Agencia(4), C1 (1), Conta Conrrente (10), C2 (1), Número do cheque (6), e C3(1), nesta ordem.
	 * Notar que estes campos são os que estão na parte superior de um cheque e na ordem apresentada.
	 */
	...
	/** 
	 * Deve ser lido um campo monetário ou seja, aceita o delimitador de centavos e 
	 ...
	 * sequido do código em barras coletado manualmente ou pela leitora, respectivamente
	 */
