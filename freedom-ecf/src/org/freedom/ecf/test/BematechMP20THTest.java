...
//		assertTrue( trataresultFuncao( ecf.comprovanteNFiscalNVinculado( "02", 35f, "Dinheiro        " ) ) );
	...
	/*public void testComandosDeRelatoriosFiscais() {
		...
		assertTrue( trataresultFuncao( ecf.leituraMemoriaFiscal( antes, hoje, BematechMP20TH.IMPRESSAO ) ) );
		System.out.println( new String( ecf.getBytesLidos() ) );
		
		System.out.print( "leituraMemoriaFiscal data result > " );
		assertTrue( trataresultFuncao( ecf.leituraMemoriaFiscal( antes, hoje, BematechMP20TH.SERIAL ) ) );
		System.out.println( new String( ecf.getBytesLidos() ) );
		
		System.out.print( "leituraMemoriaFiscal redução > " ); 
		assertTrue( trataresultFuncao( ecf.leituraMemoriaFiscal( 2, 13, BematechMP20TH.IMPRESSAO ) ) );
		System.out.println( new String( ecf.getBytesLidos() ) );
		
		System.out.print( "leituraMemoriaFiscal redução result > " ); 
		assertTrue( trataresultFuncao( ecf.leituraMemoriaFiscal( 2, 13, BematechMP20TH.SERIAL ) ) );
		System.out.println( new String( ecf.getBytesLidos() ) );
	}*/
	...
	/*public void testComandosDeInformacoesDaImpressora() {
		...
		System.out.println( "\tGrande total > " + ecf.resultVariaveis( BematechMP20TH.V_GRANDE_TOTAL ) );
		System.out.println( "\tFlags Fiscais > " + ecf.resultVariaveis( BematechMP20TH.V_FLAG_FISCAL ) );
