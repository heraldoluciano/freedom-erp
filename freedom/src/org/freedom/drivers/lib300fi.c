...
//Claudenir C. Andrade 22/03/01
//O Linux não usa a TTY paar idnentificar a Porta
//Usa o ttyS1 e ttyS2 para Com1 e Com2 Respectivas

#define    LIB_TTY1A           "/dev/ttyS0"   //Mod Claudenir de TTY1A para TTYS1
#define    LIB_TTY1B           "/dev/ttyS1"   //Mod Claudenir de TTY1B para TTYS2
#define    LIB_TTY1C           "/dev/ttyS2"   //Mod Claudenir de TTY1B para TTYS2

#define    LIB_NOME            "memoria.20fi"
#define    LIB_CRIA            ( O_RDWR | O_CREAT | O_TRUNC )
#define    LIB_MODO            0660
#define    LIB_RETRY           4
#define    LIB_TEMPO           300
 ...
 */
 ...
 if (( libContr = open ( libDevice, O_RDWR )) == -1 )
      {
        libErrno = errno;
