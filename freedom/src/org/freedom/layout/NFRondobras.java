 ...
 *
 * Layout da nota fiscal para a empresa Rondobras auto peças.
 */
...
public class NFRondobras extends Leiaute {
...
//             imp.say(imp.pRow()+0,116,Funcoes.strDecimalToStrCurrency(20,2,rs.getString("VlrProdVenda")));
           ...
           imp.say(imp.pRow()+0,87,rs.getString("TipoFreteVD").equals("C") ? "1" : "2");
