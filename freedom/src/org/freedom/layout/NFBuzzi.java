...
public class NFBuzzi extends Leiaute {
	...
	private void impTotais(ImprimeOS imp,Vector vValores){
		...
		try {	
			...
			imp.say(imp.pRow()+1,0, imp.comprimido());
			imp.say(imp.pRow()+1,0, imp.comprimido());			    	        	       	      	      
			imp.say(imp.pRow(),  8, vValores.elementAt(7).toString());
			imp.say(imp.pRow(), 80, vValores.elementAt(8).toString().equals("C") ? "1" : "2");
			imp.say(imp.pRow(), 87, vValores.elementAt(9).toString());
			imp.say(imp.pRow(),103, vValores.elementAt(10).toString());
						  
			if ( !vValores.elementAt(11).toString().equals("C") )
				imp.say(imp.pRow(),118, Funcoes.setMascara(vValores.elementAt(13).toString() != null ? vValores.elementAt(13).toString() : "","##.###.###/####-##")); 
						
			imp.say(imp.pRow()+1,0, imp.comprimido());			  
			imp.say(imp.pRow()+1,0, imp.comprimido());
			imp.say(imp.pRow(),  8, vValores.elementAt(14).toString().trim());
			imp.say(imp.pRow(), 68, vValores.elementAt(16).toString().trim());
			imp.say(imp.pRow(),102, vValores.elementAt(17).toString().trim());
			imp.say(imp.pRow(),121, vValores.elementAt(18).toString());			    	      
			imp.say(imp.pRow()+1,0, imp.comprimido());
			imp.say(imp.pRow()+1,0, imp.comprimido());			  
			imp.say(imp.pRow(),  8, vValores.elementAt(19).toString());
			imp.say(imp.pRow(), 25, vValores.elementAt(20).toString());
			imp.say(imp.pRow(), 48, vValores.elementAt(21).toString());
			imp.say(imp.pRow(),103, vValores.elementAt(22).toString());
			imp.say(imp.pRow(),128, vValores.elementAt(23).toString());			  
			imp.say(imp.pRow()+1,0, imp.comprimido());
			imp.say(imp.pRow()+1,0, imp.comprimido());
			...
			for (int i=0; i<vObs.size(); i++) {
				...
				imp.say(imp.pRow()+1,0, imp.comprimido());
				imp.say(imp.pRow(),  5, vObs.elementAt(i).toString());
				
				if(i==0)
					imp.say(imp.pRow(), 43, "Vendedor: " + vValores.elementAt(25).toString());
				
				if(i==1)
					imp.say(imp.pRow(), 43, vValores.elementAt(26).toString().substring(0,20));
