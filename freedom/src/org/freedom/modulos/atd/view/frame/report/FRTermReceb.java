...
public class FRTermReceb extends FRelatorio {
	...
	public void imprimir( TYPE_PRINT b ) {
		...
		sql.append( "SELECT O.CODEMP, O.CODFILIAL, O.CODORC, CV.NOMECONV, CV.RGCONV, CV.CPFCONV, CV.DTNASCCONV, " );
		sql.append( "P2.CABTERMR01 , P2.CABTERMR02, P2.RODTERMR, IO.NUMAUTORIZORC, P.DESCPROD, P.CODBARPROD, P.DESCCOMPPROD, " );
