...
public class FreedomATD extends Aplicativo implements ActionListener {
	public FreedomATD() {
		super("iconAtendimento32.gif", "splashATD.jpg",  1, "Freedom" , 4, "Atendimento", "freedom.ini", null);
		...
		addOpcao(100101000, TP_OPCAO_ITEM, "Atribuições", "Abribuições", 'A',
		...
		addOpcao(-1, TP_OPCAO_MENU, "Orçamento", "", 'O', 1200000000, 0, false,
				null);
		addOpcao(1200000000, TP_OPCAO_ITEM, "Orçamento", "Orcamento", 'O',
				120100000, 1, true, FOrcamento.class);
		addSeparador(1200000000);
		addOpcao(1200000000, TP_OPCAO_ITEM, "Pesquisa Orçamentos",
				"Pesquisa Orcamentos", 'P', 120200000, 1, true, FConsOrc.class);
		addOpcao(1200000000, TP_OPCAO_ITEM, "Aprova Orçamentos",
				"Aprova Orcamento", 'A', 120300000, 1, true, FAprovaOrc.class);
		addOpcao(1200000000, TP_OPCAO_ITEM, "Pesquisa Autorizações",
				"Pesquisa Autorização", 'e', 120400000, 1, true,
				FConsAutoriz.class);

		addBotao("btAtendimento.gif", "Atendimento", "Atendimento", 110100000,
				FAtendimento.class);
		addBotao("btOrcamento.gif", "Orçamento", "Orcamento", 120100000,
				FOrcamento.class);
		addBotao("btConsOrcamento.gif", "Pesquisa Orçamento",
		...
		addBotao("btAprovaOrc.gif", "Aprovações de Orçamantos",
