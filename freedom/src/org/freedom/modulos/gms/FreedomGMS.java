...
public class FreedomGMS extends AplicativoPD {
	...
	public FreedomGMS() {
		...
		addOpcao( 400000000, TP_OPCAO_ITEM, "Consulta preço", "Consulta preço", 'P', 400400000, 1, true, FConsPreco.class );
		...
		addOpcao( 500500000, TP_OPCAO_ITEM, "Relação de entradas/peso", "Relação de entradas/peso", 'e', 500501100, 2, true, FRPesoRecMerc.class );
