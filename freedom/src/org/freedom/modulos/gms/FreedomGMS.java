	...
	public FreedomGMS() {
		...
		addOpcao(-1,TP_OPCAO_MENU,"Arquivo",'A',100000000,0,false);
			addOpcao(100000000,TP_OPCAO_MENU,"Cadastros",'T',100100000,1,false);
		    	addOpcao(100100000,TP_OPCAO_MENU,"Clientes",'C',100101000,2,false);
		    		addOpcao(100101000,TP_OPCAO_ITEM,"Clientes", 'C',100101010,3,true);
		        addSeparador(100100000);	    
		    	addOpcao(100100000,TP_OPCAO_MENU,"Fornecedores",'C',100201000,2,false);
		    		addOpcao(100201000,TP_OPCAO_ITEM,"Tipos de fornecedores",'e',100201010,3,true);  
		    		addOpcao(100201000,TP_OPCAO_ITEM,"Fornecedores",'r',100201020,3,true);    
		        addSeparador(100100000);
		        addOpcao(100100000,TP_OPCAO_MENU,"Produtos",'u',100301000,2,false);
		        	addOpcao(100301000,TP_OPCAO_ITEM,"Tratamentos tributários",'t',100301010,3,true);
		        	addOpcao(100301000,TP_OPCAO_ITEM,"Classificações fiscais",'l',100130020,3,true);
		        	addOpcao(100301000,TP_OPCAO_ITEM,"Almoxarifados",'x',100130030,3,true);
		        	addOpcao(100301000,TP_OPCAO_ITEM,"Grupos",'r',100130040,3,true);
		        	addOpcao(100301000,TP_OPCAO_ITEM,"Marcas",'c',100130050,3,true);
		        	addOpcao(100301000,TP_OPCAO_ITEM,"Unidades",'U',100130060,3,true);
			      	addOpcao(100301000,TP_OPCAO_ITEM,"Kits de produtos",'K',100130070,3,true);
		        	addOpcao(100301000,TP_OPCAO_ITEM,"Produtos",'P',100130080,3,true);
		        	addSeparador(100301000);
		        	addOpcao(100301000,TP_OPCAO_MENU,"Grade de produtos",'G',100130090,3,false);        
		        		addOpcao(100130090,TP_OPCAO_ITEM,"Variantes",'V',100130091,4,true);
		        		addOpcao(100130090,TP_OPCAO_ITEM,"Modelos",'M',100130092,4,true);
		        		addOpcao(100130090,TP_OPCAO_ITEM,"Grades",'r',100130093,4,true);
		        addSeparador(100100000);	  		    		    		    		  	   
		        addOpcao(100100000,TP_OPCAO_MENU,"Outros cadastros",'C',100401000,2,false);		    
		        	addOpcao(100401000,TP_OPCAO_ITEM,"Transportadoras",'p',100401010,3,true);  	    
		        	addSeparador(100401000);
		        	addOpcao(100401000,TP_OPCAO_ITEM,"Tipo de cobrança",'o',100401020,3,true);
		        	addOpcao(100401000,TP_OPCAO_ITEM,"Plano de pagamento",'s',100401030,3,true);
		        	addSeparador(100401000);
		        	addOpcao(100401000,TP_OPCAO_ITEM,"Natureza de operação",'z',100401040,3,true);
		        	addSeparador(100401000); 
				    addOpcao(100100000,TP_OPCAO_MENU,"Atribuições",'t',100401050,3,false);
				      	addOpcao(100401050,TP_OPCAO_ITEM,"Atribuições",'r',100401051,4,true);
				      	addOpcao(100401050,TP_OPCAO_ITEM,"Atribuições por usuário",'u',100401052,4,true);		        	
		    ...
		    addOpcao(100000000,TP_OPCAO_MENU,"Configurações",'C',100300000,1,false);
		    	addOpcao(100300000,TP_OPCAO_ITEM,"Impressora",'I',100310000,2,true);
		    	addOpcao(100300000,TP_OPCAO_ITEM,"Papel",'P',100320000,2,true);
		    	addOpcao(100300000,TP_OPCAO_ITEM,"Estação",'E',100330000,2,true);// lom
		    	addSeparador(100300000);
		    	addOpcao(100300000,TP_OPCAO_MENU,"Preferências",'P',100340000,2,false);
		    		addOpcao(100340000,TP_OPCAO_ITEM,"Preferências gerais",'g',100340010,3,true);
		    		addOpcao(100300000,TP_OPCAO_ITEM,"Série de NFs",'N',100340020,3,true);
