...
public class FbnUtil {
	...
	public enum EParcela {
		CODREC, NPARCITREC, VLRITREC, VLRDESCITREC, VLRMULTAITREC, VLRJUROSITREC, VLRPARCITREC, VLRPAGOITREC, VLRAPAGITREC, DTITREC, DTVENCITREC, DTPAGOITREC, STATUSITREC, CODPLAN, OBSITREC, NUMCONTA, CODBANCO, CODTIPOCOB, DOCLANCAITREC, FLAG, ANOCC, CODCC, VLRCOMIITREC;
	}
