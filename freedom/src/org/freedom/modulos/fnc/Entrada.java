...
public class Entrada extends FDados implements PostListener {
	  ...
	  private void imprimir(boolean bVisualizar) {
	    ...
	    String sSQL = "select vdcliente.Nomecli as nome, fnbanco.Nomebanco as banco, sgcheque.NCHEQUE, sgcheque.predata,sgcheque.Dtins, sgcheque.valor "
                      +"from vdcliente, fnbanco, sgcheque where "
                      +"vdcliente.CODCLI=sgcheque.CODCLI and fnbanco.codbanco=sgcheque.codbanco and UPPER(vdcliente.Nomecli) LIKE UPPER( "+ConsNome+" ) "
					  +" and sgcheque.dtins BETWEEN ? AND ? ORDER BY "+ordena;
	    ...
	    try {
	      ...
	      total += rs.getFloat("valor");
	         ...
	         imp.say(imp.pRow()+0,1 , Funcoes.strZero(rs.getString("NCheque"),8));
