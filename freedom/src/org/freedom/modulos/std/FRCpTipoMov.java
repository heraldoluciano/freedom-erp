	...
	public void imprimir(boolean bVisualizar) {
		...
		try {
			...
			sSQL = "SELECT C.CODCOMPRA, C.DOCCOMPRA, C.DTEMITCOMPRA, C.DTENTCOMPRA, " +
				   ...
				   "WHERE PD2.CODEMP=IT2.CODEMPPD AND PD2.CODFILIAL=IT2.CODFILIALPD AND " +
				   "PD2.CODPROD=IT2.CODPROD AND IT2.CODEMP=C.CODEMP AND IT2.CODFILIAL=C.CODFILIAL AND " +
				   "IT2.CODCOMPRA=C.CODCOMPRA) VLRLIQCOMPRA " +
