	...
	public void imprimir(boolean bVisualizar) {
		...
		try {
			...
			sSQL = "SELECT C.CODCOMPRA, C.DOCCOMPRA, C.DTEMITCOMPRA, C.DTENTCOMPRA, C.VLRLIQCOMPRA, " +
				   ...
				   "FROM CPCOMPRA C, CPITCOMPRA IT, CPFORNECED F, FNPLANOPAG PG, EQPRODUTO PD, EQTIPOMOV TM "+
				   "WHERE C.CODEMP=? AND C.CODFILIAL=? "+
				   "AND C.CODEMPTM=TM.CODEMP AND C.CODFILIALTM=TM.CODFILIAL AND C.CODTIPOMOV=TM.CODTIPOMOV AND TM.TIPOMOV='DV' "+
