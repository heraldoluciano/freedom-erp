	...
	public static Object[] getPrefere() {
		...
		try {
			...
			if ( rs.next() ) {
				...
				oRetorno[ Orcamento.PrefOrc.REPLICAORC.ordinal() ] = "S".equals( rs.getString( Orcamento.PrefOrc.REPLICAORC.toString() ) );
				oRetorno[ Orcamento.PrefOrc.SQLREPLICAORC.ordinal() ] = rs.getString( Orcamento.PrefOrc.SQLREPLICAORC.toString() );
			}
