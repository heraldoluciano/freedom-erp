		...
		try {
			...
			if ( cbSaida.getVlrString().equals( "S" ) ) {
				...
				sSQL = "SELECT V.TIPOVENDA, V.DTEMITVENDA,V.DTSAIDAVENDA,IV.CODNAT,"
						...
						+ "SELECT V.TIPOVENDA,V.DTEMITVENDA, V.DTSAIDAVENDA, IV.CODNAT," + "V.CODCLI, C.UFCLI, TM.ESPECIETIPOMOV, TM.CODMODNOTA," + "V.SERIE, L.PRIMCUPOMLX DOCVENDA, L.ULTCUPOMLX DOCFIM,IV.PERCICMSITVENDA, coalesce(CF.ALIQLFISC as decimal(15,5)) aliqfisc, IV.PERCIPIITVENDA,"
