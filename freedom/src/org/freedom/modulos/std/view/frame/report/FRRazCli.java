...
public class FRRazCli extends FRelatorio {
	...
	public void imprimir( boolean bVisualizar ) {
		...
		try {
			...
			sSQL.append( " 'R' TIPO, R.DOCREC DOC, 0.00 VLRDEB, (L.VLRSUBLANCA * -1) VLRCRED " );
			...
			sSQL.append( "L.CODREC=R.CODREC AND L.CODSUBLANCA=0 AND C.CODEMP=R.CODEMPCL AND C.CODFILIAL=R.CODFILIALCL AND " );
