...
public class FManutPreco extends FFilho implements ActionListener,
	...
	public FManutPreco() {
		...
		lcMarca.add(new GuardaCampo(txtDescMarca, "DescMarca",
				"Decrição da marca", ListaCampos.DB_SI, false));
		...
		lcTabPreco.add(new GuardaCampo(txtCodTab, "CodTab", "Cód.tab.preço",
				ListaCampos.DB_PK, false));
		...
		lcClasCli.add(new GuardaCampo(txtCodClasCli, "CodClasCli", "Cód.c.cli",
				ListaCampos.DB_PK, false));
		...
		pinCli.adic(new JLabelPad("Descrição da tabela de preços"), 100, 195,
				300, 20);
		...
		pinCli.adic(new JLabelPad("Descrição do plano de pagamento"), 100, 235,
				300, 20);
		...
		pinCli.adic(new JLabelPad("Descrição da classificação do cliente"),
				100, 275, 300, 20);
			...
			if (iCodPlanoPag == 0) {
				Funcoes
						.mensagemInforma(this,
								"Plano de pagamento obrigatório!");
