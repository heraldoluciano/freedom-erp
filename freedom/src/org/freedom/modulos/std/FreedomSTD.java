...
public class FreedomSTD extends AplicativoPD {
	...
	public FreedomSTD() {
		...
		addOpcao( -1, TP_OPCAO_MENU, "Financeiro", "", 'F', 600000000, 0, false, null );
			...
			addOpcao( 600000000, TP_OPCAO_ITEM, "Historico", "Historico", 't', 600600000, 1, true, FHistPad.class );
			addOpcao( 600000000, TP_OPCAO_ITEM, "Lançamentos", "Lançamentos", 'L', 600700000, 1, true, FLanca.class );
			addSeparador( 600000000 );
			addOpcao( 600000000, TP_OPCAO_ITEM, "Tipo de crédito", "Tipo de crédito", 'L', 600800000, 1, true, FTipoCred.class );
			addOpcao( 600000000, TP_OPCAO_ITEM, "Liberação de crédito", "Liberação de crédito", 'i', 600900000, 1, true, FLiberaCredito.class );
			addSeparador( 600000000 );
			addOpcao( 600000000, TP_OPCAO_ITEM, "Tabela de juros", "Tabelas de juros", 'T', 601000000, 1, true, FTabJuros.class );
			addSeparador( 600000000 );
			addOpcao( 600000000, TP_OPCAO_ITEM, "Reprocessa saldo", "Reprocessamento de saldos", 'R', 601100000, 1, true, FProcessaSL.class );
			addSeparador( 600000000 );
			addOpcao( 600000000, TP_OPCAO_MENU, "Listagens", "", 's', 601200000, 1, false, null );
				addOpcao( 601200000, TP_OPCAO_ITEM, "Extrato", "Extrato", 'E', 601210000, 2, true, FRExtrato.class );
				addOpcao( 601200000, TP_OPCAO_ITEM, "Balancete", "Balancete", 'B', 601220000, 2, true, FRBalancete.class );
				addOpcao( 601200000, TP_OPCAO_ITEM, "Relatório financeiro por C.C.", "Relatorio Financeiro por C.C.", 'R', 601230000, 2, true, FRCentroCusto.class );
				addOpcao( 601200000, TP_OPCAO_ITEM, "Razão financeiro", "Razão financeiro", 'z', 601240000, 2, true, FRRazaoFin.class );
				addOpcao( 601200000, TP_OPCAO_ITEM, "Fluxo de caixa", "", 'F', 601250000, 2, true, FRFluxoCaixa.class );
				addOpcao( 601200000, TP_OPCAO_ITEM, "Ponto de equilibrio", "", 'q', 601260000, 2, true, FRPontoEqui.class );
			addOpcao( 600000000, TP_OPCAO_MENU, "Gráficos", "Fluxo de caixa", 'G', 601300000, 1, false, null );
				addOpcao( 601300000, TP_OPCAO_ITEM, "Balancete Gráfico", "Balancete Gráfico", 'G', 601301000, 2, true, FRBalanceteGrafico.class );
				addOpcao( 601300000, TP_OPCAO_ITEM, "Gráfico financeiro por C.C", "Gráfico Financeiro por C.C", 'f', 601302000, 2, true, FRGraficoCC.class );
