	...
	addOpcao(-1,TP_OPCAO_MENU,"Arquivo",'A',100000000,0,false, null);
	  addOpcao(100000000,TP_OPCAO_MENU,"Tabelas",'T',100100000,1,false, null);
	    addOpcao(100100000,TP_OPCAO_MENU,"Cliente",'C',100101000,2,false, null);
	      addOpcao(100101000,TP_OPCAO_ITEM,"Tipo de cliente...",'T',100101010,3,true, null);
	      addOpcao(100101000,TP_OPCAO_ITEM,"Classificação de cliente...", 'f', 100101020,3,true, null);
	      addOpcao(100101000,TP_OPCAO_ITEM,"Cliente...", 'C',100101030,3,true, null);
		  addOpcao(100101000,TP_OPCAO_ITEM,"Tipo fiscal de cliente...",'p',100101040,3,true, null);
		  addOpcao(100101000,TP_OPCAO_ITEM,"Crédito por cliente...",'r',100101050,3,true, null);
	    addOpcao(100100000,TP_OPCAO_MENU,"Vendedor",'C',100102000,2,false, null);
	      addOpcao(100102000,TP_OPCAO_ITEM,"Setor", 'S',100102010,3,true, null);
	      addOpcao(100102000,TP_OPCAO_ITEM,"Vendedor", 'V',100102020,4,true, null);
	      addOpcao(100102000,TP_OPCAO_ITEM,"Classif. de Comissões", 'P',100102030,5,true, null);
	      
	      
        addSeparador(100100000);
        addOpcao(100100000,TP_OPCAO_ITEM,"Moeda",'M',100112000,2,true, null);
	    addOpcao(100100000,TP_OPCAO_ITEM,"Banco",'B',100113000,2,true, null);
	    addOpcao(100100000,TP_OPCAO_ITEM,"Tipo de cobrança",'o',100114000,2,true, null);
	    addOpcao(100100000,TP_OPCAO_ITEM,"Plano de pagamento",'s',100115000,2,true, null);
	    //addOpcao(100100000,TP_OPCAO_ITEM,"Tipo de expositor",'x',100116000,2,true);	    
	    addSeparador(100100000);	    
	    addOpcao(100100000,TP_OPCAO_ITEM,"Transportadora",'p',100117000,2,true, null);  	    
	    addSeparador(100100000);	    
	    addOpcao(100100000,TP_OPCAO_ITEM,"Tipo de fornecedor",'e',100118000,2,true, null);  
	    addOpcao(100100000,TP_OPCAO_ITEM,"Fornecedor",'r',100119000,2,true, null);    
	    addSeparador(100100000);
        addOpcao(100100000,TP_OPCAO_ITEM,"Natureza de operação",'z',100120000,2,true, null);
	    addSeparador(100100000);
	    addOpcao(100100000,TP_OPCAO_MENU,"Produto",'u',100130000,2,false, null);
          addOpcao(100130000,TP_OPCAO_ITEM,"Tratamento tributário",'t',100130010,3,true, null);
          addOpcao(100130000,TP_OPCAO_ITEM,"Classificação fiscal",'l',100130020,3,true, null);
          addOpcao(100130000,TP_OPCAO_ITEM,"Almoxarifado",'x',100130030,3,true, null);
          addOpcao(100130000,TP_OPCAO_ITEM,"Grupo",'r',100130040,3,true, null);
          addOpcao(100130000,TP_OPCAO_ITEM,"Marca",'c',100130050,3,true, null);
          addOpcao(100130000,TP_OPCAO_ITEM,"Unidade",'U',100130060,3,true, null);
          addOpcao(100130000,TP_OPCAO_ITEM,"Produto",'P',100130070,3,true, null);
	      addSeparador(100130000);
          addOpcao(100130000,TP_OPCAO_ITEM,"Similaridade",'S',100130080,3,true, null);
