...
public class DLEditaRec extends FFDialogo implements CarregaListener {
  ...
  public DLEditaRec(Component cOrig) {
    ...
    adic(new JLabel("Descrição do banco"),90,40,250,20);
    adic(txtDescBanco,90,60,200,20);
    adic(new JLabel("Nºconta"),7,80,250,20);
    adic(txtCodConta,7,100,80,20);
    adic(new JLabel("Descrição da conta"),90,80,250,20);
    adic(txtDescConta,90,100,200,20);
    adic(new JLabel("Cód.catg."),7,120,250,20);
    adic(txtCodPlan,7,140,100,20);
    adic(new JLabel("Descrição da categoria"),110,120,250,20);
    adic(txtDescPlan,110,140,200,20);
	adic(new JLabel("Cód.c.c."),7,160,250,20);
	adic(txtCodCC,7,180,100,20);
	adic(new JLabel("Descrição do centro de custo"),110,160,250,20);
