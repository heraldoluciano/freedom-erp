...
public class FDevolucao extends FWizard implements CarregaListener {
	...
	private void mostraPainel1() {
		...
		rg1 = new JRadioGroup(3, 1, new Object[] {
				"Devolução de saída completa.", "Devolução de saída parcial.",
				"Devolução de saída sem venda agregada.", }, new Object[] {
				"SC", "SP", "SS" });
	...
	private void mostraPainel1a() {
		...
		lcVenda1a.add(new GuardaCampo(txtCodVenda1a, "CodVenda", "Cód.vend.",
				ListaCampos.DB_PK, true));
		lcVenda1a.add(new GuardaCampo(txtDocVenda1a, "DocVenda", "Doc.",
				ListaCampos.DB_SI, false));
		lcVenda1a.add(new GuardaCampo(txtSerie, "Serie", "Série",
				ListaCampos.DB_SI, false));
	...
	private void mostraPainel1c() {
		...
		lcCli1c.add(new GuardaCampo(txtCodCli1c, "CodCli", "Cód.cli",
				ListaCampos.DB_PK, true));
	...
	private void mostraPainel1a1() {
		...
		if (cancVenda()) {
			...
			adic(new JLabelPad("Não foi possível cancelar a venda."), 20, 10,
					350, 20);
	}
	...
	private void mostraPainel1a2() {
		...
		if ((iCodCompra = entrada(txtCodVenda1a.getVlrInteger().intValue(),
			...
			adic(new JLabelPad("Não foi possível gerar entrada."), 20, 10, 350,
					20);
	}
	...
	private void mostraPainel1c1() {
		...
		if ((iCodFor = geraFor(txtCodCli1c.getVlrInteger().intValue())) > 0) {
			...
			adic(new JLabelPad("Não foi possível criar o fornecedor."), 20, 10,
					350, 20);
	}
