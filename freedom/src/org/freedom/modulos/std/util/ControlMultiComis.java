package org.freedom.modulos.std.util;
...
public class ControlMultiComis {
    
	private int numComissionados = 1;
	private Connection con = null; 
	private ItemComis[] listComis = null;
	private JTextFieldPad txtCodvendPrinc;
	public ControlMultiComis(final Connection con, final int numComissionados, final JTextFieldPad txtCodvendPrinc) {
		this.con = con;
