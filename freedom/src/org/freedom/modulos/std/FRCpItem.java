...
public class FRCpItem extends FRelatorio {
	...
	public void imprimir(boolean bVisualizar) {
		...
		try {
			...
			/*
			sSQL.append( "SELECT it.precoitcompra as preco, IT.CODPROD, PD.DESCPROD, SUM(IT.QTDITCOMPRA)," );
			sSQL.append( "SUM(IT.VLRLIQITCOMPRA) " );
			...
			sSQL.append( sWhere );
			sSQL.append( "GROUP BY IT.CODPROD,PD.DESCPROD " );
			sSQL.append( " ORDER BY IT.CODPROD" );
				*/
