		...
		try {
			...
			sSql = "SELECT C2.CODCLI,C2.RAZCLI,C2.CIDCLI,TI.SIGLATIPOCLI,CLA.SIGLACLASCLI,"
 			   	 + "  SUM((SELECT (CAST((COALESCE(SUM(1),0)) AS INTEGER)) FROM TKHISTORICO HIS " +
 			   	 		"WHERE HIS.CODEMPCL=C2.CODEMP AND HIS.CODFILIALCL=C2.CODFILIAL AND " +
 			   	 		"HIS.CODCLI=C2.CODCLI AND HIS.TIPOHISTTK='V' AND HIS.DATAHISTTK BETWEEN ? AND ? )) AS JAN, "
			   	 + "  SUM((SELECT (CAST((COALESCE(SUM(1),0)) AS INTEGER)) FROM TKHISTORICO HIS " +
			   	 		"WHERE HIS.CODEMPCL=C2.CODEMP AND HIS.CODFILIALCL=C2.CODFILIAL AND " +
			   	 		"HIS.CODCLI=C2.CODCLI AND HIS.TIPOHISTTK='V' AND HIS.DATAHISTTK BETWEEN ? AND ? )) AS FEV, "
				 + "  SUM((SELECT (CAST((COALESCE(SUM(1),0)) AS INTEGER)) FROM TKHISTORICO HIS " +
				 		"WHERE HIS.CODEMPCL=C2.CODEMP AND HIS.CODFILIALCL=C2.CODFILIAL AND " +
				 		"HIS.CODCLI=C2.CODCLI AND HIS.TIPOHISTTK='V' AND HIS.DATAHISTTK BETWEEN ? AND ? )) AS MAR, "
				 + "  SUM((SELECT (CAST((COALESCE(SUM(1),0)) AS INTEGER)) FROM TKHISTORICO HIS " +
				 		"WHERE HIS.CODEMPCL=C2.CODEMP AND HIS.CODFILIALCL=C2.CODFILIAL AND " +
				 		"HIS.CODCLI=C2.CODCLI AND HIS.TIPOHISTTK='V' AND HIS.DATAHISTTK BETWEEN ? AND ? )) AS ABR, "
				 + "  SUM((SELECT (CAST((COALESCE(SUM(1),0)) AS INTEGER)) FROM TKHISTORICO HIS " +
				 		"WHERE HIS.CODEMPCL=C2.CODEMP AND HIS.CODFILIALCL=C2.CODFILIAL AND " +
				 		"HIS.CODCLI=C2.CODCLI AND HIS.TIPOHISTTK='V' AND HIS.DATAHISTTK BETWEEN ? AND ? )) AS MAI, "
				 + "  SUM((SELECT (CAST((COALESCE(SUM(1),0)) AS INTEGER)) FROM TKHISTORICO HIS " +
				 		"WHERE HIS.CODEMPCL=C2.CODEMP AND HIS.CODFILIALCL=C2.CODFILIAL AND " +
				 		"HIS.CODCLI=C2.CODCLI AND HIS.TIPOHISTTK='V' AND HIS.DATAHISTTK BETWEEN ? AND ? )) AS JUN, "
				 + "  SUM((SELECT (CAST((COALESCE(SUM(1),0)) AS INTEGER)) FROM TKHISTORICO HIS " +
				 		"WHERE HIS.CODEMPCL=C2.CODEMP AND HIS.CODFILIALCL=C2.CODFILIAL AND " +
				 		"HIS.CODCLI=C2.CODCLI AND HIS.TIPOHISTTK='V' AND HIS.DATAHISTTK BETWEEN ? AND ? )) AS JUL, "
				 + "  SUM((SELECT (CAST((COALESCE(SUM(1),0)) AS INTEGER)) FROM TKHISTORICO HIS " +
				 		"WHERE HIS.CODEMPCL=C2.CODEMP AND HIS.CODFILIALCL=C2.CODFILIAL AND " +
				 		"HIS.CODCLI=C2.CODCLI AND HIS.TIPOHISTTK='V' AND HIS.DATAHISTTK BETWEEN ? AND ? )) AS AGO, "
				 + "  SUM((SELECT (CAST((COALESCE(SUM(1),0)) AS INTEGER)) FROM TKHISTORICO HIS " +
				 		"WHERE HIS.CODEMPCL=C2.CODEMP AND HIS.CODFILIALCL=C2.CODFILIAL AND " +
				 		"HIS.CODCLI=C2.CODCLI AND HIS.TIPOHISTTK='V' AND HIS.DATAHISTTK BETWEEN ? AND ? )) AS SETE, "
				 + "  SUM((SELECT (CAST((COALESCE(SUM(1),0)) AS INTEGER)) FROM TKHISTORICO HIS " +
				 		"WHERE HIS.CODEMPCL=C2.CODEMP AND HIS.CODFILIALCL=C2.CODFILIAL AND " +
				 		"HIS.CODCLI=C2.CODCLI AND HIS.TIPOHISTTK='V' AND HIS.DATAHISTTK BETWEEN ? AND ? )) AS OUT, "
				 + "  SUM((SELECT (CAST((COALESCE(SUM(1),0)) AS INTEGER)) FROM TKHISTORICO HIS " +
				 		"WHERE HIS.CODEMPCL=C2.CODEMP AND HIS.CODFILIALCL=C2.CODFILIAL AND " +
				 		"HIS.CODCLI=C2.CODCLI AND HIS.TIPOHISTTK='V' AND HIS.DATAHISTTK BETWEEN ? AND ? )) AS NOV, "
				 + "  SUM((SELECT (CAST((COALESCE(SUM(1),0)) AS INTEGER)) FROM TKHISTORICO HIS " +
				 		"WHERE HIS.CODEMPCL=C2.CODEMP AND HIS.CODFILIALCL=C2.CODFILIAL AND " +
				 		"HIS.CODCLI=C2.CODCLI AND HIS.TIPOHISTTK='V' AND HIS.DATAHISTTK BETWEEN ? AND ? )) AS DEZ, "				
