...
/**
 * Tela para planejamento mestre da produção (Sistema de produção Empurrada (Pull System). Baseada no estoque mínimo e requisições pendentes.
 * 
...
//		MARCACAO, STATUS, DTFABROP, CODEMPPD, CODFILIALPD, CODPROD, SEQEST, DESCPROD, QTDMINPROD, QTDESTOQUE, QTDREQ,QTDEMPROD, QTDAPROD
	...
	private void carregaItens() {
		...
		try {
			...
			sql.append( "where ");
			sql.append( "pd.ativoprod='S' and pd.sldprod < pd.qtdminprod and pd.tipoprod in=('F','05') and pd.codemp=? and pd.codfilial=? and ");
