...
public class Atendimento {
	...
	public static enum EColAtend {
		SITREVATENDOIMG, SITREVATENDO, DATAATENDO, HORAATENDO, HORAATENDOFIN, INTERVATENDO, TOTALGERAL, TOTALMIN,
		   CODESPEC, DESCESPEC, CODMODEL, DESCMODEL, HORAINI, HORAFIN
	}

	public static enum SITREV {PE, E1_OK, E1_ER, E2_OK, E2_ER };  
	
	public static enum PREFS { CODEMPMI, CODFILIALMI, CODMODELMI, DESCMODELMI, CODEMPME, CODFILIALME, CODMODELME, DESCMODELME, TEMPOMAXINT, CODEMPIA, CODFILIALIA, CODESPECIA, DESCESPECIA };
