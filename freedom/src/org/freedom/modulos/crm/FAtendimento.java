...
public class FAtendimento extends FFilho implements CarregaListener, ActionListener, FocusListener, JComboBoxListener, KeyListener {
	...
	private JScrollPane spnConv = new JScrollPane( tabCli );
	...
	private JButton btImprimir = new JButton( Icone.novo( "btPrevimp.gif" ) );
	...
	private void montaTela() {
		...
		pnCli.add( spnConv, BorderLayout.CENTER );
