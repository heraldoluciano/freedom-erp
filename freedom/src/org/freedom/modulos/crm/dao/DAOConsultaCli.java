...
public class DAOConsultaCli extends AbstractDAO {
	...
	public static enum PRODVENDAS {
		...
		, VLRDESCITVENDA, VLRLIQITVENDA, TIPOVENDA, CODPLANOPAG, DESCPLANOPAG, CODVEND, NOMEVEND, CODALMOX, DESCALMOX;
	}
	public static enum ITENSVENDA {
		CODITVENDA, CODPROD, DESCPROD, CODLOTE, QTDITVENDA, PRECOITVENDA, VLRDESCITVENDA, VLRFRETEITVENDA
		, VLRLIQITVENDA, TIPOVENDA, CODPLANOPAG, DESCPLANOPAG, CODVEND, NOMEVEND, CODALMOX, DESCALMOX;
	}
	public static enum ITENSCESTA {
		SELECAO, CODPROD, DESCPROD, QTDITCESTA, PRECOITCESTA, VLRDESCITCESTA, VLRLIQITCESTA, CODALMOX, DESCALMOX;
	}
	...
	public Vector<Vector<Object>> loadItensVenda(Integer codempvd, Integer codfilialvd, String tipovenda, Integer codvenda
		...
		try {
			...
			sql.append( ", pg.codplanopag, pg.descplanopag, vo.codvend, vo.nomevend, ax.codalmox, ax.descalmox ");
			...
			sql.append( "on ax.codemp=p.codempax and ax.codfilial=p.codfilialax and ax.codalmox=p.codalmox " );
