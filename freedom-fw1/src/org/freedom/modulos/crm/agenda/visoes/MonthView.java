...
public class MonthView extends CalendarView {
	...
	public MonthView(CalendarViewConfig desc, FAgenda tela) throws Exception {
		/* ================================================== */
		super(desc);
	...
	/**
	 * @author martin.heinemann@tudor.lu 15.06.2007 15:41:10
	 * 
	 * 
	 * @version <br>
	 *          $Log: MonthView.java,v $ <br>
	...
	/**
	 * @author martin.heinemann@tudor.lu 19.06.2008 10:34:43
	 * 
	 * 
	 * @version <br>
	 *          $Log: MonthView.java,v $ <br>
			...
			try {
				...
				for (int row = 0; row < cells.size(); row++) {
					...
					for (int col = 0; col < rowList.size(); col++) {
						...
						cell.setBounds(( int ) ( col * width + 1 ), ( int ) ( row * height + 1 ), ( int ) width - 1, ( int ) height - 1);
						/*
						 * ------------------------------------------------------
						 * -
						 */
				...
				for (int i = 0; i < colCount - 1; i++) {
					...
					try {
						...
						line.setBounds(( int ) ( ( i + 1 ) * width ), 0, 1, parent.getHeight());
						/*
						 * ------------------------------------------------------
						 * -
						 */
				...
				for (int i = 0; i < rowCount; i++) {
					...
					try {
						...
						line.setBounds(0, ( int ) ( ( i + 1 ) * height ), parent.getWidth(), 1);
					}
					catch (Exception e) {
