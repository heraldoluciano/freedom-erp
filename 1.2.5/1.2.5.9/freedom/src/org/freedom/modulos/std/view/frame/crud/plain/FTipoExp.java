...
import org.freedom.modulos.std.view.dialog.report.DLRTipoExp;
...
public class FTipoExp extends FDados implements ActionListener {
	...
	private void imprimir( TYPE_PRINT bVisualizar ) {
		...
		try {
			...
			sSQL = "SELECT CODTIPOEXP,DESCTIPOEXP " + "FROM EQTIPOEXP " + "WHERE CODEMP=? AND CODFILIAL=? " + "ORDER BY " + dl.getValor();
