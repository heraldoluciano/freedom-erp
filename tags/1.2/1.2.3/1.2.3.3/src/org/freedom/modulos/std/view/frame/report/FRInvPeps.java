...
public class FRInvPeps extends FRelatorio {
	...
	public void imprimir( boolean bVisualizar ) {
		...
		try {
			...
			// iCodAlmox = txt
			sSql = "SELECT " + sCpCodigo + ",DESCPROD,SLDPROD,CUSTOUNIT,CUSTOTOT " + ",COALESCE(CODFABPROD,0) CODFABPROD,COALESCE(CODBARPROD,0) CODBARPROD,ATIVOPROD " + "FROM EQRELPEPSSP(?,?,?,?,?,?,?,?,?,?,?,?,?) " + swhere2 + swhere3 + swhere + " ORDER BY "
