...
public class ECFElginX5Test extends TestCase {
	...
	public void testComandosDeCupomFiscal() {
		...
		assertTrue( trataresultFuncao( ecf.vendaItem( 
				"000001", "Produto Teste", "FF", 'I', 1f, 10f, 'D', 0f ) ) );
...
//		System.out.println( new String( ecf.getBytesLidos() ) );
		...
		assertTrue( trataresultFuncao( ecf.leituraMemoriaFiscal( 2, 13, ECFElginX5.IMPRESSAO ) ) );
		System.out.println( new String( ecf.getBytesLidos() ) );
		
		System.out.print( "leituraMemoriaFiscal redução result > " ); 
		assertTrue( trataresultFuncao( ecf.leituraMemoriaFiscal( 2, 13, ECFElginX5.SERIAL ) ) );
		System.out.println( new String( ecf.getBytesLidos() ) );
*/
	}
