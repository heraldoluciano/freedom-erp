...
public class FRInadimplentes extends FRelatorio {
	...
	public void imprimir(boolean bVisualizar) {
		...
		String sSQL = "SELECT IT.DTVENCITREC,IT.NPARCITREC,R.CODVENDA,"+
					...
					" WHERE V.FLAG IN "+
					AplicativoPD.carregaFiltro(con,org.freedom.library.swing.frame.Aplicativo.iCodEmp)+" AND V.CODVENDA=R.CODVENDA),"+
					"R.DOCREC,R.CODREC,R.CODVENDA"+
					" FROM FNITRECEBER IT,FNRECEBER R,VDCLIENTE C"+
					" WHERE R.FLAG IN "+
					AplicativoPD.carregaFiltro(con,org.freedom.library.swing.frame.Aplicativo.iCodEmp)+" AND IT.DTVENCITREC BETWEEN ? AND ? AND"+
