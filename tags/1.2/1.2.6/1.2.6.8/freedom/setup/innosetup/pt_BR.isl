; *** Inno Setup version 5.0.6+ Portuguese (Brazil) messages ***
;
...
;
; $id: pt_BR.isl,v 1.51 2004/12/28 15:49:03 $
...
SelectDirLabel3=O assistente irá instalar [name] na seguinte pasta.
SelectDirBrowseLabel=Para continuar, clique Avançar. Se deseja selecionar outra pasta, clique em Procurar.
...
InvalidPath=Você deve especificar um caminho completo; por exemplo:%nC:\APP
...
SelectStartMenuFolderDesc=Onde o Programa de Instalação irá criar os atalhos do programa?
SelectStartMenuFolderLabel3=O assistente irá criar o(s) atalho(s) do programa na seguinte pasta do Menu Iniciar.
...
NoIconsCheck=Não criar atalhos
...
ReadyLabel1=O Programa de Instalação está pronto para iniciar a instalação do [name] no seu computador.
...
PreparingDesc=Instalação está se preparando para instalar o [name] em seu computador.
PreviousInstallNotCompleted=A instalação/remoção do programa anterior não foi completada. Você precisa reiniciar o computador para completar esta instalação. %n%nApós reiniciar seu computador, inicie o assistente novamente para completar a instalação do [name].
