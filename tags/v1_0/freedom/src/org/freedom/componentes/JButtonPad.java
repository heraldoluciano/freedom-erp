...
public class JButtonPad extends JButton {
	...
	*/
	...
	public JButtonPad (int iCodSistema, int iCodModulo, int iCodItem) {
		iCodSys = iCodSistema;
		iCodMod = iCodModulo;
		iCodIt = iCodItem;
		//iCodNiv = iCodNivel;
	...
	*  8 casas decimais (caso as casas da direita n&atildeo forem usadas colocar 0)<BR>
