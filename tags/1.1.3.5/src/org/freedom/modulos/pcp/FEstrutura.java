...
public class FEstrutura extends FDetalhe implements ChangeListener,
		ActionListener, CarregaListener, PostListener {
		...
		try {
			...
			if (sValores[1].equals("R")){
				...
				try {
					...
					sSQL = "SELECT E.CODPROD, PD.DESCPROD, E.SEQEST, E.QTDEST, E.DESCEST, " +
						   "E.ATIVOEST, E.CODMODLOTE, E.NRODIASVALID " +
