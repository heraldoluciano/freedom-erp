...
BEGIN
  ...
  BEGIN
    ...
    ELSE
    BEGIN
      /* Caso não seja possível liberar por credito pré-aprovado então verifica liberação*/
      PREFCRED = 'A';
    END
  END
  IF (PREFCRED = 'A') THEN /* Aguardar liberação */
  BEGIN
    ...
    END
    ELSE
      EXCEPTION VDVENDAEX02; /*Venda não foi liberada*/
  END
  SUSPEND;
END ^
...
/*Só vem para cá se as SELECTs acima não tiverem retornado nenhum valor.*/
...
declare variable ICODITVENDA INTEGER   /*Variaveis buscadas: */;
     ...
     declare variable VLRBASEIPIITVENDA DECIMAL(15,3);
     declare variable VLRIPIITVENDA DECIMAL(15,3);
     declare variable ICODPROD INTEGER   /*Variaveis herdadas do itorçamento: */;
     ...
     declare variable SREFPROD CHAR(13);
     declare variable OBSITORC VARCHAR(500);
     declare variable UFCLI CHAR(2)   /*Variaveis temporárias: */;
...
/*Variaveis herdadas do orçamento:*/
  DECLARE VARIABLE ICODVEND INTEGER;
...
-- Se o plano de pagamento tiver marcado para autobaixa, então é realizada a baixa automática.
...
--    exception vdvendaex01 'CODEMP: '||CAST(NEW.CODEMP AS CHAR(4));
    UPDATE FNITRECEBER SET NUMCONTA=:NUMCONTA,CODEMPCA=NEW.CODEMP,CODFILIALCA=:CODFILIALCA,
      ...
      OBSITREC='BAIXA AUTOMÁTICA',STATUSITREC='RP'
