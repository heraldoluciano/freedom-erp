...
public abstract class Aplication {
	 ...
	 * Também invoca os metodos <code>init</code>, para iniciação dos parametros da classe concreta e o
	 * metodo <code>show</code> para a exibição da janela {@link #window principal} associada a esta.
	 * 
	 * @see 	#initParameters()
	 * @see		#init()
	 * @see		#show()
	...
	/**
	 * Torna visível a {@link #window janela principal}, caso sua referência não seja igual a <code>null</code>.
	 * 
