 ...
 * <br>
 * 
 * IntegerDocument visa prover a aplicação de uma mascara exclusiva para números inteiros.
 * Sua utilização é simples, pois a mascara a ser utilizada somente permitirá caracteres númericos.
 * O padrão para o tamanho da máscara é de 10 algarismos, mas este pode ser definido atráves de
...
public class IntegerDocument extends Document {
	...
	/**
	 * Verifica a possibilidade de inserssão do texto,
	 * se sim encaminha o texto para validação com <code>validateMaskAux</code>.
	 * 
	...
	/**
	 * Re-distribui a validação para os metodos de validação de negativo e o de validação de inteiro.
	 * 
	...
	/**
	 * Valida o texto para utilização somente de algarismos númericos, sem a utilização de mascara.
	 * 
