...
public class Crud {
	...
	public Crud( final String persistUnit, final Map<String, String> properties, final boolean writerLogger ) throws Exception {
		...
		if ( writerLogger ) {
			if ( properties == null ) {
				...
				logger = FreedomLogger.getLogger( this.getClass(), 
												  properties.get( "initFile" ),
												  FreedomLogger.LOGGER_JPA );
			}
		}
	...
	public Crud( final String persistUnit, 
			 	 final int persistFramework, 
	...
	public Crud( final String persistUnit, 
			     ...
			     final boolean writerLogger ) throws Exception {

		this( persistUnit, 
			  getProperties( persistFramework, 
				             initFile, 
				             sessionName, 
				             userParam, 
				             passwordParam ),
	...
	public PersistObject find( final Class<? extends PersistObject> clas, 
							   final Key key, 
							   final boolean repeat ) throws NotConnectionCrudException {
