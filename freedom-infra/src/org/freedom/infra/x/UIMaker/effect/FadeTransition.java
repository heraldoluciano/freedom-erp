...
public class FadeTransition extends EffectStandard {
	...
	public FadeTransition( final List<Image> images,
						   final int speed,
						   final int speedSleep,
						   final float alfaIncrement ) {
	...
	public FadeTransition( final JComponent component, 
	...
	public FadeTransition( final boolean createFadePanel, 
			   			   final List<Image> images,
			   			   final int speed,
			   			   final int speedSleep,
			   			   final float alfaIncrement ) {
