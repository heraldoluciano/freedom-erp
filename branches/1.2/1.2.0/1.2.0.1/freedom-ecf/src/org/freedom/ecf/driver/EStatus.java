...
public enum EStatus {
    ...
    BEMA_RELOGIO_ERROR( 203, "Erro no relógio." ),
    BEMA_IMPRESSORA_EM_ERRO( 204, "Impressora em erro." ),
    BEMA_NO_ESC( 205, "Primeiro dado do comando não foi ESC." ),
    BEMA_NO_COMMAND( 206, "Comando inexistente." ),
    BEMA_CUPOM_FISCAL_ABERTO( 207, "Cupom fiscal aberto." ),
    BEMA_NU_PARAMS_INVALIDO( 208, "Número de parâmetro de CMD inválido." ),
    BEMA_TP_PARAM_INVALIDO( 209, "Tipo de parâmetro de CMD inválido." ),
    BEMA_OUT_OF_MEMORY( 210, "Memória fiscal lotada." ),
    BEMA_MEMORY_ERROR( 211, "Erro na memória RAM CMOS não volátil." ),
    BEMA_NO_ALIQUOTA( 212, "Alíquota não programada." ),
    BEMA_OUT_OF_ALIQUOTA( 213, "Capacidade de alíquotas esgotada." ),
    BEMA_NO_ACESESS_CANCELAMENTO( 214, "Cancelamento não permitido." ),
    BEMA_NO_CNPJ_IE( 215, "CNPJ/IE do proprietário não programados." ),
    BEMA_COMMAND_NO_EXECUTE( 216, "Comando não executado." ),
	...
	DARUMA_ERROR_N1( -1, "Comando não implementado pelo driver de comunicação." ),
