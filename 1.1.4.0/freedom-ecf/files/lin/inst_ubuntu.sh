...
cp /tmp/commapi/lib/*.so /usr/lib/jvm/java-1.5.0-sun/jre/bin/
cp /tmp/commapi/docs/javax.comm.properties /usr/lib/jvm/java-1.5.0-sun/jre/lib
cd /usr/lib
ln -sf /usr/lib/jvm/java-1.5.0-sun/jre/bin/libLinuxSerialParallel_g.so
ln -sf /usr/lib/jvm/java-1.5.0-sun/jre/bin/libLinuxSerialParallel.so
cd $diretorio
