	...
	private void visualizar() {
		...
		try {
			String sSQL = "SELECT C.DTEMITCOMPRA,C.DTENTCOMPRA,IT.CODNAT,C.CODFOR,F.UFFOR,TM.ESPECIETIPOMOV,TM.CODMODNOTA," + "C.SERIE,C.DOCCOMPRA,IT.PERCICMSITCOMPRA,IT.PERCIPIITCOMPRA,C.CODEMPFR,C.CODFILIALFR,IT.CODEMPNT,IT.CODFILIALNT," + "TM.CODEMPMN,TM.CODFILIALMN,"
					+ "SUM(VLRPRODITCOMPRA),SUM(IT.VLRBASEICMSITCOMPRA),SUM(IT.VLRICMSITCOMPRA),coalesce(SUM(IT.VLRISENTASITCOMPRA),0.00)," + "coalesce(SUM(IT.VLROUTRASITCOMPRA),0.00),SUM(IT.VLRBASEIPIITCOMPRA),SUM(IT.VLRIPIITCOMPRA), C.STATUSCOMPRA "
			...
			if ( cbSaida.getVlrString().equals( "S" ) ) {
				...
				sSQL = "SELECT V.TIPOVENDA, V.DTEMITVENDA,V.DTSAIDAVENDA,IV.CODNAT,"
						...
						+ "SELECT V.TIPOVENDA,V.DTEMITVENDA, V.DTSAIDAVENDA, IV.CODNAT," + "V.CODCLI, C.UFCLI, TM.ESPECIETIPOMOV, TM.CODMODNOTA," + "V.SERIE, L.PRIMCUPOMLX DOCVENDA, L.ULTCUPOMLX DOCFIM,IV.PERCICMSITVENDA, CF.ALIQLFISC, IV.PERCIPIITVENDA,"
