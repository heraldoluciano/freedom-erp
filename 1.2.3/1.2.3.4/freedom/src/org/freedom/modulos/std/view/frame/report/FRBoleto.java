...
//	private String sInfoMoeda[] = new String[ 4 ];
	...
	private ResultSet execQuery( String sWhereGrid ) {
		...
		sSQL.append( "ITR.OBSITREC OBS, TCO.VARIACAOCARTCOB " );
		...
		sSQL.append( "SGFILIAL F, FNCONTA CT, VDVENDEDOR VD, VDVENDA V, FNCARTCOB TCO " );
		...
		sSQL.append( "TCO.CODEMP=ITR.CODEMPCB AND TCO.CODFILIAL=ITR.CODFILIALCB AND TCO.CODCARTCOB=ITR.CODCARTCOB AND ");
